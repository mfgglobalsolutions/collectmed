...
<!-------------------------------------------------------------------------------------->
	<cfoutput>
		...
		<cftry>		
			...
			<cfif clear OR (IsDefined("form.clear_session.User.IntakeDisplayCancelledQuery") AND form.clear_session.User.IntakeDisplayCancelledQuery EQ 1) OR NOT IsDefined("session.User.IntakeDisplayCancelledQuery") OR session.User.IntakeDisplayCancelledQuery EQ "">
				...
				<cfset session.User.IntakeDisplayCancelledQuery = sqlStatement>
			
			<cfelse>
			
				<cfset sqlStatement = session.User.IntakeDisplayCancelledQuery>
			...
			<!-------------------------------------------------------------------------------------->			
			<cfquery name="getCancelledIntakes" datasource="#trim(request.datasource)#">
			...
			<cfoutput>
				<script language="JavaScript">
					var taskElement = document.getElementById("tabIntakeCancelledVerbage");
					if (taskElement != null){
						document.getElementById("tabIntakeCancelledVerbage").innerHTML = 'Cancelled (#trim(getCancelledIntakes.RecordCount)#)';		
					};	
				</script>
			</cfoutput>	
			...
			<!-------------------------------------------------------------------------------------->
			<cfparam name="startRow_CancelledIntake" default="1" type="numeric">	
			<cfif IsDefined("form.startRow_CancelledIntake") AND form.startRow_CancelledIntake NEQ "">
				<cfset startRow_CancelledIntake = form.startRow_CancelledIntake>
			<cfelseif IsDefined("url.startRow_CancelledIntake") AND url.startRow_CancelledIntake NEQ "">
				<cfset startRow_CancelledIntake = url.startRow_CancelledIntake>	
			</cfif>
			...
			<cfif clear>
				<cfset session.rowsPerPage_CancelledIntake = "">
				<!---<cfset session.startRow_CancelledIntake = 1>--->
			</cfif>
			
			<cfif IsDefined("form.rowsPerPage_CancelledIntake") AND form.rowsPerPage_CancelledIntake NEQ "">
				<cfset session.rowsPerPage_CancelledIntake = form.rowsPerPage_CancelledIntake>
			<cfelseif IsDefined("url.rowsPerPage_CancelledIntake") AND url.rowsPerPage_CancelledIntake NEQ "">
				<cfset session.rowsPerPage_CancelledIntake = url.rowsPerPage_CancelledIntake>	
			<cfelseif IsDefined("session.rowsPerPage_CancelledIntake") AND IsNumeric(session.rowsPerPage_CancelledIntake)>
				<cfset session.rowsPerPage_CancelledIntake = session.rowsPerPage_CancelledIntake>	
			<cfelse>
				<cfset session.rowsPerPage_CancelledIntake = session.Client.getRecordsPerPage()>
			</cfif>
						
			<cfset totalRows = getCancelledIntakes.recordCount>
			<cfif showAll>
				<cfset rowsPerPage = totalRows>
			</cfif>
			<cfset endRow_CancelledIntake = min(startRow_CancelledIntake + session.rowsPerPage_CancelledIntake - 1, totalRows)>
			<cfset startRowNext = endRow_CancelledIntake + 1>
			<cfset startRowBack = startRow_CancelledIntake - session.rowsPerPage_CancelledIntake>
			...
			<cf_gcNextNRecords type="CancelledIntake">					
				...
				<table border="0" cellpadding="4" cellspacing="0" class="Tbl">
					...
					<cfloop query="getCancelledIntakes" startRow="#trim(startRow_CancelledIntake)#" endRow="#trim(endRow_CancelledIntake)#">					
