...
<!--- NAME:                                                                          --->
<!--- @@Name@@                                                                       --->
<!--- Procedure_MEDICARE_REMARK_CODEIO.cfc                                           --->
<!--- @@Name@@                                                                       --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- CATEGORY:                                                                      --->
...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the Procedure_MEDICARE_REMARK_CODE table in the  --->
<!--- dB.                                                                            --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_Procedure_MEDICARE_REMARK_CODETable                              --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<!--- Procedure_MEDICARE_REMARK_CODEID<br>                                           --->
<!--- ProcedureID<br>                                                                --->
<!--- QualifierCode<br>                                                              --->
<!--- IndustryCode<br>                                                               --->
<!--- Active<br>                                                                     --->
...
<cfcomponent name="Procedure_MEDICARE_REMARK_CODEIO">
	...
	<cffunction name="reset" access="public" output="no">
		...
		<cfscript>
			...
			variables.instance.Procedure_MEDICARE_REMARK_CODEID = "NULL";
			variables.instance.ProcedureID = "NULL";
			variables.instance.QualifierCode = "";
			variables.instance.IndustryCode = "";
...
<!-------------------------------------------------------------------------------------->
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "PROCEDURE_MEDICARE_REMARK_CODEID", 1)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "INDUSTRYCODE", 4)>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for Procedure_MEDICARE_REMARK_CODEID.                       --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getProcedure_MEDICARE_REMARK_CODEID" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.Procedure_MEDICARE_REMARK_CODEID>
	</cffunction>
	 
	<cffunction name="setProcedure_MEDICARE_REMARK_CODEID" access="public" returntype="boolean" output="No">
 		
		<cfargument name="Procedure_MEDICARE_REMARK_CODEID" required="Yes" type="String">
		
		<cfif Procedure_MEDICARE_REMARK_CODEID NEQ "NULL">	
			
			<cfif arguments.Procedure_MEDICARE_REMARK_CODEID EQ "@@" OR arguments.Procedure_MEDICARE_REMARK_CODEID EQ "">
				
				<cfset arguments.Procedure_MEDICARE_REMARK_CODEID = "NULL">
						
			<cfelseif NOT REQUEST.isintDataType(Procedure_MEDICARE_REMARK_CODEID)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>Procedure_MEDICARE_REMARK_CODEID</strong> (#Procedure_MEDICARE_REMARK_CODEID#) is not of type <strong>int</strong>.">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.Procedure_MEDICARE_REMARK_CODEID = arguments.Procedure_MEDICARE_REMARK_CODEID>			
		<cfreturn true>
	...
	<cffunction name="setQualifierCode" access="public" returntype="boolean" output="No">
		...
		<cfif QualifierCode NEQ "NULL">	
			...
			<cfelseif NOT REQUEST.isvarcharDataType(QualifierCode)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>QualifierCode</strong> (#QualifierCode#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(QualifierCode) GT 5>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>QualifierCode</strong> cannot be greater than 5 character(s).">
			</cfif>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for IndustryCode.                                           --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getIndustryCode" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.IndustryCode>
	</cffunction>
	 
	<cffunction name="setIndustryCode" access="public" returntype="boolean" output="No">
 		
		<cfargument name="IndustryCode" required="Yes" type="String">
		
		<cfif IndustryCode NEQ "NULL">	
			
			<cfif arguments.IndustryCode EQ "@@" OR arguments.IndustryCode EQ "">
				
				<cfset arguments.IndustryCode = "NULL">
						
			<cfelseif NOT REQUEST.isvarcharDataType(IndustryCode)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>IndustryCode</strong> (#IndustryCode#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(IndustryCode) GT 10>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>IndustryCode</strong> cannot be greater than 10 character(s).">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.IndustryCode = arguments.IndustryCode>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "IndustryCode")>			
		<cfreturn true>
	...
	<cffunction name="new" access="public" output="no">
		...
		<cfargument name="IndustryCode" required="No" type="String" default="">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="Init" access="public" returntype="Procedure_MEDICARE_REMARK_CODEIO" output="No">
		
		<cfargument name="Procedure_MEDICARE_REMARK_CODEID" required="yes" type="numeric">		
		<cfset var qGetProcedure_MEDICARE_REMARK_CODE = "">
		
		<cfset preInit(Procedure_MEDICARE_REMARK_CODEID)>
		...
		<cfscript>
			IF(qGetProcedure_MEDICARE_REMARK_CODE.Procedure_MEDICARE_REMARK_CODEID EQ "" OR qGetProcedure_MEDICARE_REMARK_CODE.Procedure_MEDICARE_REMARK_CODEID EQ "NULL") 
				variables.instance.Procedure_MEDICARE_REMARK_CODEID = "NULL"; 
			ELSE 
				variables.instance.Procedure_MEDICARE_REMARK_CODEID = qGetProcedure_MEDICARE_REMARK_CODE.Procedure_MEDICARE_REMARK_CODEID;
				
			IF(qGetProcedure_MEDICARE_REMARK_CODE.ProcedureID EQ "" OR qGetProcedure_MEDICARE_REMARK_CODE.ProcedureID EQ "NULL") 
				variables.instance.ProcedureID = "NULL"; 
			ELSE 
				variables.instance.ProcedureID = qGetProcedure_MEDICARE_REMARK_CODE.ProcedureID;
							
				variables.instance.QualifierCode = qGetProcedure_MEDICARE_REMARK_CODE.QualifierCode;
							
				variables.instance.IndustryCode = qGetProcedure_MEDICARE_REMARK_CODE.IndustryCode;
							
				variables.instance.Active = qGetProcedure_MEDICARE_REMARK_CODE.Active;
				
			IF(qGetProcedure_MEDICARE_REMARK_CODE.InactiveCode EQ "" OR qGetProcedure_MEDICARE_REMARK_CODE.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetProcedure_MEDICARE_REMARK_CODE.InactiveCode;
							
				variables.instance.DateCreated = qGetProcedure_MEDICARE_REMARK_CODE.DateCreated;
							
				variables.instance.DateModified = qGetProcedure_MEDICARE_REMARK_CODE.DateModified;
				
		</cfscript>		
		  
		<cfset postInit(Procedure_MEDICARE_REMARK_CODEID)>
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
	 	...
	 	<cfset var qCommitProcedure_MEDICARE_REMARK_CODE = "">
		
		<cfset preUpdateCommit()>
	 	
		<cfif IsNumeric(variables.instance.Procedure_MEDICARE_REMARK_CODEID) AND variables.instance.Procedure_MEDICARE_REMARK_CODEID  GT 0>	  		
			
			<cfif ListLen(trim(variables.instance.changedVariables)) GTE 1>
			
				<cfset sqlStatement = preUpdateDataCheck()>				
				
				<cfquery name="qUpdateCommitProcedure_MEDICARE_REMARK_CODE" datasource="#trim(request.datasource)#">
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfquery name="qInsertCommitProcedure_MEDICARE_REMARK_CODE" datasource="#trim(request.datasource)#">
		   			#PreserveSingleQuotes(sqlStatement)#
		   		</cfquery>		
		 					
				<cfset postInsertCommit()>
				
				<cfset variables.instance.Procedure_MEDICARE_REMARK_CODEID = qInsertCommitProcedure_MEDICARE_REMARK_CODE.Procedure_MEDICARE_REMARK_CODEID>
				
				<cfreturn qInsertCommitProcedure_MEDICARE_REMARK_CODE.Procedure_MEDICARE_REMARK_CODEID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->	
			<cfset tableColumns = "Procedure_MEDICARE_REMARK_CODEID,ProcedureID,QualifierCode,IndustryCode,Active,InactiveCode,DateCreated,DateModified">		
			
		<!-------------------------------------------------------------------------------------->
		<!--- Denote the column names that need single quotes (strings).                     --->
		<!-------------------------------------------------------------------------------------->
			<cfset stringTableColumns = "QualifierCode,IndustryCode,Active">	
	...
	<cffunction name="preInsertDataCheck" output="no">		
		...
		<!--- append it to the update statement.                                             --->
		<!-------------------------------------------------------------------------------------->					
			<cfloop list="ProcedureID,QualifierCode,IndustryCode,Active,InactiveCode,DateCreated,DateModified" index="currentVar">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getProcedure_MEDICARE_REMARK_CODEQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getProcedure_MEDICARE_REMARK_CODEQuery">						
		<cfargument name="Fields" required="No" type="String" default="Procedure_MEDICARE_REMARK_CODEID,ProcedureID,QualifierCode,IndustryCode,Active,InactiveCode,DateCreated,DateModified">	
		...
		<cfargument name="Procedure_MEDICARE_REMARK_CODEID" required="No" type="String" default="">
		<cfargument name="Procedure_MEDICARE_REMARK_CODEID_IN" required="No" type="String" default="">
		<cfargument name="Procedure_MEDICARE_REMARK_CODEID_LIKE" required="No" type="String" default="">
		<cfargument name="ProcedureID" required="No" type="String" default="">
		...
		<cfargument name="IndustryCode" required="No" type="String" default="">
		<cfargument name="IndustryCode_IN" required="No" type="String" default="">
		<cfargument name="IndustryCode_LIKE" required="No" type="String" default="">
		<cfargument name="Active" required="No" type="String" default="">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfset availableColumns = "Procedure_MEDICARE_REMARK_CODEID,Procedure_MEDICARE_REMARK_CODEID_IN,Procedure_MEDICARE_REMARK_CODEID_LIKE,ProcedureID,ProcedureID_IN,ProcedureID_LIKE,QualifierCode,QualifierCode_IN,QualifierCode_LIKE,IndustryCode,IndustryCode_IN,IndustryCode_LIKE,Active,Active_IN,Active_LIKE,InactiveCode,InactiveCode_IN,InactiveCode_LIKE,DateCreated,DateCreated_IN,DateCreated_LIKE,DateModified,DateModified_IN,DateModified_LIKE,top1">
			...
			<cfloop from="1" to="#ArrayLen(keysToStruct)#" index="i">
				...
				<cfif NOT ListFindNoCase("QueryName|Fields|OrderBy|GroupBy", keysToStruct[i], "|") AND Find("_IN", keysToStruct[i]) EQ 0 AND Find("_LIKE", keysToStruct[i]) EQ 0>
					...
					<cfif NOT ListFindNoCase(availableColumns, keysToStruct[i])>
						<cf_gcGeneralErrorTemplate				
							invisible="Procedure_MEDICARE_REMARK_CODE"
		...
		<!-------------------------------------------------------------------------------------->			
			<cfquery Name="getProcedure_MEDICARE_REMARK_CODEQuery" datasource="#trim(request.datasource)#">
				...
				WHERE 1=1
					...
					<cfif Procedure_MEDICARE_REMARK_CODEID_LIKE NEQ "">AND Procedure_MEDICARE_REMARK_CODEID LIKE '%#trim(Procedure_MEDICARE_REMARK_CODEID_LIKE)#%'</cfif>
					...
					<cfif QualifierCode NEQ "">AND QualifierCode = '#QualifierCode#'</cfif>
					...
					<cfif IndustryCode NEQ "">AND IndustryCode = '#IndustryCode#'</cfif>
					<cfif IndustryCode_IN NEQ "">AND IndustryCode IN(#trim(IndustryCode_IN)#)</cfif>
					<cfif IndustryCode_LIKE NEQ "">AND IndustryCode LIKE '%#trim(IndustryCode_LIKE)#%'</cfif>
			...
			<cfreturn getProcedure_MEDICARE_REMARK_CODEQuery>
