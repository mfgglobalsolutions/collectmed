...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the EmailAddress table in the dB.                --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_EmailAddressTable                                                --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<cfcomponent name="EmailAddressIO">
	...
	<cffunction name="reset" access="public" output="no">
		...
		<cfscript>
			...
			variables.instance.EmailAddressID = "NULL";
			variables.instance.SiteID = "NULL";
			variables.instance.EntityID = "NULL";
			variables.instance.EmailTypeID = "NULL";
			variables.instance.Email = "";
			variables.instance.IsDefault = "";
...
<!-------------------------------------------------------------------------------------->
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "EMAILADDRESSID", 1)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "ENTITYID", 3)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "EMAILTYPEID", 4)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "EMAIL", 5)>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for EmailAddressID.                                         --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getEmailAddressID" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.EmailAddressID>
	</cffunction>
	 
	<cffunction name="setEmailAddressID" access="public" returntype="boolean" output="No">
 		
		<cfargument name="EmailAddressID" required="Yes" type="String">
		
		<cfif EmailAddressID NEQ "NULL">	
			
			<cfif arguments.EmailAddressID EQ "@@" OR arguments.EmailAddressID EQ "">
				
				<cfset arguments.EmailAddressID = "NULL">
						
			<cfelseif NOT REQUEST.isintDataType(EmailAddressID)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>EmailAddressID</strong> (#EmailAddressID#) is not of type <strong>int</strong>.">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.EmailAddressID = arguments.EmailAddressID>			
		<cfreturn true>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for EmailTypeID.                                            --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getEmailTypeID" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.EmailTypeID>
	</cffunction>
	 
	<cffunction name="setEmailTypeID" access="public" returntype="boolean" output="No">
 		
		<cfargument name="EmailTypeID" required="Yes" type="String">
		
		<cfif EmailTypeID NEQ "NULL">	
			
			<cfif arguments.EmailTypeID EQ "@@" OR arguments.EmailTypeID EQ "">
				
				<cfset arguments.EmailTypeID = "NULL">
						
			<cfelseif NOT REQUEST.isintDataType(EmailTypeID)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>EmailTypeID</strong> (#EmailTypeID#) is not of type <strong>int</strong>.">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.EmailTypeID = arguments.EmailTypeID>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "EmailTypeID")>			
		<cfreturn true>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for Email.                                                  --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getEmail" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.Email>
	</cffunction>
	 
	<cffunction name="setEmail" access="public" returntype="boolean" output="No">
 		
		<cfargument name="Email" required="Yes" type="String">
		
		<cfif Email NEQ "NULL">	
			
			<cfif arguments.Email EQ "@@" OR arguments.Email EQ "">
				
				<cfset arguments.Email = "NULL">
						
			<cfelseif NOT REQUEST.isvarcharDataType(Email)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>Email</strong> (#Email#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(Email) GT 120>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>Email</strong> cannot be greater than 120 character(s).">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.Email = arguments.Email>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "Email")>			
		<cfreturn true>
	...
	<cffunction name="setIsDefault" access="public" returntype="boolean" output="No">
		...
		<cfif IsDefault NEQ "NULL">	
			...
			<cfelseif NOT REQUEST.ischarDataType(IsDefault)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>IsDefault</strong> (#IsDefault#) is not of type <strong>char</strong>.">	
			<cfelseif len(IsDefault) GT 1>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>IsDefault</strong> cannot be greater than 1 character(s).">
			</cfif>
	...
	<cffunction name="new" access="public" output="no">
		...
		<cfargument name="EmailTypeID" required="No" type="String" default="">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="Init" access="public" returntype="EmailAddressIO" output="No">
		
		<cfargument name="EmailAddressID" required="yes" type="numeric">		
		<cfset var qGetEmailAddress = "">
		
		<cfset preInit(EmailAddressID)>
		...
		<cfscript>
			IF(qGetEmailAddress.EmailAddressID EQ "" OR qGetEmailAddress.EmailAddressID EQ "NULL") 
				variables.instance.EmailAddressID = "NULL"; 
			ELSE 
				variables.instance.EmailAddressID = qGetEmailAddress.EmailAddressID;
				
			IF(qGetEmailAddress.SiteID EQ "" OR qGetEmailAddress.SiteID EQ "NULL") 
				variables.instance.SiteID = "NULL"; 
			ELSE 
				variables.instance.SiteID = qGetEmailAddress.SiteID;
				
			IF(qGetEmailAddress.EntityID EQ "" OR qGetEmailAddress.EntityID EQ "NULL") 
				variables.instance.EntityID = "NULL"; 
			ELSE 
				variables.instance.EntityID = qGetEmailAddress.EntityID;
				
			IF(qGetEmailAddress.EmailTypeID EQ "" OR qGetEmailAddress.EmailTypeID EQ "NULL") 
				variables.instance.EmailTypeID = "NULL"; 
			ELSE 
				variables.instance.EmailTypeID = qGetEmailAddress.EmailTypeID;
							
				variables.instance.Email = qGetEmailAddress.Email;
							
				variables.instance.IsDefault = qGetEmailAddress.IsDefault;
							
				variables.instance.Active = qGetEmailAddress.Active;
				
			IF(qGetEmailAddress.InactiveCode EQ "" OR qGetEmailAddress.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetEmailAddress.InactiveCode;
							
				variables.instance.DateCreated = qGetEmailAddress.DateCreated;
							
				variables.instance.DateModified = qGetEmailAddress.DateModified;
				
		</cfscript>		
		  
		<cfset postInit(EmailAddressID)>
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
	 	...
	 	<cfset var qCommitEmailAddress = "">
		
		<cfset preUpdateCommit()>
	 	
		<cfif IsNumeric(variables.instance.EmailAddressID) AND variables.instance.EmailAddressID  GT 0>	  		
			
			<cfif ListLen(trim(variables.instance.changedVariables)) GTE 1>
			
				<cfset sqlStatement = preUpdateDataCheck()>				
				
				<cfquery name="qUpdateCommitEmailAddress" datasource="#trim(request.datasource)#">
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfquery name="qInsertCommitEmailAddress" datasource="#trim(request.datasource)#">
		   			#PreserveSingleQuotes(sqlStatement)#
		   		</cfquery>		
		 					
				<cfset postInsertCommit()>
				
				<cfset variables.instance.EmailAddressID = qInsertCommitEmailAddress.EmailAddressID>
				
				<cfreturn qInsertCommitEmailAddress.EmailAddressID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->	
			<cfset tableColumns = "EmailAddressID,SiteID,EntityID,EmailTypeID,Email,IsDefault,Active,InactiveCode,DateCreated,DateModified">		
			
		<!-------------------------------------------------------------------------------------->
		<!--- Denote the column names that need single quotes (strings).                     --->
		<!-------------------------------------------------------------------------------------->
			<cfset stringTableColumns = "Email,IsDefault,Active">	
		...
		<!-------------------------------------------------------------------------------------->					
			...
			<!-------------------------------------------------------------------------------------->	
				<cfset sqlStatement = "UPDATE emailaddress  SET #columnsToUpdate# WHERE EmailAddressID = #trim(variables.instance.EmailAddressID)#">
	...
	<cffunction name="preInsertDataCheck" output="no">		
		...
		<!--- append it to the update statement.                                             --->
		<!-------------------------------------------------------------------------------------->					
			<cfloop list="SiteID,EntityID,EmailTypeID,Email,IsDefault,Active,InactiveCode,DateCreated,DateModified" index="currentVar">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getEmailAddressQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getEmailAddressQuery">						
		<cfargument name="Fields" required="No" type="String" default="EmailAddressID,SiteID,EntityID,EmailTypeID,Email,IsDefault,Active,InactiveCode,DateCreated,DateModified">	
		...
		<cfargument name="EmailAddressID" required="No" type="String" default="">
		<cfargument name="EmailAddressID_IN" required="No" type="String" default="">
		<cfargument name="EmailAddressID_LIKE" required="No" type="String" default="">
		<cfargument name="SiteID" required="No" type="String" default="">
		...
		<cfargument name="EmailTypeID" required="No" type="String" default="">
		<cfargument name="EmailTypeID_IN" required="No" type="String" default="">
		<cfargument name="EmailTypeID_LIKE" required="No" type="String" default="">
		<cfargument name="Email" required="No" type="String" default="">
		<cfargument name="Email_IN" required="No" type="String" default="">
		<cfargument name="Email_LIKE" required="No" type="String" default="">
		<cfargument name="IsDefault" required="No" type="String" default="">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfset availableColumns = "EmailAddressID,EmailAddressID_IN,EmailAddressID_LIKE,SiteID,SiteID_IN,SiteID_LIKE,EntityID,EntityID_IN,EntityID_LIKE,EmailTypeID,EmailTypeID_IN,EmailTypeID_LIKE,Email,Email_IN,Email_LIKE,IsDefault,IsDefault_IN,IsDefault_LIKE,Active,Active_IN,Active_LIKE,InactiveCode,InactiveCode_IN,InactiveCode_LIKE,DateCreated,DateCreated_IN,DateCreated_LIKE,DateModified,DateModified_IN,DateModified_LIKE,top1">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfquery Name="getEmailAddressQuery" datasource="#trim(request.datasource)#">
				...
				WHERE 1=1
					...
					<cfif EmailAddressID_LIKE NEQ "">AND EmailAddressID LIKE '%#trim(EmailAddressID_LIKE)#%'</cfif>
					...
					<cfif EmailTypeID NEQ "" AND IsNumeric(EmailTypeID)>AND EmailTypeID = #EmailTypeID#</cfif>
					<cfif EmailTypeID_IN NEQ "">AND EmailTypeID IN(#trim(EmailTypeID_IN)#)</cfif>
					<cfif EmailTypeID_LIKE NEQ "">AND EmailTypeID LIKE '%#trim(EmailTypeID_LIKE)#%'</cfif>
					<cfif Email NEQ "">AND Email = '#Email#'</cfif>
					<cfif Email_IN NEQ "">AND Email IN(#trim(Email_IN)#)</cfif>
					<cfif Email_LIKE NEQ "">AND Email LIKE '%#trim(Email_LIKE)#%'</cfif>
					<cfif IsDefault NEQ "">AND IsDefault = '#IsDefault#'</cfif>
