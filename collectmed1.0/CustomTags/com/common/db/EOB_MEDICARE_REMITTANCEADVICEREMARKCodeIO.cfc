...
<!--- NAME:                                                                          --->
<!--- @@Name@@                                                                       --->
<!--- EOB_MEDICARE_REMITTANCEADVICEREMARKCodeIO.cfc                                  --->
<!--- @@Name@@                                                                       --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- CATEGORY:                                                                      --->
...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the EOB_MEDICARE_REMITTANCEADVICEREMARKCode      --->
<!--- table in the dB.                                                               --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_EOB_MEDICARE_REMITTANCEADVICEREMARKCodeTable                     --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<cfcomponent name="EOB_MEDICARE_REMITTANCEADVICEREMARKCodeIO">
...
<!-------------------------------------------------------------------------------------->
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="Init" access="public" returntype="EOB_MEDICARE_REMITTANCEADVICEREMARKCodeIO" output="No">
		...
		<cfscript>
			IF(qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.RecordID EQ "" OR qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.RecordID EQ "NULL") 
				variables.instance.RecordID = "NULL"; 
			ELSE 
				variables.instance.RecordID = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.RecordID;
							
				variables.instance.Code = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.Code;
							
				variables.instance.Description = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.Description;
							
				variables.instance.Active = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.Active;
				
			IF(qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.InactiveCode EQ "" OR qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.InactiveCode;
							
				variables.instance.DateCreated = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.DateCreated;
							
				variables.instance.DateModified = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.DateModified;
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
	 	...
	 	<cfset var qCommitEOB_MEDICARE_REMITTANCEADVICEREMARKCode = "">
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfset variables.instance.RecordID = qInsertCommitEOB_MEDICARE_REMITTANCEADVICEREMARKCode.RecordID>
				
				<cfreturn qInsertCommitEOB_MEDICARE_REMITTANCEADVICEREMARKCode.RecordID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->					
			...
			<!-------------------------------------------------------------------------------------->	
				<cfset sqlStatement = "UPDATE EOB_MEDICARE_REMITTANCEADVICEREMARKCode  SET #columnsToUpdate# WHERE RecordID = #trim(variables.instance.RecordID)#">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getEOB_MEDICARE_REMITTANCEADVICEREMARKCodeQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getEOB_MEDICARE_REMITTANCEADVICEREMARKCodeQuery">						
			...
			<cfloop from="1" to="#ArrayLen(keysToStruct)#" index="i">
				...
				<cfif NOT ListFindNoCase("QueryName|Fields|OrderBy|GroupBy", keysToStruct[i], "|") AND Find("_IN", keysToStruct[i]) EQ 0 AND Find("_LIKE", keysToStruct[i]) EQ 0>
					...
					<cfif NOT ListFindNoCase(availableColumns, keysToStruct[i])>
						<cf_gcGeneralErrorTemplate				
							invisible="EOB_MEDICARE_REMITTANCEADVICEREMARKCode"
		...
		<!-------------------------------------------------------------------------------------->			
			...
			<cfreturn getEOB_MEDICARE_REMITTANCEADVICEREMARKCodeQuery>
