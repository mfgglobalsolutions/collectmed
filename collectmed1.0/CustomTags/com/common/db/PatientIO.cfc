...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the Patient table in the dB.                     --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_PatientTable                                                     --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<!--- PatientID<br>                                                                  --->
<!--- EntityID<br>                                                                   --->
<!--- ClaimSubmitterIdentifier<br>                                                   --->
<!--- NM1IdentificationCode9<br>                                                     --->
<!--- AccountNumber<br>                                                              --->
<!--- Active<br>                                                                     --->
<!--- InactiveCode<br>                                                               --->
<!--- DateCreated<br>                                                                --->
...
<!-------------------------------------------------------------------------------------->
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "PATIENTID", 1)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "CLAIMSUBMITTERIDENTIFIER", 3)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "NM1IDENTIFICATIONCODE9", 4)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "ACCOUNTNUMBER", 5)>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for ClaimSubmitterIdentifier.                               --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getClaimSubmitterIdentifier" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.ClaimSubmitterIdentifier>
	</cffunction>
	 
	<cffunction name="setClaimSubmitterIdentifier" access="public" returntype="boolean" output="No">
 		
		<cfargument name="ClaimSubmitterIdentifier" required="Yes" type="String">
		
		<cfif ClaimSubmitterIdentifier NEQ "NULL">	
			
			<cfif arguments.ClaimSubmitterIdentifier EQ "@@" OR arguments.ClaimSubmitterIdentifier EQ "">
				
				<cfset arguments.ClaimSubmitterIdentifier = "NULL">
						
			<cfelseif NOT REQUEST.isvarcharDataType(ClaimSubmitterIdentifier)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>ClaimSubmitterIdentifier</strong> (#ClaimSubmitterIdentifier#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(ClaimSubmitterIdentifier) GT 38>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>ClaimSubmitterIdentifier</strong> cannot be greater than 38 character(s).">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.ClaimSubmitterIdentifier = arguments.ClaimSubmitterIdentifier>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "ClaimSubmitterIdentifier")>			
		<cfreturn true>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for NM1IdentificationCode9.                                 --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getNM1IdentificationCode9" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.NM1IdentificationCode9>
	</cffunction>
	 
	<cffunction name="setNM1IdentificationCode9" access="public" returntype="boolean" output="No">
 		
		<cfargument name="NM1IdentificationCode9" required="Yes" type="String">
		
		<cfif NM1IdentificationCode9 NEQ "NULL">	
			
			<cfif arguments.NM1IdentificationCode9 EQ "@@" OR arguments.NM1IdentificationCode9 EQ "">
				
				<cfset arguments.NM1IdentificationCode9 = "NULL">
						
			<cfelseif NOT REQUEST.isvarcharDataType(NM1IdentificationCode9)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>NM1IdentificationCode9</strong> (#NM1IdentificationCode9#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(NM1IdentificationCode9) GT 80>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>NM1IdentificationCode9</strong> cannot be greater than 80 character(s).">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.NM1IdentificationCode9 = arguments.NM1IdentificationCode9>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "NM1IdentificationCode9")>			
		<cfreturn true>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for AccountNumber.                                          --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getAccountNumber" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.AccountNumber>
	</cffunction>
	 
	<cffunction name="setAccountNumber" access="public" returntype="boolean" output="No">
 		
		<cfargument name="AccountNumber" required="Yes" type="String">
		
		<cfif AccountNumber NEQ "NULL">	
			
			<cfif arguments.AccountNumber EQ "@@" OR arguments.AccountNumber EQ "">
				
				<cfset arguments.AccountNumber = "NULL">
						
			<cfelseif NOT REQUEST.isvarcharDataType(AccountNumber)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>AccountNumber</strong> (#AccountNumber#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(AccountNumber) GT 25>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>AccountNumber</strong> cannot be greater than 25 character(s).">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.AccountNumber = arguments.AccountNumber>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "AccountNumber")>			
		<cfreturn true>
	...
	<cffunction name="new" access="public" output="no">
		...
		<cfargument name="NM1IdentificationCode9" required="No" type="String" default="">
		<cfargument name="AccountNumber" required="No" type="String" default="">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="InitPatientIO" access="public" returntype="PatientIO" output="No">
		...
		<cfscript>
			IF(qGetPatient.PatientID EQ "" OR qGetPatient.PatientID EQ "NULL") 
				variables.instance.PatientID = "NULL"; 
			ELSE 
				variables.instance.PatientID = qGetPatient.PatientID;
				
			IF(qGetPatient.EntityID EQ "" OR qGetPatient.EntityID EQ "NULL") 
				variables.instance.EntityID = "NULL"; 
			ELSE 
				variables.instance.EntityID = qGetPatient.EntityID;
							
				variables.instance.ClaimSubmitterIdentifier = qGetPatient.ClaimSubmitterIdentifier;
							
				variables.instance.NM1IdentificationCode9 = qGetPatient.NM1IdentificationCode9;
							
				variables.instance.AccountNumber = qGetPatient.AccountNumber;
							
				variables.instance.Active = qGetPatient.Active;
				
			IF(qGetPatient.InactiveCode EQ "" OR qGetPatient.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetPatient.InactiveCode;
							
				variables.instance.DateCreated = qGetPatient.DateCreated;
							
				variables.instance.DateModified = qGetPatient.DateModified;
				
		</cfscript>		
		  
		<cfset postInit(PatientID)>
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
	 	...
	 	<cfset var qCommitPatient = "">
		
		<cfset preUpdateCommit()>
	 	
		<cfif IsNumeric(variables.instance.PatientID) AND variables.instance.PatientID  GT 0>	  		
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfset variables.instance.PatientID = qInsertCommitPatient.PatientID>
				
				<cfreturn qInsertCommitPatient.PatientID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->	
			<cfset tableColumns = "PatientID,EntityID,ClaimSubmitterIdentifier,NM1IdentificationCode9,AccountNumber,Active,InactiveCode,DateCreated,DateModified">		
			
		<!-------------------------------------------------------------------------------------->
		<!--- Denote the column names that need single quotes (strings).                     --->
		<!-------------------------------------------------------------------------------------->
			<cfset stringTableColumns = "ClaimSubmitterIdentifier,NM1IdentificationCode9,AccountNumber,Active">	
		...
		<!-------------------------------------------------------------------------------------->					
			...
			<!-------------------------------------------------------------------------------------->	
				<cfset sqlStatement = "UPDATE patient  SET #columnsToUpdate# WHERE PatientID = #trim(variables.instance.PatientID)#">
	...
	<cffunction name="preInsertDataCheck" output="no">		
		...
		<!--- append it to the update statement.                                             --->
		<!-------------------------------------------------------------------------------------->					
			<cfloop list="EntityID,ClaimSubmitterIdentifier,NM1IdentificationCode9,AccountNumber,Active,InactiveCode,DateCreated,DateModified" index="currentVar">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getPatientQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getPatientQuery">						
		<cfargument name="Fields" required="No" type="String" default="PatientID,EntityID,ClaimSubmitterIdentifier,NM1IdentificationCode9,AccountNumber,Active,InactiveCode,DateCreated,DateModified">	
		...
		<cfargument name="ClaimSubmitterIdentifier" required="No" type="String" default="">
		<cfargument name="ClaimSubmitterIdentifier_IN" required="No" type="String" default="">
		<cfargument name="ClaimSubmitterIdentifier_LIKE" required="No" type="String" default="">
		<cfargument name="NM1IdentificationCode9" required="No" type="String" default="">
		<cfargument name="NM1IdentificationCode9_IN" required="No" type="String" default="">
		<cfargument name="NM1IdentificationCode9_LIKE" required="No" type="String" default="">
		<cfargument name="AccountNumber" required="No" type="String" default="">
		<cfargument name="AccountNumber_IN" required="No" type="String" default="">
		<cfargument name="AccountNumber_LIKE" required="No" type="String" default="">
		<cfargument name="Active" required="No" type="String" default="">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfset availableColumns = "PatientID,PatientID_IN,PatientID_LIKE,EntityID,EntityID_IN,EntityID_LIKE,ClaimSubmitterIdentifier,ClaimSubmitterIdentifier_IN,ClaimSubmitterIdentifier_LIKE,NM1IdentificationCode9,NM1IdentificationCode9_IN,NM1IdentificationCode9_LIKE,AccountNumber,AccountNumber_IN,AccountNumber_LIKE,Active,Active_IN,Active_LIKE,InactiveCode,InactiveCode_IN,InactiveCode_LIKE,DateCreated,DateCreated_IN,DateCreated_LIKE,DateModified,DateModified_IN,DateModified_LIKE,top1">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfquery Name="getPatientQuery" datasource="#trim(request.datasource)#">
				...
				WHERE 1=1
					...
					<cfif ClaimSubmitterIdentifier NEQ "">AND ClaimSubmitterIdentifier = '#ClaimSubmitterIdentifier#'</cfif>
					<cfif ClaimSubmitterIdentifier_IN NEQ "">AND ClaimSubmitterIdentifier IN(#trim(ClaimSubmitterIdentifier_IN)#)</cfif>
					<cfif ClaimSubmitterIdentifier_LIKE NEQ "">AND ClaimSubmitterIdentifier LIKE '%#trim(ClaimSubmitterIdentifier_LIKE)#%'</cfif>
					<cfif NM1IdentificationCode9 NEQ "">AND NM1IdentificationCode9 = '#NM1IdentificationCode9#'</cfif>
					<cfif NM1IdentificationCode9_IN NEQ "">AND NM1IdentificationCode9 IN(#trim(NM1IdentificationCode9_IN)#)</cfif>
					<cfif NM1IdentificationCode9_LIKE NEQ "">AND NM1IdentificationCode9 LIKE '%#trim(NM1IdentificationCode9_LIKE)#%'</cfif>
					<cfif AccountNumber NEQ "">AND AccountNumber = '#AccountNumber#'</cfif>
					<cfif AccountNumber_IN NEQ "">AND AccountNumber IN(#trim(AccountNumber_IN)#)</cfif>
					<cfif AccountNumber_LIKE NEQ "">AND AccountNumber LIKE '%#trim(AccountNumber_LIKE)#%'</cfif>
