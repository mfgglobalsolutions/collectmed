...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the QuoteHCPC table in the dB.                   --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_QuoteHCPCTable                                                   --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<cfcomponent name="QuoteHCPCIO">
	...
	<cffunction name="reset" access="public" output="no">
		...
		<cfscript>
			...
			variables.instance.QuoteHCPCID = "NULL";
...
<!-------------------------------------------------------------------------------------->
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "QUOTEHCPCID", 1)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "QUOTEID", 2)>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for QuoteHCPCID.                                            --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getQuoteHCPCID" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.QuoteHCPCID>
	</cffunction>
	 
	<cffunction name="setQuoteHCPCID" access="public" returntype="boolean" output="No">
 		
		<cfargument name="QuoteHCPCID" required="Yes" type="String">
		
		<cfif QuoteHCPCID NEQ "NULL">	
			
			<cfif arguments.QuoteHCPCID EQ "@@" OR arguments.QuoteHCPCID EQ "">
				
				<cfset arguments.QuoteHCPCID = "NULL">
						
			<cfelseif NOT REQUEST.isintDataType(QuoteHCPCID)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>QuoteHCPCID</strong> (#QuoteHCPCID#) is not of type <strong>int</strong>.">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.QuoteHCPCID = arguments.QuoteHCPCID>			
		<cfreturn true>
	...
	<cffunction name="setQuoteID" access="public" returntype="boolean" output="No">
		...
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "QuoteID")>			
		<cfreturn true>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="Init" access="public" returntype="QuoteHCPCIO" output="No">
		
		<cfargument name="QuoteHCPCID" required="yes" type="numeric">		
		<cfset var qGetQuoteHCPC = "">
		
		<cfset preInit(QuoteHCPCID)>
	
		<cfquery name="qGetQuoteHCPC" datasource="#trim(request.datasource)#">
			...
			FROM quotehcpc  
			WHERE QuoteHCPCID = #trim(arguments.QuoteHCPCID)# 
		</cfquery>
		...
		<cfscript>
			IF(qGetQuoteHCPC.QuoteHCPCID EQ "" OR qGetQuoteHCPC.QuoteHCPCID EQ "NULL") 
				variables.instance.QuoteHCPCID = "NULL"; 
			ELSE 
				variables.instance.QuoteHCPCID = qGetQuoteHCPC.QuoteHCPCID;
				
			IF(qGetQuoteHCPC.QuoteID EQ "" OR qGetQuoteHCPC.QuoteID EQ "NULL") 
				variables.instance.QuoteID = "NULL"; 
			ELSE 
				variables.instance.QuoteID = qGetQuoteHCPC.QuoteID;
							
				variables.instance.hcpcCode1TBox = qGetQuoteHCPC.hcpcCode1TBox;
							
				variables.instance.hcpcQty1TBox = qGetQuoteHCPC.hcpcQty1TBox;
							
				variables.instance.hcpcProduct1TBox = qGetQuoteHCPC.hcpcProduct1TBox;
							
				variables.instance.hcpcDX1TBox = qGetQuoteHCPC.hcpcDX1TBox;
							
				variables.instance.hcpcDiagnosis1TBox = qGetQuoteHCPC.hcpcDiagnosis1TBox;
							
				variables.instance.hcpcCost1TBox = qGetQuoteHCPC.hcpcCost1TBox;
							
				variables.instance.hcpcLengthOfNeedYear1TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear1TBox;
							
				variables.instance.hcpcLengthOfNeedMonth1TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth1TBox;
							
				variables.instance.hcpcCode2TBox = qGetQuoteHCPC.hcpcCode2TBox;
							
				variables.instance.hcpcQty2TBox = qGetQuoteHCPC.hcpcQty2TBox;
							
				variables.instance.hcpcProduct2TBox = qGetQuoteHCPC.hcpcProduct2TBox;
							
				variables.instance.hcpcDX2TBox = qGetQuoteHCPC.hcpcDX2TBox;
							
				variables.instance.hcpcDiagnosis2TBox = qGetQuoteHCPC.hcpcDiagnosis2TBox;
							
				variables.instance.hcpcCost2TBox = qGetQuoteHCPC.hcpcCost2TBox;
							
				variables.instance.hcpcLengthOfNeedYear2TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear2TBox;
							
				variables.instance.hcpcLengthOfNeedMonth2TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth2TBox;
							
				variables.instance.hcpcCode3TBox = qGetQuoteHCPC.hcpcCode3TBox;
							
				variables.instance.hcpcQty3TBox = qGetQuoteHCPC.hcpcQty3TBox;
							
				variables.instance.hcpcProduct3TBox = qGetQuoteHCPC.hcpcProduct3TBox;
							
				variables.instance.hcpcDX3TBox = qGetQuoteHCPC.hcpcDX3TBox;
							
				variables.instance.hcpcDiagnosis3TBox = qGetQuoteHCPC.hcpcDiagnosis3TBox;
							
				variables.instance.hcpcCost3TBox = qGetQuoteHCPC.hcpcCost3TBox;
							
				variables.instance.hcpcLengthOfNeedYear3TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear3TBox;
							
				variables.instance.hcpcLengthOfNeedMonth3TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth3TBox;
							
				variables.instance.hcpcCode4TBox = qGetQuoteHCPC.hcpcCode4TBox;
							
				variables.instance.hcpcQty4TBox = qGetQuoteHCPC.hcpcQty4TBox;
							
				variables.instance.hcpcProduct4TBox = qGetQuoteHCPC.hcpcProduct4TBox;
							
				variables.instance.hcpcDX4TBox = qGetQuoteHCPC.hcpcDX4TBox;
							
				variables.instance.hcpcDiagnosis4TBox = qGetQuoteHCPC.hcpcDiagnosis4TBox;
							
				variables.instance.hcpcCost4TBox = qGetQuoteHCPC.hcpcCost4TBox;
							
				variables.instance.hcpcLengthOfNeedYear4TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear4TBox;
							
				variables.instance.hcpcLengthOfNeedMonth4TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth4TBox;
							
				variables.instance.hcpcCode5TBox = qGetQuoteHCPC.hcpcCode5TBox;
							
				variables.instance.hcpcQty5TBox = qGetQuoteHCPC.hcpcQty5TBox;
							
				variables.instance.hcpcProduct5TBox = qGetQuoteHCPC.hcpcProduct5TBox;
							
				variables.instance.hcpcDX5TBox = qGetQuoteHCPC.hcpcDX5TBox;
							
				variables.instance.hcpcDiagnosis5TBox = qGetQuoteHCPC.hcpcDiagnosis5TBox;
							
				variables.instance.hcpcCost5TBox = qGetQuoteHCPC.hcpcCost5TBox;
							
				variables.instance.hcpcLengthOfNeedYear5TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear5TBox;
							
				variables.instance.hcpcLengthOfNeedMonth5TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth5TBox;
							
				variables.instance.hcpcCode6TBox = qGetQuoteHCPC.hcpcCode6TBox;
							
				variables.instance.hcpcQty6TBox = qGetQuoteHCPC.hcpcQty6TBox;
							
				variables.instance.hcpcProduct6TBox = qGetQuoteHCPC.hcpcProduct6TBox;
							
				variables.instance.hcpcDX6TBox = qGetQuoteHCPC.hcpcDX6TBox;
							
				variables.instance.hcpcDiagnosis6TBox = qGetQuoteHCPC.hcpcDiagnosis6TBox;
							
				variables.instance.hcpcCost6TBox = qGetQuoteHCPC.hcpcCost6TBox;
							
				variables.instance.hcpcLengthOfNeedYear6TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear6TBox;
							
				variables.instance.hcpcLengthOfNeedMonth6TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth6TBox;
							
				variables.instance.hcpcCode7TBox = qGetQuoteHCPC.hcpcCode7TBox;
							
				variables.instance.hcpcQty7TBox = qGetQuoteHCPC.hcpcQty7TBox;
							
				variables.instance.hcpcProduct7TBox = qGetQuoteHCPC.hcpcProduct7TBox;
							
				variables.instance.hcpcDX7TBox = qGetQuoteHCPC.hcpcDX7TBox;
							
				variables.instance.hcpcDiagnosis7TBox = qGetQuoteHCPC.hcpcDiagnosis7TBox;
							
				variables.instance.hcpcCost7TBox = qGetQuoteHCPC.hcpcCost7TBox;
							
				variables.instance.hcpcLengthOfNeedYear7TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear7TBox;
							
				variables.instance.hcpcLengthOfNeedMonth7TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth7TBox;
							
				variables.instance.hcpcCode8TBox = qGetQuoteHCPC.hcpcCode8TBox;
							
				variables.instance.hcpcQty8TBox = qGetQuoteHCPC.hcpcQty8TBox;
							
				variables.instance.hcpcProduct8TBox = qGetQuoteHCPC.hcpcProduct8TBox;
							
				variables.instance.hcpcDX8TBox = qGetQuoteHCPC.hcpcDX8TBox;
							
				variables.instance.hcpcDiagnosis8TBox = qGetQuoteHCPC.hcpcDiagnosis8TBox;
							
				variables.instance.hcpcCost8TBox = qGetQuoteHCPC.hcpcCost8TBox;
							
				variables.instance.hcpcLengthOfNeedYear8TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear8TBox;
							
				variables.instance.hcpcLengthOfNeedMonth8TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth8TBox;
							
				variables.instance.hcpcCode9TBox = qGetQuoteHCPC.hcpcCode9TBox;
							
				variables.instance.hcpcQty9TBox = qGetQuoteHCPC.hcpcQty9TBox;
							
				variables.instance.hcpcProduct9TBox = qGetQuoteHCPC.hcpcProduct9TBox;
							
				variables.instance.hcpcDX9TBox = qGetQuoteHCPC.hcpcDX9TBox;
							
				variables.instance.hcpcDiagnosis9TBox = qGetQuoteHCPC.hcpcDiagnosis9TBox;
							
				variables.instance.hcpcCost9TBox = qGetQuoteHCPC.hcpcCost9TBox;
							
				variables.instance.hcpcLengthOfNeedYear9TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear9TBox;
							
				variables.instance.hcpcLengthOfNeedMonth9TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth9TBox;
							
				variables.instance.hcpcCode10TBox = qGetQuoteHCPC.hcpcCode10TBox;
							
				variables.instance.hcpcQty10TBox = qGetQuoteHCPC.hcpcQty10TBox;
							
				variables.instance.hcpcProduct10TBox = qGetQuoteHCPC.hcpcProduct10TBox;
							
				variables.instance.hcpcDX10TBox = qGetQuoteHCPC.hcpcDX10TBox;
							
				variables.instance.hcpcDiagnosis10TBox = qGetQuoteHCPC.hcpcDiagnosis10TBox;
							
				variables.instance.hcpcCost10TBox = qGetQuoteHCPC.hcpcCost10TBox;
							
				variables.instance.hcpcLengthOfNeedYear10TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear10TBox;
							
				variables.instance.hcpcLengthOfNeedMonth10TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth10TBox;
							
				variables.instance.hcpcCode11TBox = qGetQuoteHCPC.hcpcCode11TBox;
							
				variables.instance.hcpcQty11TBox = qGetQuoteHCPC.hcpcQty11TBox;
							
				variables.instance.hcpcProduct11TBox = qGetQuoteHCPC.hcpcProduct11TBox;
							
				variables.instance.hcpcDX11TBox = qGetQuoteHCPC.hcpcDX11TBox;
							
				variables.instance.hcpcDiagnosis11TBox = qGetQuoteHCPC.hcpcDiagnosis11TBox;
							
				variables.instance.hcpcCost11TBox = qGetQuoteHCPC.hcpcCost11TBox;
							
				variables.instance.hcpcLengthOfNeedYear11TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear11TBox;
							
				variables.instance.hcpcLengthOfNeedMonth11TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth11TBox;
							
				variables.instance.hcpcCode12TBox = qGetQuoteHCPC.hcpcCode12TBox;
							
				variables.instance.hcpcQty12TBox = qGetQuoteHCPC.hcpcQty12TBox;
							
				variables.instance.hcpcProduct12TBox = qGetQuoteHCPC.hcpcProduct12TBox;
							
				variables.instance.hcpcDX12TBox = qGetQuoteHCPC.hcpcDX12TBox;
							
				variables.instance.hcpcDiagnosis12TBox = qGetQuoteHCPC.hcpcDiagnosis12TBox;
							
				variables.instance.hcpcCost12TBox = qGetQuoteHCPC.hcpcCost12TBox;
							
				variables.instance.hcpcLengthOfNeedYear12TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear12TBox;
							
				variables.instance.hcpcLengthOfNeedMonth12TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth12TBox;
							
				variables.instance.hcpcCode13TBox = qGetQuoteHCPC.hcpcCode13TBox;
							
				variables.instance.hcpcQty13TBox = qGetQuoteHCPC.hcpcQty13TBox;
							
				variables.instance.hcpcProduct13TBox = qGetQuoteHCPC.hcpcProduct13TBox;
							
				variables.instance.hcpcDX13TBox = qGetQuoteHCPC.hcpcDX13TBox;
							
				variables.instance.hcpcDiagnosis13TBox = qGetQuoteHCPC.hcpcDiagnosis13TBox;
							
				variables.instance.hcpcCost13TBox = qGetQuoteHCPC.hcpcCost13TBox;
							
				variables.instance.hcpcLengthOfNeedYear13TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear13TBox;
							
				variables.instance.hcpcLengthOfNeedMonth13TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth13TBox;
							
				variables.instance.hcpcCode14TBox = qGetQuoteHCPC.hcpcCode14TBox;
							
				variables.instance.hcpcQty14TBox = qGetQuoteHCPC.hcpcQty14TBox;
							
				variables.instance.hcpcProduct14TBox = qGetQuoteHCPC.hcpcProduct14TBox;
							
				variables.instance.hcpcDX14TBox = qGetQuoteHCPC.hcpcDX14TBox;
							
				variables.instance.hcpcDiagnosis14TBox = qGetQuoteHCPC.hcpcDiagnosis14TBox;
							
				variables.instance.hcpcCost14TBox = qGetQuoteHCPC.hcpcCost14TBox;
							
				variables.instance.hcpcLengthOfNeedYear14TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear14TBox;
							
				variables.instance.hcpcLengthOfNeedMonth14TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth14TBox;
							
				variables.instance.hcpcCode15TBox = qGetQuoteHCPC.hcpcCode15TBox;
							
				variables.instance.hcpcQty15TBox = qGetQuoteHCPC.hcpcQty15TBox;
							
				variables.instance.hcpcProduct15TBox = qGetQuoteHCPC.hcpcProduct15TBox;
							
				variables.instance.hcpcDX15TBox = qGetQuoteHCPC.hcpcDX15TBox;
							
				variables.instance.hcpcDiagnosis15TBox = qGetQuoteHCPC.hcpcDiagnosis15TBox;
							
				variables.instance.hcpcCost15TBox = qGetQuoteHCPC.hcpcCost15TBox;
							
				variables.instance.hcpcLengthOfNeedYear15TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear15TBox;
							
				variables.instance.hcpcLengthOfNeedMonth15TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth15TBox;
							
				variables.instance.hcpcCode16TBox = qGetQuoteHCPC.hcpcCode16TBox;
							
				variables.instance.hcpcQty16TBox = qGetQuoteHCPC.hcpcQty16TBox;
							
				variables.instance.hcpcProduct16TBox = qGetQuoteHCPC.hcpcProduct16TBox;
							
				variables.instance.hcpcDX16TBox = qGetQuoteHCPC.hcpcDX16TBox;
							
				variables.instance.hcpcDiagnosis16TBox = qGetQuoteHCPC.hcpcDiagnosis16TBox;
							
				variables.instance.hcpcCost16TBox = qGetQuoteHCPC.hcpcCost16TBox;
							
				variables.instance.hcpcLengthOfNeedYear16TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear16TBox;
							
				variables.instance.hcpcLengthOfNeedMonth16TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth16TBox;
							
				variables.instance.hcpcCode17TBox = qGetQuoteHCPC.hcpcCode17TBox;
							
				variables.instance.hcpcQty17TBox = qGetQuoteHCPC.hcpcQty17TBox;
							
				variables.instance.hcpcProduct17TBox = qGetQuoteHCPC.hcpcProduct17TBox;
							
				variables.instance.hcpcDX17TBox = qGetQuoteHCPC.hcpcDX17TBox;
							
				variables.instance.hcpcDiagnosis17TBox = qGetQuoteHCPC.hcpcDiagnosis17TBox;
							
				variables.instance.hcpcCost17TBox = qGetQuoteHCPC.hcpcCost17TBox;
							
				variables.instance.hcpcLengthOfNeedYear17TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear17TBox;
							
				variables.instance.hcpcLengthOfNeedMonth17TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth17TBox;
							
				variables.instance.hcpcCode18TBox = qGetQuoteHCPC.hcpcCode18TBox;
							
				variables.instance.hcpcQty18TBox = qGetQuoteHCPC.hcpcQty18TBox;
							
				variables.instance.hcpcProduct18TBox = qGetQuoteHCPC.hcpcProduct18TBox;
							
				variables.instance.hcpcDX18TBox = qGetQuoteHCPC.hcpcDX18TBox;
							
				variables.instance.hcpcDiagnosis18TBox = qGetQuoteHCPC.hcpcDiagnosis18TBox;
							
				variables.instance.hcpcCost18TBox = qGetQuoteHCPC.hcpcCost18TBox;
							
				variables.instance.hcpcLengthOfNeedYear18TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear18TBox;
							
				variables.instance.hcpcLengthOfNeedMonth18TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth18TBox;
							
				variables.instance.hcpcCode19TBox = qGetQuoteHCPC.hcpcCode19TBox;
							
				variables.instance.hcpcQty19TBox = qGetQuoteHCPC.hcpcQty19TBox;
							
				variables.instance.hcpcProduct19TBox = qGetQuoteHCPC.hcpcProduct19TBox;
							
				variables.instance.hcpcDX19TBox = qGetQuoteHCPC.hcpcDX19TBox;
							
				variables.instance.hcpcDiagnosis19TBox = qGetQuoteHCPC.hcpcDiagnosis19TBox;
							
				variables.instance.hcpcCost19TBox = qGetQuoteHCPC.hcpcCost19TBox;
							
				variables.instance.hcpcLengthOfNeedYear19TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear19TBox;
							
				variables.instance.hcpcLengthOfNeedMonth19TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth19TBox;
							
				variables.instance.hcpcCode20TBox = qGetQuoteHCPC.hcpcCode20TBox;
							
				variables.instance.hcpcQty20TBox = qGetQuoteHCPC.hcpcQty20TBox;
							
				variables.instance.hcpcProduct20TBox = qGetQuoteHCPC.hcpcProduct20TBox;
							
				variables.instance.hcpcDX20TBox = qGetQuoteHCPC.hcpcDX20TBox;
							
				variables.instance.hcpcDiagnosis20TBox = qGetQuoteHCPC.hcpcDiagnosis20TBox;
							
				variables.instance.hcpcCost20TBox = qGetQuoteHCPC.hcpcCost20TBox;
							
				variables.instance.hcpcLengthOfNeedYear20TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear20TBox;
							
				variables.instance.hcpcLengthOfNeedMonth20TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth20TBox;
							
				variables.instance.hcpcCode21TBox = qGetQuoteHCPC.hcpcCode21TBox;
							
				variables.instance.hcpcQty21TBox = qGetQuoteHCPC.hcpcQty21TBox;
							
				variables.instance.hcpcProduct21TBox = qGetQuoteHCPC.hcpcProduct21TBox;
							
				variables.instance.hcpcDX21TBox = qGetQuoteHCPC.hcpcDX21TBox;
							
				variables.instance.hcpcDiagnosis21TBox = qGetQuoteHCPC.hcpcDiagnosis21TBox;
							
				variables.instance.hcpcCost21TBox = qGetQuoteHCPC.hcpcCost21TBox;
							
				variables.instance.hcpcLengthOfNeedYear21TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear21TBox;
							
				variables.instance.hcpcLengthOfNeedMonth21TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth21TBox;
							
				variables.instance.hcpcCode22TBox = qGetQuoteHCPC.hcpcCode22TBox;
							
				variables.instance.hcpcQty22TBox = qGetQuoteHCPC.hcpcQty22TBox;
							
				variables.instance.hcpcProduct22TBox = qGetQuoteHCPC.hcpcProduct22TBox;
							
				variables.instance.hcpcDX22TBox = qGetQuoteHCPC.hcpcDX22TBox;
							
				variables.instance.hcpcDiagnosis22TBox = qGetQuoteHCPC.hcpcDiagnosis22TBox;
							
				variables.instance.hcpcCost22TBox = qGetQuoteHCPC.hcpcCost22TBox;
							
				variables.instance.hcpcLengthOfNeedYear22TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear22TBox;
							
				variables.instance.hcpcLengthOfNeedMonth22TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth22TBox;
							
				variables.instance.hcpcCode23TBox = qGetQuoteHCPC.hcpcCode23TBox;
							
				variables.instance.hcpcQty23TBox = qGetQuoteHCPC.hcpcQty23TBox;
							
				variables.instance.hcpcProduct23TBox = qGetQuoteHCPC.hcpcProduct23TBox;
							
				variables.instance.hcpcDX23TBox = qGetQuoteHCPC.hcpcDX23TBox;
							
				variables.instance.hcpcDiagnosis23TBox = qGetQuoteHCPC.hcpcDiagnosis23TBox;
							
				variables.instance.hcpcCost23TBox = qGetQuoteHCPC.hcpcCost23TBox;
							
				variables.instance.hcpcLengthOfNeedYear23TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear23TBox;
							
				variables.instance.hcpcLengthOfNeedMonth23TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth23TBox;
							
				variables.instance.hcpcCode24TBox = qGetQuoteHCPC.hcpcCode24TBox;
							
				variables.instance.hcpcQty24TBox = qGetQuoteHCPC.hcpcQty24TBox;
							
				variables.instance.hcpcProduct24TBox = qGetQuoteHCPC.hcpcProduct24TBox;
							
				variables.instance.hcpcDX24TBox = qGetQuoteHCPC.hcpcDX24TBox;
							
				variables.instance.hcpcDiagnosis24TBox = qGetQuoteHCPC.hcpcDiagnosis24TBox;
							
				variables.instance.hcpcCost24TBox = qGetQuoteHCPC.hcpcCost24TBox;
							
				variables.instance.hcpcLengthOfNeedYear24TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear24TBox;
							
				variables.instance.hcpcLengthOfNeedMonth24TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth24TBox;
							
				variables.instance.hcpcCode25TBox = qGetQuoteHCPC.hcpcCode25TBox;
							
				variables.instance.hcpcQty25TBox = qGetQuoteHCPC.hcpcQty25TBox;
							
				variables.instance.hcpcProduct25TBox = qGetQuoteHCPC.hcpcProduct25TBox;
							
				variables.instance.hcpcDX25TBox = qGetQuoteHCPC.hcpcDX25TBox;
							
				variables.instance.hcpcDiagnosis25TBox = qGetQuoteHCPC.hcpcDiagnosis25TBox;
							
				variables.instance.hcpcCost25TBox = qGetQuoteHCPC.hcpcCost25TBox;
							
				variables.instance.hcpcLengthOfNeedYear25TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear25TBox;
							
				variables.instance.hcpcLengthOfNeedMonth25TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth25TBox;
							
				variables.instance.hcpcCode26TBox = qGetQuoteHCPC.hcpcCode26TBox;
							
				variables.instance.hcpcQty26TBox = qGetQuoteHCPC.hcpcQty26TBox;
							
				variables.instance.hcpcProduct26TBox = qGetQuoteHCPC.hcpcProduct26TBox;
							
				variables.instance.hcpcDX26TBox = qGetQuoteHCPC.hcpcDX26TBox;
							
				variables.instance.hcpcDiagnosis26TBox = qGetQuoteHCPC.hcpcDiagnosis26TBox;
							
				variables.instance.hcpcCost26TBox = qGetQuoteHCPC.hcpcCost26TBox;
							
				variables.instance.hcpcLengthOfNeedYear26TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear26TBox;
							
				variables.instance.hcpcLengthOfNeedMonth26TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth26TBox;
							
				variables.instance.hcpcCode27TBox = qGetQuoteHCPC.hcpcCode27TBox;
							
				variables.instance.hcpcQty27TBox = qGetQuoteHCPC.hcpcQty27TBox;
							
				variables.instance.hcpcProduct27TBox = qGetQuoteHCPC.hcpcProduct27TBox;
							
				variables.instance.hcpcDX27TBox = qGetQuoteHCPC.hcpcDX27TBox;
							
				variables.instance.hcpcDiagnosis27TBox = qGetQuoteHCPC.hcpcDiagnosis27TBox;
							
				variables.instance.hcpcCost27TBox = qGetQuoteHCPC.hcpcCost27TBox;
							
				variables.instance.hcpcLengthOfNeedYear27TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear27TBox;
							
				variables.instance.hcpcLengthOfNeedMonth27TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth27TBox;
							
				variables.instance.hcpcCode28TBox = qGetQuoteHCPC.hcpcCode28TBox;
							
				variables.instance.hcpcQty28TBox = qGetQuoteHCPC.hcpcQty28TBox;
							
				variables.instance.hcpcProduct28TBox = qGetQuoteHCPC.hcpcProduct28TBox;
							
				variables.instance.hcpcDX28TBox = qGetQuoteHCPC.hcpcDX28TBox;
							
				variables.instance.hcpcDiagnosis28TBox = qGetQuoteHCPC.hcpcDiagnosis28TBox;
							
				variables.instance.hcpcCost28TBox = qGetQuoteHCPC.hcpcCost28TBox;
							
				variables.instance.hcpcLengthOfNeedYear28TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear28TBox;
							
				variables.instance.hcpcLengthOfNeedMonth28TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth28TBox;
							
				variables.instance.hcpcCode29TBox = qGetQuoteHCPC.hcpcCode29TBox;
							
				variables.instance.hcpcQty29TBox = qGetQuoteHCPC.hcpcQty29TBox;
							
				variables.instance.hcpcProduct29TBox = qGetQuoteHCPC.hcpcProduct29TBox;
							
				variables.instance.hcpcDX29TBox = qGetQuoteHCPC.hcpcDX29TBox;
							
				variables.instance.hcpcDiagnosis29TBox = qGetQuoteHCPC.hcpcDiagnosis29TBox;
							
				variables.instance.hcpcCost29TBox = qGetQuoteHCPC.hcpcCost29TBox;
							
				variables.instance.hcpcLengthOfNeedYear29TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear29TBox;
							
				variables.instance.hcpcLengthOfNeedMonth29TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth29TBox;
							
				variables.instance.hcpcCode30TBox = qGetQuoteHCPC.hcpcCode30TBox;
							
				variables.instance.hcpcQty30TBox = qGetQuoteHCPC.hcpcQty30TBox;
							
				variables.instance.hcpcProduct30TBox = qGetQuoteHCPC.hcpcProduct30TBox;
							
				variables.instance.hcpcDX30TBox = qGetQuoteHCPC.hcpcDX30TBox;
							
				variables.instance.hcpcDiagnosis30TBox = qGetQuoteHCPC.hcpcDiagnosis30TBox;
							
				variables.instance.hcpcCost30TBox = qGetQuoteHCPC.hcpcCost30TBox;
							
				variables.instance.hcpcLengthOfNeedYear30TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear30TBox;
							
				variables.instance.hcpcLengthOfNeedMonth30TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth30TBox;
							
				variables.instance.hcpcCode31TBox = qGetQuoteHCPC.hcpcCode31TBox;
							
				variables.instance.hcpcQty31TBox = qGetQuoteHCPC.hcpcQty31TBox;
							
				variables.instance.hcpcProduct31TBox = qGetQuoteHCPC.hcpcProduct31TBox;
							
				variables.instance.hcpcDX31TBox = qGetQuoteHCPC.hcpcDX31TBox;
							
				variables.instance.hcpcDiagnosis31TBox = qGetQuoteHCPC.hcpcDiagnosis31TBox;
							
				variables.instance.hcpcCost31TBox = qGetQuoteHCPC.hcpcCost31TBox;
							
				variables.instance.hcpcLengthOfNeedYear31TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear31TBox;
							
				variables.instance.hcpcLengthOfNeedMonth31TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth31TBox;
							
				variables.instance.hcpcCode32TBox = qGetQuoteHCPC.hcpcCode32TBox;
							
				variables.instance.hcpcQty32TBox = qGetQuoteHCPC.hcpcQty32TBox;
							
				variables.instance.hcpcProduct32TBox = qGetQuoteHCPC.hcpcProduct32TBox;
							
				variables.instance.hcpcDX32TBox = qGetQuoteHCPC.hcpcDX32TBox;
							
				variables.instance.hcpcDiagnosis32TBox = qGetQuoteHCPC.hcpcDiagnosis32TBox;
							
				variables.instance.hcpcCost32TBox = qGetQuoteHCPC.hcpcCost32TBox;
							
				variables.instance.hcpcLengthOfNeedYear32TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear32TBox;
							
				variables.instance.hcpcLengthOfNeedMonth32TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth32TBox;
							
				variables.instance.hcpcCode33TBox = qGetQuoteHCPC.hcpcCode33TBox;
							
				variables.instance.hcpcQty33TBox = qGetQuoteHCPC.hcpcQty33TBox;
							
				variables.instance.hcpcProduct33TBox = qGetQuoteHCPC.hcpcProduct33TBox;
							
				variables.instance.hcpcDX33TBox = qGetQuoteHCPC.hcpcDX33TBox;
							
				variables.instance.hcpcDiagnosis33TBox = qGetQuoteHCPC.hcpcDiagnosis33TBox;
							
				variables.instance.hcpcCost33TBox = qGetQuoteHCPC.hcpcCost33TBox;
							
				variables.instance.hcpcLengthOfNeedYear33TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear33TBox;
							
				variables.instance.hcpcLengthOfNeedMonth33TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth33TBox;
							
				variables.instance.hcpcCode34TBox = qGetQuoteHCPC.hcpcCode34TBox;
							
				variables.instance.hcpcQty34TBox = qGetQuoteHCPC.hcpcQty34TBox;
							
				variables.instance.hcpcProduct34TBox = qGetQuoteHCPC.hcpcProduct34TBox;
							
				variables.instance.hcpcDX34TBox = qGetQuoteHCPC.hcpcDX34TBox;
							
				variables.instance.hcpcDiagnosis34TBox = qGetQuoteHCPC.hcpcDiagnosis34TBox;
							
				variables.instance.hcpcCost34TBox = qGetQuoteHCPC.hcpcCost34TBox;
							
				variables.instance.hcpcLengthOfNeedYear34TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear34TBox;
							
				variables.instance.hcpcLengthOfNeedMonth34TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth34TBox;
							
				variables.instance.hcpcCode35TBox = qGetQuoteHCPC.hcpcCode35TBox;
							
				variables.instance.hcpcQty35TBox = qGetQuoteHCPC.hcpcQty35TBox;
							
				variables.instance.hcpcProduct35TBox = qGetQuoteHCPC.hcpcProduct35TBox;
							
				variables.instance.hcpcDX35TBox = qGetQuoteHCPC.hcpcDX35TBox;
							
				variables.instance.hcpcDiagnosis35TBox = qGetQuoteHCPC.hcpcDiagnosis35TBox;
							
				variables.instance.hcpcCost35TBox = qGetQuoteHCPC.hcpcCost35TBox;
							
				variables.instance.hcpcLengthOfNeedYear35TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear35TBox;
							
				variables.instance.hcpcLengthOfNeedMonth35TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth35TBox;
							
				variables.instance.hcpcCode36TBox = qGetQuoteHCPC.hcpcCode36TBox;
							
				variables.instance.hcpcQty36TBox = qGetQuoteHCPC.hcpcQty36TBox;
							
				variables.instance.hcpcProduct36TBox = qGetQuoteHCPC.hcpcProduct36TBox;
							
				variables.instance.hcpcDX36TBox = qGetQuoteHCPC.hcpcDX36TBox;
							
				variables.instance.hcpcDiagnosis36TBox = qGetQuoteHCPC.hcpcDiagnosis36TBox;
							
				variables.instance.hcpcCost36TBox = qGetQuoteHCPC.hcpcCost36TBox;
							
				variables.instance.hcpcLengthOfNeedYear36TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear36TBox;
							
				variables.instance.hcpcLengthOfNeedMonth36TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth36TBox;
							
				variables.instance.hcpcCode37TBox = qGetQuoteHCPC.hcpcCode37TBox;
							
				variables.instance.hcpcQty37TBox = qGetQuoteHCPC.hcpcQty37TBox;
							
				variables.instance.hcpcProduct37TBox = qGetQuoteHCPC.hcpcProduct37TBox;
							
				variables.instance.hcpcDX37TBox = qGetQuoteHCPC.hcpcDX37TBox;
							
				variables.instance.hcpcDiagnosis37TBox = qGetQuoteHCPC.hcpcDiagnosis37TBox;
							
				variables.instance.hcpcCost37TBox = qGetQuoteHCPC.hcpcCost37TBox;
							
				variables.instance.hcpcLengthOfNeedYear37TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear37TBox;
							
				variables.instance.hcpcLengthOfNeedMonth37TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth37TBox;
							
				variables.instance.hcpcCode38TBox = qGetQuoteHCPC.hcpcCode38TBox;
							
				variables.instance.hcpcQty38TBox = qGetQuoteHCPC.hcpcQty38TBox;
							
				variables.instance.hcpcProduct38TBox = qGetQuoteHCPC.hcpcProduct38TBox;
							
				variables.instance.hcpcDX38TBox = qGetQuoteHCPC.hcpcDX38TBox;
							
				variables.instance.hcpcDiagnosis38TBox = qGetQuoteHCPC.hcpcDiagnosis38TBox;
							
				variables.instance.hcpcCost38TBox = qGetQuoteHCPC.hcpcCost38TBox;
							
				variables.instance.hcpcLengthOfNeedYear38TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear38TBox;
							
				variables.instance.hcpcLengthOfNeedMonth38TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth38TBox;
							
				variables.instance.hcpcCode39TBox = qGetQuoteHCPC.hcpcCode39TBox;
							
				variables.instance.hcpcQty39TBox = qGetQuoteHCPC.hcpcQty39TBox;
							
				variables.instance.hcpcProduct39TBox = qGetQuoteHCPC.hcpcProduct39TBox;
							
				variables.instance.hcpcDX39TBox = qGetQuoteHCPC.hcpcDX39TBox;
							
				variables.instance.hcpcDiagnosis39TBox = qGetQuoteHCPC.hcpcDiagnosis39TBox;
							
				variables.instance.hcpcCost39TBox = qGetQuoteHCPC.hcpcCost39TBox;
							
				variables.instance.hcpcLengthOfNeedYear39TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear39TBox;
							
				variables.instance.hcpcLengthOfNeedMonth39TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth39TBox;
							
				variables.instance.hcpcCode40TBox = qGetQuoteHCPC.hcpcCode40TBox;
							
				variables.instance.hcpcQty40TBox = qGetQuoteHCPC.hcpcQty40TBox;
							
				variables.instance.hcpcProduct40TBox = qGetQuoteHCPC.hcpcProduct40TBox;
							
				variables.instance.hcpcDX40TBox = qGetQuoteHCPC.hcpcDX40TBox;
							
				variables.instance.hcpcDiagnosis40TBox = qGetQuoteHCPC.hcpcDiagnosis40TBox;
							
				variables.instance.hcpcCost40TBox = qGetQuoteHCPC.hcpcCost40TBox;
							
				variables.instance.hcpcLengthOfNeedYear40TBox = qGetQuoteHCPC.hcpcLengthOfNeedYear40TBox;
							
				variables.instance.hcpcLengthOfNeedMonth40TBox = qGetQuoteHCPC.hcpcLengthOfNeedMonth40TBox;
							
				variables.instance.Active = qGetQuoteHCPC.Active;
				
			IF(qGetQuoteHCPC.InactiveCode EQ "" OR qGetQuoteHCPC.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetQuoteHCPC.InactiveCode;
							
				variables.instance.DateCreated = qGetQuoteHCPC.DateCreated;
							
				variables.instance.DateModified = qGetQuoteHCPC.DateModified;
				
		</cfscript>		
		  
		<cfset postInit(QuoteHCPCID)>
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
	 	...
	 	<cfset var qCommitQuoteHCPC = "">
		
		<cfset preUpdateCommit()>
	 	
		<cfif IsNumeric(variables.instance.QuoteHCPCID) AND variables.instance.QuoteHCPCID  GT 0>	  		
			
			<cfif ListLen(trim(variables.instance.changedVariables)) GTE 1>
			
				<cfset sqlStatement = preUpdateDataCheck()>				
				
				<cfquery name="qUpdateCommitQuoteHCPC" datasource="#trim(request.datasource)#">
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfquery name="qInsertCommitQuoteHCPC" datasource="#trim(request.datasource)#">
		   			#PreserveSingleQuotes(sqlStatement)#
		   		</cfquery>		
		 					
				<cfset postInsertCommit()>
				
				<cfset variables.instance.QuoteHCPCID = qInsertCommitQuoteHCPC.QuoteHCPCID>
				
				<cfreturn qInsertCommitQuoteHCPC.QuoteHCPCID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->	
			<cfset tableColumns = "QuoteHCPCID,QuoteID,hcpcCode1TBox,hcpcQty1TBox,hcpcProduct1TBox,hcpcDX1TBox,hcpcDiagnosis1TBox,hcpcCost1TBox,hcpcLengthOfNeedYear1TBox,hcpcLengthOfNeedMonth1TBox,hcpcCode2TBox,hcpcQty2TBox,hcpcProduct2TBox,hcpcDX2TBox,hcpcDiagnosis2TBox,hcpcCost2TBox,hcpcLengthOfNeedYear2TBox,hcpcLengthOfNeedMonth2TBox,hcpcCode3TBox,hcpcQty3TBox,hcpcProduct3TBox,hcpcDX3TBox,hcpcDiagnosis3TBox,hcpcCost3TBox,hcpcLengthOfNeedYear3TBox,hcpcLengthOfNeedMonth3TBox,hcpcCode4TBox,hcpcQty4TBox,hcpcProduct4TBox,hcpcDX4TBox,hcpcDiagnosis4TBox,hcpcCost4TBox,hcpcLengthOfNeedYear4TBox,hcpcLengthOfNeedMonth4TBox,hcpcCode5TBox,hcpcQty5TBox,hcpcProduct5TBox,hcpcDX5TBox,hcpcDiagnosis5TBox,hcpcCost5TBox,hcpcLengthOfNeedYear5TBox,hcpcLengthOfNeedMonth5TBox,hcpcCode6TBox,hcpcQty6TBox,hcpcProduct6TBox,hcpcDX6TBox,hcpcDiagnosis6TBox,hcpcCost6TBox,hcpcLengthOfNeedYear6TBox,hcpcLengthOfNeedMonth6TBox,hcpcCode7TBox,hcpcQty7TBox,hcpcProduct7TBox,hcpcDX7TBox,hcpcDiagnosis7TBox,hcpcCost7TBox,hcpcLengthOfNeedYear7TBox,hcpcLengthOfNeedMonth7TBox,hcpcCode8TBox,hcpcQty8TBox,hcpcProduct8TBox,hcpcDX8TBox,hcpcDiagnosis8TBox,hcpcCost8TBox,hcpcLengthOfNeedYear8TBox,hcpcLengthOfNeedMonth8TBox,hcpcCode9TBox,hcpcQty9TBox,hcpcProduct9TBox,hcpcDX9TBox,hcpcDiagnosis9TBox,hcpcCost9TBox,hcpcLengthOfNeedYear9TBox,hcpcLengthOfNeedMonth9TBox,hcpcCode10TBox,hcpcQty10TBox,hcpcProduct10TBox,hcpcDX10TBox,hcpcDiagnosis10TBox,hcpcCost10TBox,hcpcLengthOfNeedYear10TBox,hcpcLengthOfNeedMonth10TBox,hcpcCode11TBox,hcpcQty11TBox,hcpcProduct11TBox,hcpcDX11TBox,hcpcDiagnosis11TBox,hcpcCost11TBox,hcpcLengthOfNeedYear11TBox,hcpcLengthOfNeedMonth11TBox,hcpcCode12TBox,hcpcQty12TBox,hcpcProduct12TBox,hcpcDX12TBox,hcpcDiagnosis12TBox,hcpcCost12TBox,hcpcLengthOfNeedYear12TBox,hcpcLengthOfNeedMonth12TBox,hcpcCode13TBox,hcpcQty13TBox,hcpcProduct13TBox,hcpcDX13TBox,hcpcDiagnosis13TBox,hcpcCost13TBox,hcpcLengthOfNeedYear13TBox,hcpcLengthOfNeedMonth13TBox,hcpcCode14TBox,hcpcQty14TBox,hcpcProduct14TBox,hcpcDX14TBox,hcpcDiagnosis14TBox,hcpcCost14TBox,hcpcLengthOfNeedYear14TBox,hcpcLengthOfNeedMonth14TBox,hcpcCode15TBox,hcpcQty15TBox,hcpcProduct15TBox,hcpcDX15TBox,hcpcDiagnosis15TBox,hcpcCost15TBox,hcpcLengthOfNeedYear15TBox,hcpcLengthOfNeedMonth15TBox,hcpcCode16TBox,hcpcQty16TBox,hcpcProduct16TBox,hcpcDX16TBox,hcpcDiagnosis16TBox,hcpcCost16TBox,hcpcLengthOfNeedYear16TBox,hcpcLengthOfNeedMonth16TBox,hcpcCode17TBox,hcpcQty17TBox,hcpcProduct17TBox,hcpcDX17TBox,hcpcDiagnosis17TBox,hcpcCost17TBox,hcpcLengthOfNeedYear17TBox,hcpcLengthOfNeedMonth17TBox,hcpcCode18TBox,hcpcQty18TBox,hcpcProduct18TBox,hcpcDX18TBox,hcpcDiagnosis18TBox,hcpcCost18TBox,hcpcLengthOfNeedYear18TBox,hcpcLengthOfNeedMonth18TBox,hcpcCode19TBox,hcpcQty19TBox,hcpcProduct19TBox,hcpcDX19TBox,hcpcDiagnosis19TBox,hcpcCost19TBox,hcpcLengthOfNeedYear19TBox,hcpcLengthOfNeedMonth19TBox,hcpcCode20TBox,hcpcQty20TBox,hcpcProduct20TBox,hcpcDX20TBox,hcpcDiagnosis20TBox,hcpcCost20TBox,hcpcLengthOfNeedYear20TBox,hcpcLengthOfNeedMonth20TBox,hcpcCode21TBox,hcpcQty21TBox,hcpcProduct21TBox,hcpcDX21TBox,hcpcDiagnosis21TBox,hcpcCost21TBox,hcpcLengthOfNeedYear21TBox,hcpcLengthOfNeedMonth21TBox,hcpcCode22TBox,hcpcQty22TBox,hcpcProduct22TBox,hcpcDX22TBox,hcpcDiagnosis22TBox,hcpcCost22TBox,hcpcLengthOfNeedYear22TBox,hcpcLengthOfNeedMonth22TBox,hcpcCode23TBox,hcpcQty23TBox,hcpcProduct23TBox,hcpcDX23TBox,hcpcDiagnosis23TBox,hcpcCost23TBox,hcpcLengthOfNeedYear23TBox,hcpcLengthOfNeedMonth23TBox,hcpcCode24TBox,hcpcQty24TBox,hcpcProduct24TBox,hcpcDX24TBox,hcpcDiagnosis24TBox,hcpcCost24TBox,hcpcLengthOfNeedYear24TBox,hcpcLengthOfNeedMonth24TBox,hcpcCode25TBox,hcpcQty25TBox,hcpcProduct25TBox,hcpcDX25TBox,hcpcDiagnosis25TBox,hcpcCost25TBox,hcpcLengthOfNeedYear25TBox,hcpcLengthOfNeedMonth25TBox,hcpcCode26TBox,hcpcQty26TBox,hcpcProduct26TBox,hcpcDX26TBox,hcpcDiagnosis26TBox,hcpcCost26TBox,hcpcLengthOfNeedYear26TBox,hcpcLengthOfNeedMonth26TBox,hcpcCode27TBox,hcpcQty27TBox,hcpcProduct27TBox,hcpcDX27TBox,hcpcDiagnosis27TBox,hcpcCost27TBox,hcpcLengthOfNeedYear27TBox,hcpcLengthOfNeedMonth27TBox,hcpcCode28TBox,hcpcQty28TBox,hcpcProduct28TBox,hcpcDX28TBox,hcpcDiagnosis28TBox,hcpcCost28TBox,hcpcLengthOfNeedYear28TBox,hcpcLengthOfNeedMonth28TBox,hcpcCode29TBox,hcpcQty29TBox,hcpcProduct29TBox,hcpcDX29TBox,hcpcDiagnosis29TBox,hcpcCost29TBox,hcpcLengthOfNeedYear29TBox,hcpcLengthOfNeedMonth29TBox,hcpcCode30TBox,hcpcQty30TBox,hcpcProduct30TBox,hcpcDX30TBox,hcpcDiagnosis30TBox,hcpcCost30TBox,hcpcLengthOfNeedYear30TBox,hcpcLengthOfNeedMonth30TBox,hcpcCode31TBox,hcpcQty31TBox,hcpcProduct31TBox,hcpcDX31TBox,hcpcDiagnosis31TBox,hcpcCost31TBox,hcpcLengthOfNeedYear31TBox,hcpcLengthOfNeedMonth31TBox,hcpcCode32TBox,hcpcQty32TBox,hcpcProduct32TBox,hcpcDX32TBox,hcpcDiagnosis32TBox,hcpcCost32TBox,hcpcLengthOfNeedYear32TBox,hcpcLengthOfNeedMonth32TBox,hcpcCode33TBox,hcpcQty33TBox,hcpcProduct33TBox,hcpcDX33TBox,hcpcDiagnosis33TBox,hcpcCost33TBox,hcpcLengthOfNeedYear33TBox,hcpcLengthOfNeedMonth33TBox,hcpcCode34TBox,hcpcQty34TBox,hcpcProduct34TBox,hcpcDX34TBox,hcpcDiagnosis34TBox,hcpcCost34TBox,hcpcLengthOfNeedYear34TBox,hcpcLengthOfNeedMonth34TBox,hcpcCode35TBox,hcpcQty35TBox,hcpcProduct35TBox,hcpcDX35TBox,hcpcDiagnosis35TBox,hcpcCost35TBox,hcpcLengthOfNeedYear35TBox,hcpcLengthOfNeedMonth35TBox,hcpcCode36TBox,hcpcQty36TBox,hcpcProduct36TBox,hcpcDX36TBox,hcpcDiagnosis36TBox,hcpcCost36TBox,hcpcLengthOfNeedYear36TBox,hcpcLengthOfNeedMonth36TBox,hcpcCode37TBox,hcpcQty37TBox,hcpcProduct37TBox,hcpcDX37TBox,hcpcDiagnosis37TBox,hcpcCost37TBox,hcpcLengthOfNeedYear37TBox,hcpcLengthOfNeedMonth37TBox,hcpcCode38TBox,hcpcQty38TBox,hcpcProduct38TBox,hcpcDX38TBox,hcpcDiagnosis38TBox,hcpcCost38TBox,hcpcLengthOfNeedYear38TBox,hcpcLengthOfNeedMonth38TBox,hcpcCode39TBox,hcpcQty39TBox,hcpcProduct39TBox,hcpcDX39TBox,hcpcDiagnosis39TBox,hcpcCost39TBox,hcpcLengthOfNeedYear39TBox,hcpcLengthOfNeedMonth39TBox,hcpcCode40TBox,hcpcQty40TBox,hcpcProduct40TBox,hcpcDX40TBox,hcpcDiagnosis40TBox,hcpcCost40TBox,hcpcLengthOfNeedYear40TBox,hcpcLengthOfNeedMonth40TBox,Active,InactiveCode,DateCreated,DateModified">		
	...
	<cffunction name="preInsertDataCheck" output="no">		
		...
		<!--- append it to the update statement.                                             --->
		<!-------------------------------------------------------------------------------------->					
			<cfloop list="QuoteID,hcpcCode1TBox,hcpcQty1TBox,hcpcProduct1TBox,hcpcDX1TBox,hcpcDiagnosis1TBox,hcpcCost1TBox,hcpcLengthOfNeedYear1TBox,hcpcLengthOfNeedMonth1TBox,hcpcCode2TBox,hcpcQty2TBox,hcpcProduct2TBox,hcpcDX2TBox,hcpcDiagnosis2TBox,hcpcCost2TBox,hcpcLengthOfNeedYear2TBox,hcpcLengthOfNeedMonth2TBox,hcpcCode3TBox,hcpcQty3TBox,hcpcProduct3TBox,hcpcDX3TBox,hcpcDiagnosis3TBox,hcpcCost3TBox,hcpcLengthOfNeedYear3TBox,hcpcLengthOfNeedMonth3TBox,hcpcCode4TBox,hcpcQty4TBox,hcpcProduct4TBox,hcpcDX4TBox,hcpcDiagnosis4TBox,hcpcCost4TBox,hcpcLengthOfNeedYear4TBox,hcpcLengthOfNeedMonth4TBox,hcpcCode5TBox,hcpcQty5TBox,hcpcProduct5TBox,hcpcDX5TBox,hcpcDiagnosis5TBox,hcpcCost5TBox,hcpcLengthOfNeedYear5TBox,hcpcLengthOfNeedMonth5TBox,hcpcCode6TBox,hcpcQty6TBox,hcpcProduct6TBox,hcpcDX6TBox,hcpcDiagnosis6TBox,hcpcCost6TBox,hcpcLengthOfNeedYear6TBox,hcpcLengthOfNeedMonth6TBox,hcpcCode7TBox,hcpcQty7TBox,hcpcProduct7TBox,hcpcDX7TBox,hcpcDiagnosis7TBox,hcpcCost7TBox,hcpcLengthOfNeedYear7TBox,hcpcLengthOfNeedMonth7TBox,hcpcCode8TBox,hcpcQty8TBox,hcpcProduct8TBox,hcpcDX8TBox,hcpcDiagnosis8TBox,hcpcCost8TBox,hcpcLengthOfNeedYear8TBox,hcpcLengthOfNeedMonth8TBox,hcpcCode9TBox,hcpcQty9TBox,hcpcProduct9TBox,hcpcDX9TBox,hcpcDiagnosis9TBox,hcpcCost9TBox,hcpcLengthOfNeedYear9TBox,hcpcLengthOfNeedMonth9TBox,hcpcCode10TBox,hcpcQty10TBox,hcpcProduct10TBox,hcpcDX10TBox,hcpcDiagnosis10TBox,hcpcCost10TBox,hcpcLengthOfNeedYear10TBox,hcpcLengthOfNeedMonth10TBox,hcpcCode11TBox,hcpcQty11TBox,hcpcProduct11TBox,hcpcDX11TBox,hcpcDiagnosis11TBox,hcpcCost11TBox,hcpcLengthOfNeedYear11TBox,hcpcLengthOfNeedMonth11TBox,hcpcCode12TBox,hcpcQty12TBox,hcpcProduct12TBox,hcpcDX12TBox,hcpcDiagnosis12TBox,hcpcCost12TBox,hcpcLengthOfNeedYear12TBox,hcpcLengthOfNeedMonth12TBox,hcpcCode13TBox,hcpcQty13TBox,hcpcProduct13TBox,hcpcDX13TBox,hcpcDiagnosis13TBox,hcpcCost13TBox,hcpcLengthOfNeedYear13TBox,hcpcLengthOfNeedMonth13TBox,hcpcCode14TBox,hcpcQty14TBox,hcpcProduct14TBox,hcpcDX14TBox,hcpcDiagnosis14TBox,hcpcCost14TBox,hcpcLengthOfNeedYear14TBox,hcpcLengthOfNeedMonth14TBox,hcpcCode15TBox,hcpcQty15TBox,hcpcProduct15TBox,hcpcDX15TBox,hcpcDiagnosis15TBox,hcpcCost15TBox,hcpcLengthOfNeedYear15TBox,hcpcLengthOfNeedMonth15TBox,hcpcCode16TBox,hcpcQty16TBox,hcpcProduct16TBox,hcpcDX16TBox,hcpcDiagnosis16TBox,hcpcCost16TBox,hcpcLengthOfNeedYear16TBox,hcpcLengthOfNeedMonth16TBox,hcpcCode17TBox,hcpcQty17TBox,hcpcProduct17TBox,hcpcDX17TBox,hcpcDiagnosis17TBox,hcpcCost17TBox,hcpcLengthOfNeedYear17TBox,hcpcLengthOfNeedMonth17TBox,hcpcCode18TBox,hcpcQty18TBox,hcpcProduct18TBox,hcpcDX18TBox,hcpcDiagnosis18TBox,hcpcCost18TBox,hcpcLengthOfNeedYear18TBox,hcpcLengthOfNeedMonth18TBox,hcpcCode19TBox,hcpcQty19TBox,hcpcProduct19TBox,hcpcDX19TBox,hcpcDiagnosis19TBox,hcpcCost19TBox,hcpcLengthOfNeedYear19TBox,hcpcLengthOfNeedMonth19TBox,hcpcCode20TBox,hcpcQty20TBox,hcpcProduct20TBox,hcpcDX20TBox,hcpcDiagnosis20TBox,hcpcCost20TBox,hcpcLengthOfNeedYear20TBox,hcpcLengthOfNeedMonth20TBox,hcpcCode21TBox,hcpcQty21TBox,hcpcProduct21TBox,hcpcDX21TBox,hcpcDiagnosis21TBox,hcpcCost21TBox,hcpcLengthOfNeedYear21TBox,hcpcLengthOfNeedMonth21TBox,hcpcCode22TBox,hcpcQty22TBox,hcpcProduct22TBox,hcpcDX22TBox,hcpcDiagnosis22TBox,hcpcCost22TBox,hcpcLengthOfNeedYear22TBox,hcpcLengthOfNeedMonth22TBox,hcpcCode23TBox,hcpcQty23TBox,hcpcProduct23TBox,hcpcDX23TBox,hcpcDiagnosis23TBox,hcpcCost23TBox,hcpcLengthOfNeedYear23TBox,hcpcLengthOfNeedMonth23TBox,hcpcCode24TBox,hcpcQty24TBox,hcpcProduct24TBox,hcpcDX24TBox,hcpcDiagnosis24TBox,hcpcCost24TBox,hcpcLengthOfNeedYear24TBox,hcpcLengthOfNeedMonth24TBox,hcpcCode25TBox,hcpcQty25TBox,hcpcProduct25TBox,hcpcDX25TBox,hcpcDiagnosis25TBox,hcpcCost25TBox,hcpcLengthOfNeedYear25TBox,hcpcLengthOfNeedMonth25TBox,hcpcCode26TBox,hcpcQty26TBox,hcpcProduct26TBox,hcpcDX26TBox,hcpcDiagnosis26TBox,hcpcCost26TBox,hcpcLengthOfNeedYear26TBox,hcpcLengthOfNeedMonth26TBox,hcpcCode27TBox,hcpcQty27TBox,hcpcProduct27TBox,hcpcDX27TBox,hcpcDiagnosis27TBox,hcpcCost27TBox,hcpcLengthOfNeedYear27TBox,hcpcLengthOfNeedMonth27TBox,hcpcCode28TBox,hcpcQty28TBox,hcpcProduct28TBox,hcpcDX28TBox,hcpcDiagnosis28TBox,hcpcCost28TBox,hcpcLengthOfNeedYear28TBox,hcpcLengthOfNeedMonth28TBox,hcpcCode29TBox,hcpcQty29TBox,hcpcProduct29TBox,hcpcDX29TBox,hcpcDiagnosis29TBox,hcpcCost29TBox,hcpcLengthOfNeedYear29TBox,hcpcLengthOfNeedMonth29TBox,hcpcCode30TBox,hcpcQty30TBox,hcpcProduct30TBox,hcpcDX30TBox,hcpcDiagnosis30TBox,hcpcCost30TBox,hcpcLengthOfNeedYear30TBox,hcpcLengthOfNeedMonth30TBox,hcpcCode31TBox,hcpcQty31TBox,hcpcProduct31TBox,hcpcDX31TBox,hcpcDiagnosis31TBox,hcpcCost31TBox,hcpcLengthOfNeedYear31TBox,hcpcLengthOfNeedMonth31TBox,hcpcCode32TBox,hcpcQty32TBox,hcpcProduct32TBox,hcpcDX32TBox,hcpcDiagnosis32TBox,hcpcCost32TBox,hcpcLengthOfNeedYear32TBox,hcpcLengthOfNeedMonth32TBox,hcpcCode33TBox,hcpcQty33TBox,hcpcProduct33TBox,hcpcDX33TBox,hcpcDiagnosis33TBox,hcpcCost33TBox,hcpcLengthOfNeedYear33TBox,hcpcLengthOfNeedMonth33TBox,hcpcCode34TBox,hcpcQty34TBox,hcpcProduct34TBox,hcpcDX34TBox,hcpcDiagnosis34TBox,hcpcCost34TBox,hcpcLengthOfNeedYear34TBox,hcpcLengthOfNeedMonth34TBox,hcpcCode35TBox,hcpcQty35TBox,hcpcProduct35TBox,hcpcDX35TBox,hcpcDiagnosis35TBox,hcpcCost35TBox,hcpcLengthOfNeedYear35TBox,hcpcLengthOfNeedMonth35TBox,hcpcCode36TBox,hcpcQty36TBox,hcpcProduct36TBox,hcpcDX36TBox,hcpcDiagnosis36TBox,hcpcCost36TBox,hcpcLengthOfNeedYear36TBox,hcpcLengthOfNeedMonth36TBox,hcpcCode37TBox,hcpcQty37TBox,hcpcProduct37TBox,hcpcDX37TBox,hcpcDiagnosis37TBox,hcpcCost37TBox,hcpcLengthOfNeedYear37TBox,hcpcLengthOfNeedMonth37TBox,hcpcCode38TBox,hcpcQty38TBox,hcpcProduct38TBox,hcpcDX38TBox,hcpcDiagnosis38TBox,hcpcCost38TBox,hcpcLengthOfNeedYear38TBox,hcpcLengthOfNeedMonth38TBox,hcpcCode39TBox,hcpcQty39TBox,hcpcProduct39TBox,hcpcDX39TBox,hcpcDiagnosis39TBox,hcpcCost39TBox,hcpcLengthOfNeedYear39TBox,hcpcLengthOfNeedMonth39TBox,hcpcCode40TBox,hcpcQty40TBox,hcpcProduct40TBox,hcpcDX40TBox,hcpcDiagnosis40TBox,hcpcCost40TBox,hcpcLengthOfNeedYear40TBox,hcpcLengthOfNeedMonth40TBox,Active,InactiveCode,DateCreated,DateModified" index="currentVar">
			...
			<!--- Build the SQL statement.                                                       --->
			<!-------------------------------------------------------------------------------------->	
				<cfset sqlStatement = "INSERT INTO quotehcpc  (#trim(columnsToInsert)#) VALUES(#trim(columnsToInsertValues)#); SELECT LAST_INSERT_ID() AS QuoteHCPCID ">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getQuoteHCPCQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getQuoteHCPCQuery">						
		<cfargument name="Fields" required="No" type="String" default="QuoteHCPCID,QuoteID,hcpcCode1TBox,hcpcQty1TBox,hcpcProduct1TBox,hcpcDX1TBox,hcpcDiagnosis1TBox,hcpcCost1TBox,hcpcLengthOfNeedYear1TBox,hcpcLengthOfNeedMonth1TBox,hcpcCode2TBox,hcpcQty2TBox,hcpcProduct2TBox,hcpcDX2TBox,hcpcDiagnosis2TBox,hcpcCost2TBox,hcpcLengthOfNeedYear2TBox,hcpcLengthOfNeedMonth2TBox,hcpcCode3TBox,hcpcQty3TBox,hcpcProduct3TBox,hcpcDX3TBox,hcpcDiagnosis3TBox,hcpcCost3TBox,hcpcLengthOfNeedYear3TBox,hcpcLengthOfNeedMonth3TBox,hcpcCode4TBox,hcpcQty4TBox,hcpcProduct4TBox,hcpcDX4TBox,hcpcDiagnosis4TBox,hcpcCost4TBox,hcpcLengthOfNeedYear4TBox,hcpcLengthOfNeedMonth4TBox,hcpcCode5TBox,hcpcQty5TBox,hcpcProduct5TBox,hcpcDX5TBox,hcpcDiagnosis5TBox,hcpcCost5TBox,hcpcLengthOfNeedYear5TBox,hcpcLengthOfNeedMonth5TBox,hcpcCode6TBox,hcpcQty6TBox,hcpcProduct6TBox,hcpcDX6TBox,hcpcDiagnosis6TBox,hcpcCost6TBox,hcpcLengthOfNeedYear6TBox,hcpcLengthOfNeedMonth6TBox,hcpcCode7TBox,hcpcQty7TBox,hcpcProduct7TBox,hcpcDX7TBox,hcpcDiagnosis7TBox,hcpcCost7TBox,hcpcLengthOfNeedYear7TBox,hcpcLengthOfNeedMonth7TBox,hcpcCode8TBox,hcpcQty8TBox,hcpcProduct8TBox,hcpcDX8TBox,hcpcDiagnosis8TBox,hcpcCost8TBox,hcpcLengthOfNeedYear8TBox,hcpcLengthOfNeedMonth8TBox,hcpcCode9TBox,hcpcQty9TBox,hcpcProduct9TBox,hcpcDX9TBox,hcpcDiagnosis9TBox,hcpcCost9TBox,hcpcLengthOfNeedYear9TBox,hcpcLengthOfNeedMonth9TBox,hcpcCode10TBox,hcpcQty10TBox,hcpcProduct10TBox,hcpcDX10TBox,hcpcDiagnosis10TBox,hcpcCost10TBox,hcpcLengthOfNeedYear10TBox,hcpcLengthOfNeedMonth10TBox,hcpcCode11TBox,hcpcQty11TBox,hcpcProduct11TBox,hcpcDX11TBox,hcpcDiagnosis11TBox,hcpcCost11TBox,hcpcLengthOfNeedYear11TBox,hcpcLengthOfNeedMonth11TBox,hcpcCode12TBox,hcpcQty12TBox,hcpcProduct12TBox,hcpcDX12TBox,hcpcDiagnosis12TBox,hcpcCost12TBox,hcpcLengthOfNeedYear12TBox,hcpcLengthOfNeedMonth12TBox,hcpcCode13TBox,hcpcQty13TBox,hcpcProduct13TBox,hcpcDX13TBox,hcpcDiagnosis13TBox,hcpcCost13TBox,hcpcLengthOfNeedYear13TBox,hcpcLengthOfNeedMonth13TBox,hcpcCode14TBox,hcpcQty14TBox,hcpcProduct14TBox,hcpcDX14TBox,hcpcDiagnosis14TBox,hcpcCost14TBox,hcpcLengthOfNeedYear14TBox,hcpcLengthOfNeedMonth14TBox,hcpcCode15TBox,hcpcQty15TBox,hcpcProduct15TBox,hcpcDX15TBox,hcpcDiagnosis15TBox,hcpcCost15TBox,hcpcLengthOfNeedYear15TBox,hcpcLengthOfNeedMonth15TBox,hcpcCode16TBox,hcpcQty16TBox,hcpcProduct16TBox,hcpcDX16TBox,hcpcDiagnosis16TBox,hcpcCost16TBox,hcpcLengthOfNeedYear16TBox,hcpcLengthOfNeedMonth16TBox,hcpcCode17TBox,hcpcQty17TBox,hcpcProduct17TBox,hcpcDX17TBox,hcpcDiagnosis17TBox,hcpcCost17TBox,hcpcLengthOfNeedYear17TBox,hcpcLengthOfNeedMonth17TBox,hcpcCode18TBox,hcpcQty18TBox,hcpcProduct18TBox,hcpcDX18TBox,hcpcDiagnosis18TBox,hcpcCost18TBox,hcpcLengthOfNeedYear18TBox,hcpcLengthOfNeedMonth18TBox,hcpcCode19TBox,hcpcQty19TBox,hcpcProduct19TBox,hcpcDX19TBox,hcpcDiagnosis19TBox,hcpcCost19TBox,hcpcLengthOfNeedYear19TBox,hcpcLengthOfNeedMonth19TBox,hcpcCode20TBox,hcpcQty20TBox,hcpcProduct20TBox,hcpcDX20TBox,hcpcDiagnosis20TBox,hcpcCost20TBox,hcpcLengthOfNeedYear20TBox,hcpcLengthOfNeedMonth20TBox,hcpcCode21TBox,hcpcQty21TBox,hcpcProduct21TBox,hcpcDX21TBox,hcpcDiagnosis21TBox,hcpcCost21TBox,hcpcLengthOfNeedYear21TBox,hcpcLengthOfNeedMonth21TBox,hcpcCode22TBox,hcpcQty22TBox,hcpcProduct22TBox,hcpcDX22TBox,hcpcDiagnosis22TBox,hcpcCost22TBox,hcpcLengthOfNeedYear22TBox,hcpcLengthOfNeedMonth22TBox,hcpcCode23TBox,hcpcQty23TBox,hcpcProduct23TBox,hcpcDX23TBox,hcpcDiagnosis23TBox,hcpcCost23TBox,hcpcLengthOfNeedYear23TBox,hcpcLengthOfNeedMonth23TBox,hcpcCode24TBox,hcpcQty24TBox,hcpcProduct24TBox,hcpcDX24TBox,hcpcDiagnosis24TBox,hcpcCost24TBox,hcpcLengthOfNeedYear24TBox,hcpcLengthOfNeedMonth24TBox,hcpcCode25TBox,hcpcQty25TBox,hcpcProduct25TBox,hcpcDX25TBox,hcpcDiagnosis25TBox,hcpcCost25TBox,hcpcLengthOfNeedYear25TBox,hcpcLengthOfNeedMonth25TBox,hcpcCode26TBox,hcpcQty26TBox,hcpcProduct26TBox,hcpcDX26TBox,hcpcDiagnosis26TBox,hcpcCost26TBox,hcpcLengthOfNeedYear26TBox,hcpcLengthOfNeedMonth26TBox,hcpcCode27TBox,hcpcQty27TBox,hcpcProduct27TBox,hcpcDX27TBox,hcpcDiagnosis27TBox,hcpcCost27TBox,hcpcLengthOfNeedYear27TBox,hcpcLengthOfNeedMonth27TBox,hcpcCode28TBox,hcpcQty28TBox,hcpcProduct28TBox,hcpcDX28TBox,hcpcDiagnosis28TBox,hcpcCost28TBox,hcpcLengthOfNeedYear28TBox,hcpcLengthOfNeedMonth28TBox,hcpcCode29TBox,hcpcQty29TBox,hcpcProduct29TBox,hcpcDX29TBox,hcpcDiagnosis29TBox,hcpcCost29TBox,hcpcLengthOfNeedYear29TBox,hcpcLengthOfNeedMonth29TBox,hcpcCode30TBox,hcpcQty30TBox,hcpcProduct30TBox,hcpcDX30TBox,hcpcDiagnosis30TBox,hcpcCost30TBox,hcpcLengthOfNeedYear30TBox,hcpcLengthOfNeedMonth30TBox,hcpcCode31TBox,hcpcQty31TBox,hcpcProduct31TBox,hcpcDX31TBox,hcpcDiagnosis31TBox,hcpcCost31TBox,hcpcLengthOfNeedYear31TBox,hcpcLengthOfNeedMonth31TBox,hcpcCode32TBox,hcpcQty32TBox,hcpcProduct32TBox,hcpcDX32TBox,hcpcDiagnosis32TBox,hcpcCost32TBox,hcpcLengthOfNeedYear32TBox,hcpcLengthOfNeedMonth32TBox,hcpcCode33TBox,hcpcQty33TBox,hcpcProduct33TBox,hcpcDX33TBox,hcpcDiagnosis33TBox,hcpcCost33TBox,hcpcLengthOfNeedYear33TBox,hcpcLengthOfNeedMonth33TBox,hcpcCode34TBox,hcpcQty34TBox,hcpcProduct34TBox,hcpcDX34TBox,hcpcDiagnosis34TBox,hcpcCost34TBox,hcpcLengthOfNeedYear34TBox,hcpcLengthOfNeedMonth34TBox,hcpcCode35TBox,hcpcQty35TBox,hcpcProduct35TBox,hcpcDX35TBox,hcpcDiagnosis35TBox,hcpcCost35TBox,hcpcLengthOfNeedYear35TBox,hcpcLengthOfNeedMonth35TBox,hcpcCode36TBox,hcpcQty36TBox,hcpcProduct36TBox,hcpcDX36TBox,hcpcDiagnosis36TBox,hcpcCost36TBox,hcpcLengthOfNeedYear36TBox,hcpcLengthOfNeedMonth36TBox,hcpcCode37TBox,hcpcQty37TBox,hcpcProduct37TBox,hcpcDX37TBox,hcpcDiagnosis37TBox,hcpcCost37TBox,hcpcLengthOfNeedYear37TBox,hcpcLengthOfNeedMonth37TBox,hcpcCode38TBox,hcpcQty38TBox,hcpcProduct38TBox,hcpcDX38TBox,hcpcDiagnosis38TBox,hcpcCost38TBox,hcpcLengthOfNeedYear38TBox,hcpcLengthOfNeedMonth38TBox,hcpcCode39TBox,hcpcQty39TBox,hcpcProduct39TBox,hcpcDX39TBox,hcpcDiagnosis39TBox,hcpcCost39TBox,hcpcLengthOfNeedYear39TBox,hcpcLengthOfNeedMonth39TBox,hcpcCode40TBox,hcpcQty40TBox,hcpcProduct40TBox,hcpcDX40TBox,hcpcDiagnosis40TBox,hcpcCost40TBox,hcpcLengthOfNeedYear40TBox,hcpcLengthOfNeedMonth40TBox,Active,InactiveCode,DateCreated,DateModified">	
		...
		<cfargument name="QuoteHCPCID" required="No" type="String" default="">
		<cfargument name="QuoteHCPCID_IN" required="No" type="String" default="">
		<cfargument name="QuoteHCPCID_LIKE" required="No" type="String" default="">
		<cfargument name="QuoteID" required="No" type="String" default="">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfquery Name="getQuoteHCPCQuery" datasource="#trim(request.datasource)#">
				SELECT #trim(Fields)#
				FROM quotehcpc   
				WHERE 1=1
					<cfif QuoteHCPCID NEQ "" AND IsNumeric(QuoteHCPCID)>AND QuoteHCPCID = #QuoteHCPCID#</cfif>
					<cfif QuoteHCPCID_IN NEQ "">AND QuoteHCPCID IN(#trim(QuoteHCPCID_IN)#)</cfif>
					<cfif QuoteHCPCID_LIKE NEQ "">AND QuoteHCPCID LIKE '%#trim(QuoteHCPCID_LIKE)#%'</cfif>
