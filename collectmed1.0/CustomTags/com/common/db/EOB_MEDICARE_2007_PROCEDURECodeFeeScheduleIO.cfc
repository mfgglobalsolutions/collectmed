...
<!--- NAME:                                                                          --->
<!--- @@Name@@                                                                       --->
<!--- EOB_MEDICARE_2007_PROCEDURECodeFeeScheduleIO.cfc                               --->
<!--- @@Name@@                                                                       --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- CATEGORY:                                                                      --->
...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the EOB_MEDICARE_2007_PROCEDURECodeFeeSchedule   --->
<!--- table in the dB.                                                               --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_EOB_MEDICARE_2007_PROCEDURECodeFeeScheduleTable                  --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<cfcomponent name="EOB_MEDICARE_2007_PROCEDURECodeFeeScheduleIO">
...
<!-------------------------------------------------------------------------------------->
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="Init" access="public" returntype="EOB_MEDICARE_2007_PROCEDURECodeFeeScheduleIO" output="No">
		...
		<cfscript>
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.RecordID EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.RecordID EQ "NULL") 
				variables.instance.RecordID = "NULL"; 
			ELSE 
				variables.instance.RecordID = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.RecordID;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.HCPCRecordID EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.HCPCRecordID EQ "NULL") 
				variables.instance.HCPCRecordID = "NULL"; 
			ELSE 
				variables.instance.HCPCRecordID = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.HCPCRecordID;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.CategoryID EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.CategoryID EQ "NULL") 
				variables.instance.CategoryID = "NULL"; 
			ELSE 
				variables.instance.CategoryID = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.CategoryID;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD1 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD1 EQ "NULL") 
				variables.instance.MOD1 = "NULL"; 
			ELSE 
				variables.instance.MOD1 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD1;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD2 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD2 EQ "NULL") 
				variables.instance.MOD2 = "NULL"; 
			ELSE 
				variables.instance.MOD2 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD2;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD3 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD3 EQ "NULL") 
				variables.instance.MOD3 = "NULL"; 
			ELSE 
				variables.instance.MOD3 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD3;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD4 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD4 EQ "NULL") 
				variables.instance.MOD4 = "NULL"; 
			ELSE 
				variables.instance.MOD4 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.MOD4;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Ceiling EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Ceiling EQ "NULL") 
				variables.instance.Ceiling = "NULL"; 
			ELSE 
				variables.instance.Ceiling = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Ceiling;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Floor EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Floor EQ "NULL") 
				variables.instance.Floor = "NULL"; 
			ELSE 
				variables.instance.Floor = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Floor;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AL_16 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AL_16 EQ "NULL") 
				variables.instance.Fee_AL_16 = "NULL"; 
			ELSE 
				variables.instance.Fee_AL_16 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AL_16;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AK_17 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AK_17 EQ "NULL") 
				variables.instance.Fee_AK_17 = "NULL"; 
			ELSE 
				variables.instance.Fee_AK_17 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AK_17;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AZ_18 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AZ_18 EQ "NULL") 
				variables.instance.Fee_AZ_18 = "NULL"; 
			ELSE 
				variables.instance.Fee_AZ_18 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AZ_18;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AR_19 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AR_19 EQ "NULL") 
				variables.instance.Fee_AR_19 = "NULL"; 
			ELSE 
				variables.instance.Fee_AR_19 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_AR_19;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_CA_20 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_CA_20 EQ "NULL") 
				variables.instance.Fee_CA_20 = "NULL"; 
			ELSE 
				variables.instance.Fee_CA_20 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_CA_20;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_CO_21 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_CO_21 EQ "NULL") 
				variables.instance.Fee_CO_21 = "NULL"; 
			ELSE 
				variables.instance.Fee_CO_21 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_CO_21;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_CT_22 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_CT_22 EQ "NULL") 
				variables.instance.Fee_CT_22 = "NULL"; 
			ELSE 
				variables.instance.Fee_CT_22 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_CT_22;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_DE_23 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_DE_23 EQ "NULL") 
				variables.instance.Fee_DE_23 = "NULL"; 
			ELSE 
				variables.instance.Fee_DE_23 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_DE_23;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_DC_24 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_DC_24 EQ "NULL") 
				variables.instance.Fee_DC_24 = "NULL"; 
			ELSE 
				variables.instance.Fee_DC_24 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_DC_24;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_FL_25 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_FL_25 EQ "NULL") 
				variables.instance.Fee_FL_25 = "NULL"; 
			ELSE 
				variables.instance.Fee_FL_25 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_FL_25;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_GA_26 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_GA_26 EQ "NULL") 
				variables.instance.Fee_GA_26 = "NULL"; 
			ELSE 
				variables.instance.Fee_GA_26 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_GA_26;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_HI_27 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_HI_27 EQ "NULL") 
				variables.instance.Fee_HI_27 = "NULL"; 
			ELSE 
				variables.instance.Fee_HI_27 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_HI_27;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_ID_28 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_ID_28 EQ "NULL") 
				variables.instance.Fee_ID_28 = "NULL"; 
			ELSE 
				variables.instance.Fee_ID_28 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_ID_28;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_IL_29 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_IL_29 EQ "NULL") 
				variables.instance.Fee_IL_29 = "NULL"; 
			ELSE 
				variables.instance.Fee_IL_29 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_IL_29;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_IN_30 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_IN_30 EQ "NULL") 
				variables.instance.Fee_IN_30 = "NULL"; 
			ELSE 
				variables.instance.Fee_IN_30 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_IN_30;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_IA_31 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_IA_31 EQ "NULL") 
				variables.instance.Fee_IA_31 = "NULL"; 
			ELSE 
				variables.instance.Fee_IA_31 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_IA_31;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_KS_32 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_KS_32 EQ "NULL") 
				variables.instance.Fee_KS_32 = "NULL"; 
			ELSE 
				variables.instance.Fee_KS_32 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_KS_32;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_KY_33 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_KY_33 EQ "NULL") 
				variables.instance.Fee_KY_33 = "NULL"; 
			ELSE 
				variables.instance.Fee_KY_33 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_KY_33;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_LA_34 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_LA_34 EQ "NULL") 
				variables.instance.Fee_LA_34 = "NULL"; 
			ELSE 
				variables.instance.Fee_LA_34 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_LA_34;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_ME_35 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_ME_35 EQ "NULL") 
				variables.instance.Fee_ME_35 = "NULL"; 
			ELSE 
				variables.instance.Fee_ME_35 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_ME_35;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MD_36 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MD_36 EQ "NULL") 
				variables.instance.Fee_MD_36 = "NULL"; 
			ELSE 
				variables.instance.Fee_MD_36 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MD_36;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MA_37 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MA_37 EQ "NULL") 
				variables.instance.Fee_MA_37 = "NULL"; 
			ELSE 
				variables.instance.Fee_MA_37 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MA_37;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MI_38 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MI_38 EQ "NULL") 
				variables.instance.Fee_MI_38 = "NULL"; 
			ELSE 
				variables.instance.Fee_MI_38 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MI_38;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MN_39 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MN_39 EQ "NULL") 
				variables.instance.Fee_MN_39 = "NULL"; 
			ELSE 
				variables.instance.Fee_MN_39 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MN_39;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MS_40 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MS_40 EQ "NULL") 
				variables.instance.Fee_MS_40 = "NULL"; 
			ELSE 
				variables.instance.Fee_MS_40 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MS_40;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MO_41 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MO_41 EQ "NULL") 
				variables.instance.Fee_MO_41 = "NULL"; 
			ELSE 
				variables.instance.Fee_MO_41 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MO_41;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MT_42 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MT_42 EQ "NULL") 
				variables.instance.Fee_MT_42 = "NULL"; 
			ELSE 
				variables.instance.Fee_MT_42 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_MT_42;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NE_43 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NE_43 EQ "NULL") 
				variables.instance.Fee_NE_43 = "NULL"; 
			ELSE 
				variables.instance.Fee_NE_43 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NE_43;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NV_44 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NV_44 EQ "NULL") 
				variables.instance.Fee_NV_44 = "NULL"; 
			ELSE 
				variables.instance.Fee_NV_44 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NV_44;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NE_45 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NE_45 EQ "NULL") 
				variables.instance.Fee_NE_45 = "NULL"; 
			ELSE 
				variables.instance.Fee_NE_45 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NE_45;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NJ_46 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NJ_46 EQ "NULL") 
				variables.instance.Fee_NJ_46 = "NULL"; 
			ELSE 
				variables.instance.Fee_NJ_46 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NJ_46;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NM_47 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NM_47 EQ "NULL") 
				variables.instance.Fee_NM_47 = "NULL"; 
			ELSE 
				variables.instance.Fee_NM_47 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NM_47;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NY_48 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NY_48 EQ "NULL") 
				variables.instance.Fee_NY_48 = "NULL"; 
			ELSE 
				variables.instance.Fee_NY_48 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NY_48;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NC_49 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NC_49 EQ "NULL") 
				variables.instance.Fee_NC_49 = "NULL"; 
			ELSE 
				variables.instance.Fee_NC_49 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_NC_49;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_ND_50 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_ND_50 EQ "NULL") 
				variables.instance.Fee_ND_50 = "NULL"; 
			ELSE 
				variables.instance.Fee_ND_50 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_ND_50;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_OH_51 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_OH_51 EQ "NULL") 
				variables.instance.Fee_OH_51 = "NULL"; 
			ELSE 
				variables.instance.Fee_OH_51 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_OH_51;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_OK_52 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_OK_52 EQ "NULL") 
				variables.instance.Fee_OK_52 = "NULL"; 
			ELSE 
				variables.instance.Fee_OK_52 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_OK_52;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_OR_53 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_OR_53 EQ "NULL") 
				variables.instance.Fee_OR_53 = "NULL"; 
			ELSE 
				variables.instance.Fee_OR_53 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_OR_53;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_PA_54 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_PA_54 EQ "NULL") 
				variables.instance.Fee_PA_54 = "NULL"; 
			ELSE 
				variables.instance.Fee_PA_54 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_PA_54;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_RI_55 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_RI_55 EQ "NULL") 
				variables.instance.Fee_RI_55 = "NULL"; 
			ELSE 
				variables.instance.Fee_RI_55 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_RI_55;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_SC_56 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_SC_56 EQ "NULL") 
				variables.instance.Fee_SC_56 = "NULL"; 
			ELSE 
				variables.instance.Fee_SC_56 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_SC_56;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_SD_57 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_SD_57 EQ "NULL") 
				variables.instance.Fee_SD_57 = "NULL"; 
			ELSE 
				variables.instance.Fee_SD_57 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_SD_57;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_TN_58 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_TN_58 EQ "NULL") 
				variables.instance.Fee_TN_58 = "NULL"; 
			ELSE 
				variables.instance.Fee_TN_58 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_TN_58;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_TX_59 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_TX_59 EQ "NULL") 
				variables.instance.Fee_TX_59 = "NULL"; 
			ELSE 
				variables.instance.Fee_TX_59 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_TX_59;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_UT_60 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_UT_60 EQ "NULL") 
				variables.instance.Fee_UT_60 = "NULL"; 
			ELSE 
				variables.instance.Fee_UT_60 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_UT_60;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_VT_61 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_VT_61 EQ "NULL") 
				variables.instance.Fee_VT_61 = "NULL"; 
			ELSE 
				variables.instance.Fee_VT_61 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_VT_61;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_VA_62 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_VA_62 EQ "NULL") 
				variables.instance.Fee_VA_62 = "NULL"; 
			ELSE 
				variables.instance.Fee_VA_62 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_VA_62;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WA_63 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WA_63 EQ "NULL") 
				variables.instance.Fee_WA_63 = "NULL"; 
			ELSE 
				variables.instance.Fee_WA_63 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WA_63;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WV_64 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WV_64 EQ "NULL") 
				variables.instance.Fee_WV_64 = "NULL"; 
			ELSE 
				variables.instance.Fee_WV_64 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WV_64;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WI_65 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WI_65 EQ "NULL") 
				variables.instance.Fee_WI_65 = "NULL"; 
			ELSE 
				variables.instance.Fee_WI_65 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WI_65;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WY_66 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WY_66 EQ "NULL") 
				variables.instance.Fee_WY_66 = "NULL"; 
			ELSE 
				variables.instance.Fee_WY_66 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_WY_66;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_PR_229 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_PR_229 EQ "NULL") 
				variables.instance.Fee_PR_229 = "NULL"; 
			ELSE 
				variables.instance.Fee_PR_229 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_PR_229;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_VI_238 EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_VI_238 EQ "NULL") 
				variables.instance.Fee_VI_238 = "NULL"; 
			ELSE 
				variables.instance.Fee_VI_238 = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Fee_VI_238;
							
				variables.instance.Active = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.Active;
				
			IF(qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.InactiveCode EQ "" OR qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.InactiveCode;
							
				variables.instance.DateCreated = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.DateCreated;
							
				variables.instance.DateModified = qGetEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.DateModified;
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
	 	...
	 	<cfset var qCommitEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule = "">
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfset variables.instance.RecordID = qInsertCommitEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.RecordID>
				
				<cfreturn qInsertCommitEOB_MEDICARE_2007_PROCEDURECodeFeeSchedule.RecordID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->					
			...
			<!-------------------------------------------------------------------------------------->	
				<cfset sqlStatement = "UPDATE EOB_MEDICARE_2007_PROCEDURECodeFeeSchedule  SET #columnsToUpdate# WHERE RecordID = #trim(variables.instance.RecordID)#">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getEOB_MEDICARE_2007_PROCEDURECodeFeeScheduleQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getEOB_MEDICARE_2007_PROCEDURECodeFeeScheduleQuery">						
			...
			<cfloop from="1" to="#ArrayLen(keysToStruct)#" index="i">
				...
				<cfif NOT ListFindNoCase("QueryName|Fields|OrderBy|GroupBy", keysToStruct[i], "|") AND Find("_IN", keysToStruct[i]) EQ 0 AND Find("_LIKE", keysToStruct[i]) EQ 0>
					...
					<cfif NOT ListFindNoCase(availableColumns, keysToStruct[i])>
						<cf_gcGeneralErrorTemplate				
							invisible="EOB_MEDICARE_2007_PROCEDURECodeFeeSchedule"
		...
		<!-------------------------------------------------------------------------------------->			
			...
			<cfreturn getEOB_MEDICARE_2007_PROCEDURECodeFeeScheduleQuery>
