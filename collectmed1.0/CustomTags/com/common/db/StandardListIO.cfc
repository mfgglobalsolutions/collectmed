...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the StandardList table in the dB.                --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_StandardListTable                                                --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<cfcomponent name="StandardListIO">
	...
	<cffunction name="reset" access="public" output="no">
		...
		<cfscript>
			...
			variables.instance.StandardListID = "NULL";
			variables.instance.SiteID = "NULL";
			variables.instance.ListName = "";
			variables.instance.ListDescription = "";
...
<!-------------------------------------------------------------------------------------->
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "STANDARDLISTID", 1)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "LISTNAME", 3)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "LISTDESCRIPTION", 4)>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for StandardListID.                                         --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getStandardListID" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.StandardListID>
	</cffunction>
	 
	<cffunction name="setStandardListID" access="public" returntype="boolean" output="No">
 		
		<cfargument name="StandardListID" required="Yes" type="String">
		
		<cfif StandardListID NEQ "NULL">	
			
			<cfif arguments.StandardListID EQ "@@" OR arguments.StandardListID EQ "">
				
				<cfset arguments.StandardListID = "NULL">
						
			<cfelseif NOT REQUEST.isintDataType(StandardListID)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>StandardListID</strong> (#StandardListID#) is not of type <strong>int</strong>.">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.StandardListID = arguments.StandardListID>			
		<cfreturn true>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for ListName.                                               --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getListName" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.ListName>
	</cffunction>
	 
	<cffunction name="setListName" access="public" returntype="boolean" output="No">
 		
		<cfargument name="ListName" required="Yes" type="String">
		
		<cfif ListName NEQ "NULL">	
			
			<cfif arguments.ListName EQ "@@" OR arguments.ListName EQ "">
				
				<cfset arguments.ListName = "NULL">
						
			<cfelseif NOT REQUEST.isvarcharDataType(ListName)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>ListName</strong> (#ListName#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(ListName) GT 50>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>ListName</strong> cannot be greater than 50 character(s).">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.ListName = arguments.ListName>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "ListName")>			
		<cfreturn true>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for ListDescription.                                        --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getListDescription" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.ListDescription>
	</cffunction>
	 
	<cffunction name="setListDescription" access="public" returntype="boolean" output="No">
 		
		<cfargument name="ListDescription" required="Yes" type="String">
		
		<cfif ListDescription NEQ "NULL">	
			
			<cfif arguments.ListDescription EQ "@@" OR arguments.ListDescription EQ "">
				
				<cfset arguments.ListDescription = "NULL">
						
			<cfelseif NOT REQUEST.isvarcharDataType(ListDescription)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>ListDescription</strong> (#ListDescription#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(ListDescription) GT 2000>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>ListDescription</strong> cannot be greater than 2000 character(s).">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.ListDescription = arguments.ListDescription>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "ListDescription")>			
		<cfreturn true>
	...
	<cffunction name="new" access="public" output="no">
		...
		<cfargument name="ListName" required="No" type="String" default="">
		<cfargument name="ListDescription" required="No" type="String" default="">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="Init" access="public" returntype="StandardListIO" output="No">
		...
		<cfscript>
			IF(qGetStandardList.StandardListID EQ "" OR qGetStandardList.StandardListID EQ "NULL") 
				variables.instance.StandardListID = "NULL"; 
			ELSE 
				variables.instance.StandardListID = qGetStandardList.StandardListID;
				
			IF(qGetStandardList.SiteID EQ "" OR qGetStandardList.SiteID EQ "NULL") 
				variables.instance.SiteID = "NULL"; 
			ELSE 
				variables.instance.SiteID = qGetStandardList.SiteID;
							
				variables.instance.ListName = qGetStandardList.ListName;
							
				variables.instance.ListDescription = qGetStandardList.ListDescription;
							
				variables.instance.Active = qGetStandardList.Active;
				
			IF(qGetStandardList.InactiveCode EQ "" OR qGetStandardList.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetStandardList.InactiveCode;
							
				variables.instance.DateCreated = qGetStandardList.DateCreated;
							
				variables.instance.DateModified = qGetStandardList.DateModified;
				
		</cfscript>		
		  
		<cfset postInit(StandardListID)>
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
	 	...
	 	<cfset var qCommitStandardList = "">
		
		<cfset preUpdateCommit()>
	 	
		<cfif IsNumeric(variables.instance.StandardListID) AND variables.instance.StandardListID  GT 0>	  		
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfset variables.instance.StandardListID = qInsertCommitStandardList.StandardListID>
				
				<cfreturn qInsertCommitStandardList.StandardListID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->	
			<cfset tableColumns = "StandardListID,SiteID,ListName,ListDescription,Active,InactiveCode,DateCreated,DateModified">		
			
		<!-------------------------------------------------------------------------------------->
		<!--- Denote the column names that need single quotes (strings).                     --->
		<!-------------------------------------------------------------------------------------->
			<cfset stringTableColumns = "ListName,ListDescription,Active">	
	...
	<cffunction name="preInsertDataCheck" output="no">		
		...
		<!--- append it to the update statement.                                             --->
		<!-------------------------------------------------------------------------------------->					
			<cfloop list="SiteID,ListName,ListDescription,Active,InactiveCode,DateCreated,DateModified" index="currentVar">
			...
			<!--- Build the SQL statement.                                                       --->
			<!-------------------------------------------------------------------------------------->	
				<cfset sqlStatement = "INSERT INTO StandardList  (#trim(columnsToInsert)#) VALUES(#trim(columnsToInsertValues)#); SELECT LAST_INSERT_ID() AS StandardListID ">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getStandardListQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getStandardListQuery">						
		<cfargument name="Fields" required="No" type="String" default="StandardListID,SiteID,ListName,ListDescription,Active,InactiveCode,DateCreated,DateModified">	
		...
		<cfargument name="StandardListID" required="No" type="String" default="">
		<cfargument name="StandardListID_IN" required="No" type="String" default="">
		<cfargument name="StandardListID_LIKE" required="No" type="String" default="">
		<cfargument name="SiteID" required="No" type="String" default="">
		<cfargument name="SiteID_IN" required="No" type="String" default="">
		<cfargument name="SiteID_LIKE" required="No" type="String" default="">
		<cfargument name="ListName" required="No" type="String" default="">
		<cfargument name="ListName_IN" required="No" type="String" default="">
		<cfargument name="ListName_LIKE" required="No" type="String" default="">
		<cfargument name="ListDescription" required="No" type="String" default="">
		<cfargument name="ListDescription_IN" required="No" type="String" default="">
		<cfargument name="ListDescription_LIKE" required="No" type="String" default="">
		<cfargument name="Active" required="No" type="String" default="">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfset availableColumns = "StandardListID,StandardListID_IN,StandardListID_LIKE,SiteID,SiteID_IN,SiteID_LIKE,ListName,ListName_IN,ListName_LIKE,ListDescription,ListDescription_IN,ListDescription_LIKE,Active,Active_IN,Active_LIKE,InactiveCode,InactiveCode_IN,InactiveCode_LIKE,DateCreated,DateCreated_IN,DateCreated_LIKE,DateModified,DateModified_IN,DateModified_LIKE,top1">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfquery Name="getStandardListQuery" datasource="PA_Master">
				...
				FROM StandardList   
				WHERE 1=1
					<cfif StandardListID NEQ "" AND IsNumeric(StandardListID)>AND StandardListID = #StandardListID#</cfif>
					<cfif StandardListID_IN NEQ "">AND StandardListID IN(#trim(StandardListID_IN)#)</cfif>
					<cfif StandardListID_LIKE NEQ "">AND StandardListID LIKE '%#trim(StandardListID_LIKE)#%'</cfif>
					...
					<cfif ListName NEQ "">AND ListName = '#ListName#'</cfif>
					<cfif ListName_IN NEQ "">AND ListName IN(#trim(ListName_IN)#)</cfif>
					<cfif ListName_LIKE NEQ "">AND ListName LIKE '%#trim(ListName_LIKE)#%'</cfif>
					<cfif ListDescription NEQ "">AND ListDescription = '#ListDescription#'</cfif>
					<cfif ListDescription_IN NEQ "">AND ListDescription IN(#trim(ListDescription_IN)#)</cfif>
					<cfif ListDescription_LIKE NEQ "">AND ListDescription LIKE '%#trim(ListDescription_LIKE)#%'</cfif>
