...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the ProcedureOpenClose table in the dB.          --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_ProcedureOpenCloseTable                                          --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<cfcomponent name="ProcedureOpenCloseIO">
	...
	<cffunction name="reset" access="public" output="no">
		...
		<cfscript>
			...
			variables.instance.ProcedureOpenCloseID = "NULL";
			variables.instance.ProcedureID = "NULL";
			variables.instance.OpenOrClose = "NULL";
...
<!-------------------------------------------------------------------------------------->
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "PROCEDUREOPENCLOSEID", 1)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "OPENORCLOSE", 3)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "NOTE", 5)>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for ProcedureOpenCloseID.                                   --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getProcedureOpenCloseID" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.ProcedureOpenCloseID>
	</cffunction>
	 
	<cffunction name="setProcedureOpenCloseID" access="public" returntype="boolean" output="No">
 		
		<cfargument name="ProcedureOpenCloseID" required="Yes" type="String">
		
		<cfif ProcedureOpenCloseID NEQ "NULL">	
			
			<cfif arguments.ProcedureOpenCloseID EQ "@@" OR arguments.ProcedureOpenCloseID EQ "">
				
				<cfset arguments.ProcedureOpenCloseID = "NULL">
						
			<cfelseif NOT REQUEST.isintDataType(ProcedureOpenCloseID)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>ProcedureOpenCloseID</strong> (#ProcedureOpenCloseID#) is not of type <strong>int</strong>.">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.ProcedureOpenCloseID = arguments.ProcedureOpenCloseID>			
		<cfreturn true>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for OpenOrClose.                                            --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getOpenOrClose" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.OpenOrClose>
	</cffunction>
	 
	<cffunction name="setOpenOrClose" access="public" returntype="boolean" output="No">
 		
		<cfargument name="OpenOrClose" required="Yes" type="String">
		
		<cfif OpenOrClose NEQ "NULL">	
			
			<cfif arguments.OpenOrClose EQ "@@" OR arguments.OpenOrClose EQ "">
				
				<cfset arguments.OpenOrClose = "NULL">
						
			<cfelseif NOT REQUEST.isintDataType(OpenOrClose)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>OpenOrClose</strong> (#OpenOrClose#) is not of type <strong>int</strong>.">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.OpenOrClose = arguments.OpenOrClose>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "OpenOrClose")>			
		<cfreturn true>
	...
	<cffunction name="new" access="public" output="no">
		...
		<cfargument name="OpenOrClose" required="No" type="String" default="">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="Init" access="public" returntype="ProcedureOpenCloseIO" output="No">
		
		<cfargument name="ProcedureOpenCloseID" required="yes" type="numeric">		
		<cfset var qGetProcedureOpenClose = "">
		
		<cfset preInit(ProcedureOpenCloseID)>
		...
		<cfscript>
			IF(qGetProcedureOpenClose.ProcedureOpenCloseID EQ "" OR qGetProcedureOpenClose.ProcedureOpenCloseID EQ "NULL") 
				variables.instance.ProcedureOpenCloseID = "NULL"; 
			ELSE 
				variables.instance.ProcedureOpenCloseID = qGetProcedureOpenClose.ProcedureOpenCloseID;
				
			IF(qGetProcedureOpenClose.ProcedureID EQ "" OR qGetProcedureOpenClose.ProcedureID EQ "NULL") 
				variables.instance.ProcedureID = "NULL"; 
			ELSE 
				variables.instance.ProcedureID = qGetProcedureOpenClose.ProcedureID;
				
			IF(qGetProcedureOpenClose.OpenOrClose EQ "" OR qGetProcedureOpenClose.OpenOrClose EQ "NULL") 
				variables.instance.OpenOrClose = "NULL"; 
			ELSE 
				variables.instance.OpenOrClose = qGetProcedureOpenClose.OpenOrClose;
				
			IF(qGetProcedureOpenClose.UsersID EQ "" OR qGetProcedureOpenClose.UsersID EQ "NULL") 
				variables.instance.UsersID = "NULL"; 
			ELSE 
				variables.instance.UsersID = qGetProcedureOpenClose.UsersID;
							
				variables.instance.Note = qGetProcedureOpenClose.Note;
							
				variables.instance.Active = qGetProcedureOpenClose.Active;
				
			IF(qGetProcedureOpenClose.InactiveCode EQ "" OR qGetProcedureOpenClose.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetProcedureOpenClose.InactiveCode;
							
				variables.instance.DateCreated = qGetProcedureOpenClose.DateCreated;
							
				variables.instance.DateModified = qGetProcedureOpenClose.DateModified;
				
		</cfscript>		
		  
		<cfset postInit(ProcedureOpenCloseID)>
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
	 	...
	 	<cfset var qCommitProcedureOpenClose = "">
		
		<cfset preUpdateCommit()>
	 	
		<cfif IsNumeric(variables.instance.ProcedureOpenCloseID) AND variables.instance.ProcedureOpenCloseID  GT 0>	  		
			
			<cfif ListLen(trim(variables.instance.changedVariables)) GTE 1>
			
				<cfset sqlStatement = preUpdateDataCheck()>				
				
				<cfquery name="qUpdateCommitProcedureOpenClose" datasource="#trim(request.datasource)#">
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfquery name="qInsertCommitProcedureOpenClose" datasource="#trim(request.datasource)#">
		   			#PreserveSingleQuotes(sqlStatement)#
		   		</cfquery>		
		 					
				<cfset postInsertCommit()>
				
				<cfset variables.instance.ProcedureOpenCloseID = qInsertCommitProcedureOpenClose.ProcedureOpenCloseID>
				
				<cfreturn qInsertCommitProcedureOpenClose.ProcedureOpenCloseID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->	
			<cfset tableColumns = "ProcedureOpenCloseID,ProcedureID,OpenOrClose,UsersID,Note,Active,InactiveCode,DateCreated,DateModified">		
	...
	<cffunction name="preInsertDataCheck" output="no">		
		...
		<!--- append it to the update statement.                                             --->
		<!-------------------------------------------------------------------------------------->					
			<cfloop list="ProcedureID,OpenOrClose,UsersID,Note,Active,InactiveCode,DateCreated,DateModified" index="currentVar">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getProcedureOpenCloseQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getProcedureOpenCloseQuery">						
		<cfargument name="Fields" required="No" type="String" default="ProcedureOpenCloseID,ProcedureID,OpenOrClose,UsersID,Note,Active,InactiveCode,DateCreated,DateModified">	
		...
		<cfargument name="ProcedureOpenCloseID" required="No" type="String" default="">
		<cfargument name="ProcedureOpenCloseID_IN" required="No" type="String" default="">
		<cfargument name="ProcedureOpenCloseID_LIKE" required="No" type="String" default="">
		<cfargument name="ProcedureID" required="No" type="String" default="">
		...
		<cfargument name="OpenOrClose" required="No" type="String" default="">
		<cfargument name="OpenOrClose_IN" required="No" type="String" default="">
		<cfargument name="OpenOrClose_LIKE" required="No" type="String" default="">
		<cfargument name="UsersID" required="No" type="String" default="">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfquery Name="getProcedureOpenCloseQuery" datasource="#trim(request.datasource)#">
				...
				WHERE 1=1
					...
					<cfif ProcedureOpenCloseID_LIKE NEQ "">AND ProcedureOpenCloseID LIKE '%#trim(ProcedureOpenCloseID_LIKE)#%'</cfif>
					...
					<cfif OpenOrClose NEQ "" AND IsNumeric(OpenOrClose)>AND OpenOrClose = #OpenOrClose#</cfif>
					<cfif OpenOrClose_IN NEQ "">AND OpenOrClose IN(#trim(OpenOrClose_IN)#)</cfif>
					<cfif OpenOrClose_LIKE NEQ "">AND OpenOrClose LIKE '%#trim(OpenOrClose_LIKE)#%'</cfif>
			...
			<cfreturn getProcedureOpenCloseQuery>
