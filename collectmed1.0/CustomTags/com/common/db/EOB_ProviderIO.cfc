...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the EOB_Provider table in the dB.                --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_EOB_ProviderTable                                                --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<!--- ProviderID<br>                                                                 --->
<!--- ProviderName<br>                                                               --->
<!--- ProviderMainAddressID<br>                                                      --->
<!--- ProviderMainPhoneID<br>                                                        --->
<!--- Active<br>                                                                     --->
<!--- InactiveCode<br>                                                               --->
<!--- DateCreated<br>                                                                --->
<!--- DateModified<br>                                                               --->  
...
<cfcomponent name="EOB_ProviderIO">
	...
	<cffunction name="reset" access="public" output="no">
		...
		<cfscript>
			...
			variables.instance.ProviderName = "";
			variables.instance.ProviderMainAddressID = "NULL";
			variables.instance.ProviderMainPhoneID = "NULL";
...
<!-------------------------------------------------------------------------------------->
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "PROVIDERID", 2)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "PROVIDERNAME", 3)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "PROVIDERMAINADDRESSID", 4)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "PROVIDERMAINPHONEID", 5)>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for ProviderName.                                           --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getProviderName" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.ProviderName>
	</cffunction>
	 
	<cffunction name="setProviderName" access="public" returntype="boolean" output="No">
 		
		<cfargument name="ProviderName" required="Yes" type="String">
		
		<cfif ProviderName NEQ "NULL">	
			
			<cfif arguments.ProviderName EQ "@@" OR arguments.ProviderName EQ "">
				
				<cfset arguments.ProviderName = "NULL">
						
			<cfelseif NOT REQUEST.isvarcharDataType(ProviderName)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>ProviderName</strong> (#ProviderName#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(ProviderName) GT 150>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>ProviderName</strong> cannot be greater than 150 character(s).">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.ProviderName = arguments.ProviderName>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "ProviderName")>			
		<cfreturn true>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for ProviderMainAddressID.                                  --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getProviderMainAddressID" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.ProviderMainAddressID>
	</cffunction>
	 
	<cffunction name="setProviderMainAddressID" access="public" returntype="boolean" output="No">
 		
		<cfargument name="ProviderMainAddressID" required="Yes" type="String">
		
		<cfif ProviderMainAddressID NEQ "NULL">	
			
			<cfif arguments.ProviderMainAddressID EQ "@@" OR arguments.ProviderMainAddressID EQ "">
				
				<cfset arguments.ProviderMainAddressID = "NULL">
						
			<cfelseif NOT REQUEST.isintDataType(ProviderMainAddressID)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>ProviderMainAddressID</strong> (#ProviderMainAddressID#) is not of type <strong>int</strong>.">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.ProviderMainAddressID = arguments.ProviderMainAddressID>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "ProviderMainAddressID")>			
		<cfreturn true>
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for ProviderMainPhoneID.                                    --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getProviderMainPhoneID" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.ProviderMainPhoneID>
	</cffunction>
	 
	<cffunction name="setProviderMainPhoneID" access="public" returntype="boolean" output="No">
 		
		<cfargument name="ProviderMainPhoneID" required="Yes" type="String">
		
		<cfif ProviderMainPhoneID NEQ "NULL">	
			
			<cfif arguments.ProviderMainPhoneID EQ "@@" OR arguments.ProviderMainPhoneID EQ "">
				
				<cfset arguments.ProviderMainPhoneID = "NULL">
						
			<cfelseif NOT REQUEST.isintDataType(ProviderMainPhoneID)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>ProviderMainPhoneID</strong> (#ProviderMainPhoneID#) is not of type <strong>int</strong>.">
			</cfif>
						
		</cfif>	
			
 		<cfset variables.instance.ProviderMainPhoneID = arguments.ProviderMainPhoneID>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "ProviderMainPhoneID")>			
		<cfreturn true>
	...
	<cffunction name="new" access="public" output="no">
		...
		<cfargument name="ProviderName" required="No" type="String" default="">
		<cfargument name="ProviderMainAddressID" required="No" type="String" default="">
		<cfargument name="ProviderMainPhoneID" required="No" type="String" default="">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="Init" access="public" returntype="EOB_ProviderIO" output="No">
		...
		<cfscript>
			IF(qGetEOB_Provider.recordID EQ "" OR qGetEOB_Provider.recordID EQ "NULL") 
				variables.instance.recordID = "NULL"; 
			ELSE 
				variables.instance.recordID = qGetEOB_Provider.recordID;
							
				variables.instance.ProviderID = qGetEOB_Provider.ProviderID;
							
				variables.instance.ProviderName = qGetEOB_Provider.ProviderName;
				
			IF(qGetEOB_Provider.ProviderMainAddressID EQ "" OR qGetEOB_Provider.ProviderMainAddressID EQ "NULL") 
				variables.instance.ProviderMainAddressID = "NULL"; 
			ELSE 
				variables.instance.ProviderMainAddressID = qGetEOB_Provider.ProviderMainAddressID;
				
			IF(qGetEOB_Provider.ProviderMainPhoneID EQ "" OR qGetEOB_Provider.ProviderMainPhoneID EQ "NULL") 
				variables.instance.ProviderMainPhoneID = "NULL"; 
			ELSE 
				variables.instance.ProviderMainPhoneID = qGetEOB_Provider.ProviderMainPhoneID;
							
				variables.instance.Active = qGetEOB_Provider.Active;
				
			IF(qGetEOB_Provider.InactiveCode EQ "" OR qGetEOB_Provider.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetEOB_Provider.InactiveCode;
							
				variables.instance.DateCreated = qGetEOB_Provider.DateCreated;
							
				variables.instance.DateModified = qGetEOB_Provider.DateModified;
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfset variables.instance.recordID = qInsertCommitEOB_Provider.recordID>
				
				<cfreturn qInsertCommitEOB_Provider.recordID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->	
			<cfset tableColumns = "recordID,ProviderID,ProviderName,ProviderMainAddressID,ProviderMainPhoneID,Active,InactiveCode,DateCreated,DateModified">		
			
		<!-------------------------------------------------------------------------------------->
		<!--- Denote the column names that need single quotes (strings).                     --->
		<!-------------------------------------------------------------------------------------->
			<cfset stringTableColumns = "ProviderID,ProviderName,Active">	
		...
		<!-------------------------------------------------------------------------------------->					
			...
			<!-------------------------------------------------------------------------------------->	
				<cfset sqlStatement = "UPDATE EOB_Provider  SET #columnsToUpdate# WHERE recordID = #trim(variables.instance.recordID)#">
	...
	<cffunction name="preInsertDataCheck" output="no">		
		...
		<!--- append it to the update statement.                                             --->
		<!-------------------------------------------------------------------------------------->					
			<cfloop list="ProviderID,ProviderName,ProviderMainAddressID,ProviderMainPhoneID,Active,InactiveCode,DateCreated,DateModified" index="currentVar">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getEOB_ProviderQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getEOB_ProviderQuery">						
		<cfargument name="Fields" required="No" type="String" default="recordID,ProviderID,ProviderName,ProviderMainAddressID,ProviderMainPhoneID,Active,InactiveCode,DateCreated,DateModified">	
		...
		<cfargument name="ProviderName" required="No" type="String" default="">
		<cfargument name="ProviderName_IN" required="No" type="String" default="">
		<cfargument name="ProviderName_LIKE" required="No" type="String" default="">
		<cfargument name="ProviderMainAddressID" required="No" type="String" default="">
		<cfargument name="ProviderMainAddressID_IN" required="No" type="String" default="">
		<cfargument name="ProviderMainAddressID_LIKE" required="No" type="String" default="">
		<cfargument name="ProviderMainPhoneID" required="No" type="String" default="">
		<cfargument name="ProviderMainPhoneID_IN" required="No" type="String" default="">
		<cfargument name="ProviderMainPhoneID_LIKE" required="No" type="String" default="">
		<cfargument name="Active" required="No" type="String" default="">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfset availableColumns = "recordID,recordID_IN,recordID_LIKE,ProviderID,ProviderID_IN,ProviderID_LIKE,ProviderName,ProviderName_IN,ProviderName_LIKE,ProviderMainAddressID,ProviderMainAddressID_IN,ProviderMainAddressID_LIKE,ProviderMainPhoneID,ProviderMainPhoneID_IN,ProviderMainPhoneID_LIKE,Active,Active_IN,Active_LIKE,InactiveCode,InactiveCode_IN,InactiveCode_LIKE,DateCreated,DateCreated_IN,DateCreated_LIKE,DateModified,DateModified_IN,DateModified_LIKE,top1">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfquery Name="getEOB_ProviderQuery" datasource="pa_master">
				...
				WHERE 1=1
					...
					<cfif ProviderName NEQ "">AND ProviderName = '#ProviderName#'</cfif>
					<cfif ProviderName_IN NEQ "">AND ProviderName IN(#trim(ProviderName_IN)#)</cfif>
					<cfif ProviderName_LIKE NEQ "">AND ProviderName LIKE '%#trim(ProviderName_LIKE)#%'</cfif>
					<cfif ProviderMainAddressID NEQ "" AND IsNumeric(ProviderMainAddressID)>AND ProviderMainAddressID = #ProviderMainAddressID#</cfif>
					<cfif ProviderMainAddressID_IN NEQ "">AND ProviderMainAddressID IN(#trim(ProviderMainAddressID_IN)#)</cfif>
					<cfif ProviderMainAddressID_LIKE NEQ "">AND ProviderMainAddressID LIKE '%#trim(ProviderMainAddressID_LIKE)#%'</cfif>
					<cfif ProviderMainPhoneID NEQ "" AND IsNumeric(ProviderMainPhoneID)>AND ProviderMainPhoneID = #ProviderMainPhoneID#</cfif>
					<cfif ProviderMainPhoneID_IN NEQ "">AND ProviderMainPhoneID IN(#trim(ProviderMainPhoneID_IN)#)</cfif>
					<cfif ProviderMainPhoneID_LIKE NEQ "">AND ProviderMainPhoneID LIKE '%#trim(ProviderMainPhoneID_LIKE)#%'</cfif>
