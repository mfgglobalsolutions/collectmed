...
<!--- NAME:                                                                          --->
<!--- @@Name@@                                                                       --->
<!--- EOB_MEDICARE_PROCEDURECodeFeeScheduleIO.cfc                                    --->
<!--- @@Name@@                                                                       --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- CATEGORY:                                                                      --->
...
<!--- DESCRIPTION:                                                                   ---> 
<!--- @@DESCRIPTION@@                                                                --->
<!--- This tag is a CFC tag tied to the EOB_MEDICARE_PROCEDURECodeFeeSchedule table  --->
<!--- in the dB.                                                                     --->  
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@ExampleCall@@                                                                --->
<!--- &lt;cf_db_Get_EOB_MEDICARE_PROCEDURECodeFeeScheduleTable                       --->  
<!--- @@ExampleCall@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<cfcomponent name="EOB_MEDICARE_PROCEDURECodeFeeScheduleIO">
	...
	<cffunction name="reset" access="public" output="no">
		...
		<cfscript>
			...
			variables.instance.MOD1 = "";
			variables.instance.MOD2 = "";
			variables.instance.MOD3 = "";
			variables.instance.MOD4 = "";
			...
			variables.instance.Fee_AK_19 = "NULL";
...
<!-------------------------------------------------------------------------------------->
	...
	<cfset temp = QueryAddRow(defaultsQuery, 65)>
...
<!-------------------------------------------------------------------------------------->
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "ACTIVE", 38)>
	<cfset temp = QuerySetCell(defaultsQuery, "IS_NULLABLE", "No", 38)>
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_DEFAULT", "1", 38)>
	<cfset temp = QuerySetCell(defaultsQuery, "DATA_TYPE", "char", 38)>
	
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "INACTIVECODE", 39)>
	<cfset temp = QuerySetCell(defaultsQuery, "IS_NULLABLE", "YES", 39)>
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_DEFAULT", "", 39)>
	<cfset temp = QuerySetCell(defaultsQuery, "DATA_TYPE", "int", 39)>
	
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "DATECREATED", 40)>
	<cfset temp = QuerySetCell(defaultsQuery, "IS_NULLABLE", "No", 40)>
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_DEFAULT", "NOW()", 40)>
	<cfset temp = QuerySetCell(defaultsQuery, "DATA_TYPE", "datetime", 40)>
	
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "DATEMODIFIED", 41)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "CATEGORYID", 42)>
	<cfset temp = QuerySetCell(defaultsQuery, "IS_NULLABLE", "YES", 42)>
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_DEFAULT", "", 42)>
	<cfset temp = QuerySetCell(defaultsQuery, "DATA_TYPE", "int", 42)>
	
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "MOD1", 43)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "MOD2", 44)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "MOD3", 45)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "MOD4", 46)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "CEILING", 47)>
	<cfset temp = QuerySetCell(defaultsQuery, "IS_NULLABLE", "YES", 47)>
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_DEFAULT", "", 47)>
	<cfset temp = QuerySetCell(defaultsQuery, "DATA_TYPE", "money", 47)>
	
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FLOOR", 48)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_AL_16", 49)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_AK_17", 50)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_AZ_18", 51)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_AK_19", 52)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_CA_20", 53)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_CO_21", 54)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_CT_22", 55)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_DE_23", 56)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_DC_24", 57)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_FL_25", 58)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_GA_26", 59)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_HI_27", 60)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_ID_28", 61)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_IL_29", 62)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_IN_30", 63)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_IA_31", 64)>
	...
	<cfset temp = QuerySetCell(defaultsQuery, "COLUMN_NAME", "FEE_KS_32", 65)>
	...
	<cffunction name="setMOD1" access="public" returntype="boolean" output="No">
		...
		<cfif MOD1 NEQ "NULL">	
			...
			<cfif NOT REQUEST.isvarcharDataType(MOD1)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>MOD1</strong> (#MOD1#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(MOD1) GT 5>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>MOD1</strong> cannot be greater than 5 character(s).">
			</cfif>
						
			<cfif arguments.MOD1 EQ "@@">
	...
	<cffunction name="setMOD2" access="public" returntype="boolean" output="No">
		...
		<cfif MOD2 NEQ "NULL">	
			...
			<cfif NOT REQUEST.isvarcharDataType(MOD2)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>MOD2</strong> (#MOD2#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(MOD2) GT 5>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>MOD2</strong> cannot be greater than 5 character(s).">
			</cfif>
						
			<cfif arguments.MOD2 EQ "@@">
	...
	<cffunction name="setMOD3" access="public" returntype="boolean" output="No">
		...
		<cfif MOD3 NEQ "NULL">	
			...
			<cfif NOT REQUEST.isvarcharDataType(MOD3)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>MOD3</strong> (#MOD3#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(MOD3) GT 5>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>MOD3</strong> cannot be greater than 5 character(s).">
			</cfif>
						
			<cfif arguments.MOD3 EQ "@@">
	...
	<cffunction name="setMOD4" access="public" returntype="boolean" output="No">
		...
		<cfif MOD4 NEQ "NULL">	
			...
			<cfif NOT REQUEST.isvarcharDataType(MOD4)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>MOD4</strong> (#MOD4#) is not of type <strong>varchar</strong>.">	
			<cfelseif len(MOD4) GT 5>
				<cf_gcGeneralErrorTemplate
					message="The field <strong>MOD4</strong> cannot be greater than 5 character(s).">
			</cfif>
						
			<cfif arguments.MOD4 EQ "@@">
	...
	<!--------------------------------------------------------------------------------------> 	
	<!--- GET and SET method for Fee_AK_19.                                              --->
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getFee_AK_19" access="public" returntype="String" output="No">
  		<cfreturn variables.instance.Fee_AK_19>
	</cffunction>
	 
	<cffunction name="setFee_AK_19" access="public" returntype="boolean" output="No">
 		
		<cfargument name="Fee_AK_19" required="Yes" type="String">
		
		<cfif Fee_AK_19 NEQ "NULL">	
			
			<cfif NOT REQUEST.ismoneyDataType(Fee_AK_19)>
				<cf_gcGeneralErrorTemplate				
					message="<strong>Fee_AK_19</strong> (#Fee_AK_19#) is not of type <strong>money</strong>.">
			</cfif>
						
			<cfif arguments.Fee_AK_19 EQ "@@">
				<cfset arguments.Fee_AK_19 = "NULL">
			</cfif>
			
		</cfif>	
			
 		<cfset variables.instance.Fee_AK_19 = arguments.Fee_AK_19>					
		<cfset variables.instance.changedVariables = ListAppend(variables.instance.changedVariables, "Fee_AK_19")>			
		<cfreturn true>
	...
	<cffunction name="new" access="public" output="no">
		...
		<cfargument name="Fee_AK_19" required="No" type="String" default="">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="Init" access="public" returntype="EOB_MEDICARE_PROCEDURECodeFeeScheduleIO" output="No">
		
		<cfargument name="RecordID" required="yes" type="numeric">		
		<cfset var qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule = "">
		
		<cfset preInit(RecordID)>
	
		<cfquery name="qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule" datasource="#request.datasource#">
	  		SELECT RecordID,HCPCRecordID,CategoryID,MOD1,MOD2,MOD3,MOD4,Ceiling,Floor,Fee_AL_16,Fee_AK_17,Fee_AZ_18,Fee_AK_19,Fee_CA_20,Fee_CO_21,Fee_CT_22,Fee_DE_23,Fee_DC_24,Fee_FL_25,Fee_GA_26,Fee_HI_27,Fee_ID_28,Fee_IL_29,Fee_IN_30,Fee_IA_31,Fee_KS_32,Fee_KY_33,Fee_LA_34,Fee_ME_35,Fee_MD_36,Fee_MA_37,Fee_MI_38,Fee_MN_39,Fee_MS_40,Fee_MO_41,Fee_MT_42,Fee_NE_43,Fee_NV_44,Fee_NE_45,Fee_NJ_46,Fee_NM_47,Fee_NY_48,Fee_NC_49,Fee_ND_50,Fee_OH_51,Fee_OK_52,Fee_OR_53,Fee_PA_54,Fee_RI_55,Fee_SC_56,Fee_SD_57,Fee_TN_58,Fee_TX_59,Fee_UT_60,Fee_VT_61,Fee_VA_62,Fee_WA_63,Fee_WV_64,Fee_WI_65,Fee_WY_66,Fee_PR_229,Active,InactiveCode,DateCreated,DateModified
			FROM EOB_MEDICARE_PROCEDURECodeFeeSchedule  
			WHERE RecordID = #trim(arguments.RecordID)# 
		</cfquery>
		
		<cfif qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Recordcount LTE 0>
			<cf_gcGeneralErrorTemplate				
		...
		<cfscript>
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.RecordID EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.RecordID EQ "NULL") 
				variables.instance.RecordID = "NULL"; 
			ELSE 
				variables.instance.RecordID = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.RecordID;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.HCPCRecordID EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.HCPCRecordID EQ "NULL") 
				variables.instance.HCPCRecordID = "NULL"; 
			ELSE 
				variables.instance.HCPCRecordID = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.HCPCRecordID;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.CategoryID EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.CategoryID EQ "NULL") 
				variables.instance.CategoryID = "NULL"; 
			ELSE 
				variables.instance.CategoryID = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.CategoryID;
							
				variables.instance.MOD1 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.MOD1;
							
				variables.instance.MOD2 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.MOD2;
							
				variables.instance.MOD3 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.MOD3;
							
				variables.instance.MOD4 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.MOD4;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Ceiling EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Ceiling EQ "NULL") 
				variables.instance.Ceiling = "NULL"; 
			ELSE 
				variables.instance.Ceiling = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Ceiling;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Floor EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Floor EQ "NULL") 
				variables.instance.Floor = "NULL"; 
			ELSE 
				variables.instance.Floor = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Floor;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AL_16 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AL_16 EQ "NULL") 
				variables.instance.Fee_AL_16 = "NULL"; 
			ELSE 
				variables.instance.Fee_AL_16 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AL_16;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AK_17 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AK_17 EQ "NULL") 
				variables.instance.Fee_AK_17 = "NULL"; 
			ELSE 
				variables.instance.Fee_AK_17 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AK_17;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AZ_18 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AZ_18 EQ "NULL") 
				variables.instance.Fee_AZ_18 = "NULL"; 
			ELSE 
				variables.instance.Fee_AZ_18 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AZ_18;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AK_19 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AK_19 EQ "NULL") 
				variables.instance.Fee_AK_19 = "NULL"; 
			ELSE 
				variables.instance.Fee_AK_19 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_AK_19;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_CA_20 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_CA_20 EQ "NULL") 
				variables.instance.Fee_CA_20 = "NULL"; 
			ELSE 
				variables.instance.Fee_CA_20 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_CA_20;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_CO_21 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_CO_21 EQ "NULL") 
				variables.instance.Fee_CO_21 = "NULL"; 
			ELSE 
				variables.instance.Fee_CO_21 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_CO_21;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_CT_22 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_CT_22 EQ "NULL") 
				variables.instance.Fee_CT_22 = "NULL"; 
			ELSE 
				variables.instance.Fee_CT_22 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_CT_22;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_DE_23 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_DE_23 EQ "NULL") 
				variables.instance.Fee_DE_23 = "NULL"; 
			ELSE 
				variables.instance.Fee_DE_23 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_DE_23;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_DC_24 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_DC_24 EQ "NULL") 
				variables.instance.Fee_DC_24 = "NULL"; 
			ELSE 
				variables.instance.Fee_DC_24 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_DC_24;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_FL_25 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_FL_25 EQ "NULL") 
				variables.instance.Fee_FL_25 = "NULL"; 
			ELSE 
				variables.instance.Fee_FL_25 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_FL_25;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_GA_26 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_GA_26 EQ "NULL") 
				variables.instance.Fee_GA_26 = "NULL"; 
			ELSE 
				variables.instance.Fee_GA_26 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_GA_26;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_HI_27 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_HI_27 EQ "NULL") 
				variables.instance.Fee_HI_27 = "NULL"; 
			ELSE 
				variables.instance.Fee_HI_27 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_HI_27;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_ID_28 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_ID_28 EQ "NULL") 
				variables.instance.Fee_ID_28 = "NULL"; 
			ELSE 
				variables.instance.Fee_ID_28 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_ID_28;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_IL_29 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_IL_29 EQ "NULL") 
				variables.instance.Fee_IL_29 = "NULL"; 
			ELSE 
				variables.instance.Fee_IL_29 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_IL_29;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_IN_30 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_IN_30 EQ "NULL") 
				variables.instance.Fee_IN_30 = "NULL"; 
			ELSE 
				variables.instance.Fee_IN_30 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_IN_30;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_IA_31 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_IA_31 EQ "NULL") 
				variables.instance.Fee_IA_31 = "NULL"; 
			ELSE 
				variables.instance.Fee_IA_31 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_IA_31;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_KS_32 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_KS_32 EQ "NULL") 
				variables.instance.Fee_KS_32 = "NULL"; 
			ELSE 
				variables.instance.Fee_KS_32 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_KS_32;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_KY_33 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_KY_33 EQ "NULL") 
				variables.instance.Fee_KY_33 = "NULL"; 
			ELSE 
				variables.instance.Fee_KY_33 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_KY_33;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_LA_34 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_LA_34 EQ "NULL") 
				variables.instance.Fee_LA_34 = "NULL"; 
			ELSE 
				variables.instance.Fee_LA_34 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_LA_34;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_ME_35 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_ME_35 EQ "NULL") 
				variables.instance.Fee_ME_35 = "NULL"; 
			ELSE 
				variables.instance.Fee_ME_35 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_ME_35;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MD_36 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MD_36 EQ "NULL") 
				variables.instance.Fee_MD_36 = "NULL"; 
			ELSE 
				variables.instance.Fee_MD_36 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MD_36;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MA_37 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MA_37 EQ "NULL") 
				variables.instance.Fee_MA_37 = "NULL"; 
			ELSE 
				variables.instance.Fee_MA_37 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MA_37;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MI_38 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MI_38 EQ "NULL") 
				variables.instance.Fee_MI_38 = "NULL"; 
			ELSE 
				variables.instance.Fee_MI_38 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MI_38;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MN_39 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MN_39 EQ "NULL") 
				variables.instance.Fee_MN_39 = "NULL"; 
			ELSE 
				variables.instance.Fee_MN_39 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MN_39;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MS_40 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MS_40 EQ "NULL") 
				variables.instance.Fee_MS_40 = "NULL"; 
			ELSE 
				variables.instance.Fee_MS_40 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MS_40;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MO_41 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MO_41 EQ "NULL") 
				variables.instance.Fee_MO_41 = "NULL"; 
			ELSE 
				variables.instance.Fee_MO_41 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MO_41;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MT_42 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MT_42 EQ "NULL") 
				variables.instance.Fee_MT_42 = "NULL"; 
			ELSE 
				variables.instance.Fee_MT_42 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_MT_42;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NE_43 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NE_43 EQ "NULL") 
				variables.instance.Fee_NE_43 = "NULL"; 
			ELSE 
				variables.instance.Fee_NE_43 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NE_43;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NV_44 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NV_44 EQ "NULL") 
				variables.instance.Fee_NV_44 = "NULL"; 
			ELSE 
				variables.instance.Fee_NV_44 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NV_44;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NE_45 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NE_45 EQ "NULL") 
				variables.instance.Fee_NE_45 = "NULL"; 
			ELSE 
				variables.instance.Fee_NE_45 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NE_45;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NJ_46 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NJ_46 EQ "NULL") 
				variables.instance.Fee_NJ_46 = "NULL"; 
			ELSE 
				variables.instance.Fee_NJ_46 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NJ_46;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NM_47 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NM_47 EQ "NULL") 
				variables.instance.Fee_NM_47 = "NULL"; 
			ELSE 
				variables.instance.Fee_NM_47 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NM_47;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NY_48 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NY_48 EQ "NULL") 
				variables.instance.Fee_NY_48 = "NULL"; 
			ELSE 
				variables.instance.Fee_NY_48 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NY_48;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NC_49 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NC_49 EQ "NULL") 
				variables.instance.Fee_NC_49 = "NULL"; 
			ELSE 
				variables.instance.Fee_NC_49 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_NC_49;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_ND_50 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_ND_50 EQ "NULL") 
				variables.instance.Fee_ND_50 = "NULL"; 
			ELSE 
				variables.instance.Fee_ND_50 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_ND_50;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_OH_51 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_OH_51 EQ "NULL") 
				variables.instance.Fee_OH_51 = "NULL"; 
			ELSE 
				variables.instance.Fee_OH_51 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_OH_51;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_OK_52 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_OK_52 EQ "NULL") 
				variables.instance.Fee_OK_52 = "NULL"; 
			ELSE 
				variables.instance.Fee_OK_52 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_OK_52;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_OR_53 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_OR_53 EQ "NULL") 
				variables.instance.Fee_OR_53 = "NULL"; 
			ELSE 
				variables.instance.Fee_OR_53 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_OR_53;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_PA_54 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_PA_54 EQ "NULL") 
				variables.instance.Fee_PA_54 = "NULL"; 
			ELSE 
				variables.instance.Fee_PA_54 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_PA_54;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_RI_55 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_RI_55 EQ "NULL") 
				variables.instance.Fee_RI_55 = "NULL"; 
			ELSE 
				variables.instance.Fee_RI_55 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_RI_55;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_SC_56 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_SC_56 EQ "NULL") 
				variables.instance.Fee_SC_56 = "NULL"; 
			ELSE 
				variables.instance.Fee_SC_56 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_SC_56;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_SD_57 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_SD_57 EQ "NULL") 
				variables.instance.Fee_SD_57 = "NULL"; 
			ELSE 
				variables.instance.Fee_SD_57 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_SD_57;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_TN_58 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_TN_58 EQ "NULL") 
				variables.instance.Fee_TN_58 = "NULL"; 
			ELSE 
				variables.instance.Fee_TN_58 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_TN_58;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_TX_59 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_TX_59 EQ "NULL") 
				variables.instance.Fee_TX_59 = "NULL"; 
			ELSE 
				variables.instance.Fee_TX_59 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_TX_59;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_UT_60 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_UT_60 EQ "NULL") 
				variables.instance.Fee_UT_60 = "NULL"; 
			ELSE 
				variables.instance.Fee_UT_60 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_UT_60;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_VT_61 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_VT_61 EQ "NULL") 
				variables.instance.Fee_VT_61 = "NULL"; 
			ELSE 
				variables.instance.Fee_VT_61 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_VT_61;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_VA_62 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_VA_62 EQ "NULL") 
				variables.instance.Fee_VA_62 = "NULL"; 
			ELSE 
				variables.instance.Fee_VA_62 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_VA_62;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WA_63 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WA_63 EQ "NULL") 
				variables.instance.Fee_WA_63 = "NULL"; 
			ELSE 
				variables.instance.Fee_WA_63 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WA_63;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WV_64 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WV_64 EQ "NULL") 
				variables.instance.Fee_WV_64 = "NULL"; 
			ELSE 
				variables.instance.Fee_WV_64 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WV_64;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WI_65 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WI_65 EQ "NULL") 
				variables.instance.Fee_WI_65 = "NULL"; 
			ELSE 
				variables.instance.Fee_WI_65 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WI_65;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WY_66 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WY_66 EQ "NULL") 
				variables.instance.Fee_WY_66 = "NULL"; 
			ELSE 
				variables.instance.Fee_WY_66 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_WY_66;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_PR_229 EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_PR_229 EQ "NULL") 
				variables.instance.Fee_PR_229 = "NULL"; 
			ELSE 
				variables.instance.Fee_PR_229 = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Fee_PR_229;
							
				variables.instance.Active = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.Active;
				
			IF(qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.InactiveCode EQ "" OR qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.InactiveCode EQ "NULL") 
				variables.instance.InactiveCode = "NULL"; 
			ELSE 
				variables.instance.InactiveCode = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.InactiveCode;
							
				variables.instance.DateCreated = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.DateCreated;
							
				variables.instance.DateModified = qGetEOB_MEDICARE_PROCEDURECodeFeeSchedule.DateModified;
	...
	<cffunction name="Commit" access="public" returntype="Boolean">
	 	...
	 	<cfset var qCommitEOB_MEDICARE_PROCEDURECodeFeeSchedule = "">
		...
		<cfif IsNumeric(variables.instance.RecordID) AND variables.instance.RecordID  GT 0>	  		
			...
			<cfif ListLen(trim(variables.instance.changedVariables)) GTE 1>
				...
				<cfquery name="qUpdateCommitEOB_MEDICARE_PROCEDURECodeFeeSchedule" datasource="#request.datasource#">
		...
		<cfelse>
			...
			<cfelse>
				...
				<cfquery name="qInsertCommitEOB_MEDICARE_PROCEDURECodeFeeSchedule" datasource="#request.datasource#">
		   			#PreserveSingleQuotes(sqlStatement)#
		   		</cfquery>		
		 					
				<cfset postInsertCommit()>
				
				<cfset variables.instance.RecordID = qInsertCommitEOB_MEDICARE_PROCEDURECodeFeeSchedule.RecordID>
				
				<cfreturn qInsertCommitEOB_MEDICARE_PROCEDURECodeFeeSchedule.RecordID>
	...
	<cffunction name="preUpdateDataCheck" output="no">
		...
		<!-------------------------------------------------------------------------------------->	
			<cfset tableColumns = "RecordID,HCPCRecordID,CategoryID,MOD1,MOD2,MOD3,MOD4,Ceiling,Floor,Fee_AL_16,Fee_AK_17,Fee_AZ_18,Fee_AK_19,Fee_CA_20,Fee_CO_21,Fee_CT_22,Fee_DE_23,Fee_DC_24,Fee_FL_25,Fee_GA_26,Fee_HI_27,Fee_ID_28,Fee_IL_29,Fee_IN_30,Fee_IA_31,Fee_KS_32,Fee_KY_33,Fee_LA_34,Fee_ME_35,Fee_MD_36,Fee_MA_37,Fee_MI_38,Fee_MN_39,Fee_MS_40,Fee_MO_41,Fee_MT_42,Fee_NE_43,Fee_NV_44,Fee_NE_45,Fee_NJ_46,Fee_NM_47,Fee_NY_48,Fee_NC_49,Fee_ND_50,Fee_OH_51,Fee_OK_52,Fee_OR_53,Fee_PA_54,Fee_RI_55,Fee_SC_56,Fee_SD_57,Fee_TN_58,Fee_TX_59,Fee_UT_60,Fee_VT_61,Fee_VA_62,Fee_WA_63,Fee_WV_64,Fee_WI_65,Fee_WY_66,Fee_PR_229,Active,InactiveCode,DateCreated,DateModified">		
			
		<!-------------------------------------------------------------------------------------->
		<!--- Denote the column names that need single quotes (strings).                     --->
		<!-------------------------------------------------------------------------------------->
			<cfset stringTableColumns = "MOD1,MOD2,MOD3,MOD4,Active">	
	...
	<cffunction name="preInsertDataCheck" output="no">		
		...
		<!--- append it to the update statement.                                             --->
		<!-------------------------------------------------------------------------------------->					
			<cfloop list="HCPCRecordID,CategoryID,MOD1,MOD2,MOD3,MOD4,Ceiling,Floor,Fee_AL_16,Fee_AK_17,Fee_AZ_18,Fee_AK_19,Fee_CA_20,Fee_CO_21,Fee_CT_22,Fee_DE_23,Fee_DC_24,Fee_FL_25,Fee_GA_26,Fee_HI_27,Fee_ID_28,Fee_IL_29,Fee_IN_30,Fee_IA_31,Fee_KS_32,Fee_KY_33,Fee_LA_34,Fee_ME_35,Fee_MD_36,Fee_MA_37,Fee_MI_38,Fee_MN_39,Fee_MS_40,Fee_MO_41,Fee_MT_42,Fee_NE_43,Fee_NV_44,Fee_NE_45,Fee_NJ_46,Fee_NM_47,Fee_NY_48,Fee_NC_49,Fee_ND_50,Fee_OH_51,Fee_OK_52,Fee_OR_53,Fee_PA_54,Fee_RI_55,Fee_SC_56,Fee_SD_57,Fee_TN_58,Fee_TX_59,Fee_UT_60,Fee_VT_61,Fee_VA_62,Fee_WA_63,Fee_WV_64,Fee_WI_65,Fee_WY_66,Fee_PR_229,Active,InactiveCode,DateCreated,DateModified" index="currentVar">
	...
	<!--- query.                                                                         --->
	<!-------------------------------------------------------------------------------------->
	<cffunction name="getEOB_MEDICARE_PROCEDURECodeFeeScheduleQuery" returntype="query" hint="Call this object by appending to the where clause the columns that match your search criteria returning a query.">
		
		<cfargument name="QueryName" required="No" type="String" default="getEOB_MEDICARE_PROCEDURECodeFeeScheduleQuery">						
		<cfargument name="Fields" required="No" type="String" default="RecordID,HCPCRecordID,CategoryID,MOD1,MOD2,MOD3,MOD4,Ceiling,Floor,Fee_AL_16,Fee_AK_17,Fee_AZ_18,Fee_AK_19,Fee_CA_20,Fee_CO_21,Fee_CT_22,Fee_DE_23,Fee_DC_24,Fee_FL_25,Fee_GA_26,Fee_HI_27,Fee_ID_28,Fee_IL_29,Fee_IN_30,Fee_IA_31,Fee_KS_32,Fee_KY_33,Fee_LA_34,Fee_ME_35,Fee_MD_36,Fee_MA_37,Fee_MI_38,Fee_MN_39,Fee_MS_40,Fee_MO_41,Fee_MT_42,Fee_NE_43,Fee_NV_44,Fee_NE_45,Fee_NJ_46,Fee_NM_47,Fee_NY_48,Fee_NC_49,Fee_ND_50,Fee_OH_51,Fee_OK_52,Fee_OR_53,Fee_PA_54,Fee_RI_55,Fee_SC_56,Fee_SD_57,Fee_TN_58,Fee_TX_59,Fee_UT_60,Fee_VT_61,Fee_VA_62,Fee_WA_63,Fee_WV_64,Fee_WI_65,Fee_WY_66,Fee_PR_229,Active,InactiveCode,DateCreated,DateModified">	
		...
		<cfargument name="Fee_AK_19" required="No" type="String" default="">
		<cfargument name="Fee_AK_19_IN" required="No" type="String" default="">
		<cfargument name="Fee_AK_19_LIKE" required="No" type="String" default="">
		<cfargument name="Fee_CA_20" required="No" type="String" default="">
		...
		<!-------------------------------------------------------------------------------------->			
			<cfquery Name="getEOB_MEDICARE_PROCEDURECodeFeeScheduleQuery" datasource="#trim(request.DataSource)#" cachedwithin="#CreateTimeSpan(0,0,0,0)#">
				SELECT #trim(Fields)#
				FROM EOB_MEDICARE_PROCEDURECodeFeeSchedule  WHERE 1=1
					...
					<cfif Fee_AK_19 NEQ "" AND IsNumeric(Fee_AK_19)>AND Fee_AK_19 = #Fee_AK_19#</cfif>
					<cfif Fee_AK_19_IN NEQ "">AND Fee_AK_19 IN(#trim(Fee_AK_19_IN)#)</cfif>
					<cfif Fee_AK_19_LIKE NEQ "">AND Fee_AK_19 LIKE '%#trim(Fee_AK_19_LIKE)#%'</cfif>
			...
			<cfreturn getEOB_MEDICARE_PROCEDURECodeFeeScheduleQuery>
