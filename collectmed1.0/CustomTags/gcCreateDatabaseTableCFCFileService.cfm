...
<cfset fileString = fileString & '		
	...
	<!--- Pseudo-constructor                                                             --->
	<!-------------------------------------------------------------------------------------->
	<cfset variables.instance.#trim(TableName)#DAO = '''' />
	<cfset variables.instance.#trim(TableName)#Gateway = '''' />	
	...
	<cffunction name="init" access="public"	output="false" returntype="any" hint="I am the constructor method for the #trim(TableName)#SVC Class.">
		...
		<cfargument name="#trim(TableName)#DAO" required="true" type="Components.service.#trim(TableName)#DAO" hint="I am the DAO object." />
		<cfargument name="#trim(TableName)#Gateway" required="true" type="Components.service.#trim(TableName)#Gateway" hint="I am the Gateway object." />
	...
	<cffunction name="save" access="public" output="false" hint="I save or update an #trim(TableName)# into the database.">
		...
		<cfreturn variables.instance.#trim(TableName)#DAO.save(arguments.#trim(TableName)#) />
	</cffunction>
	
	<cffunction name="read" access="public" output="false" hint="I obtain details for a specific #trim(TableName)# from the database.">
		<cfargument name="#trim(TableName)#" required="true" type="cmComponents.com.common.model.#trim(TableName)#" hint="I am the #trim(TableName)# you wish to search for." />
		<cfreturn variables.instance.#trim(TableName)#DAO.read(arguments.#trim(TableName)#) />
	</cffunction>
	...
	<cffunction name="delete" access="public" output="false" hint="I delete a specific #trim(TableName)# from the database.">
		...
		<cfreturn variables.instance.#trim(TableName)#DAO.delete(arguments.#trim(TableName)#ID) />
	</cffunction>	
	...
	<cffunction name="getAll#trim(TableName)#s" access="public" output="false" hint="I run a query of all #trim(TableName)#s within the database table.">		
		...
		<cfreturn variables.instance.#trim(TableName)#Gateway.getAll#trim(TableName)#s(arguments.filter) />		
	</cffunction>
	...
	<cffunction name="filterBy#trim(TableName)#ID" access="public" output="false" hint="I run a query of all #trim(TableName)#s within the database table based upon a filter.">
		...
		<cfreturn variables.instance.#trim(TableName)#Gateway.filterAll#trim(TableName)#s(strFilter) />
