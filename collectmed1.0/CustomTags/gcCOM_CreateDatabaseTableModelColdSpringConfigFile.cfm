<!-------------------------------------------------------------------------------------->
<!--- NAME: gcCreateDatabaseTableModelColdSpringConfigFile.cfm                       --->
<!-------------------------------------------------------------------------------------->
<!--- PURPOSE:                                                                       --->  
<!---                                                                                --->
...
<cfloop query="CurrentModelcfcs">		
<cfif ListLast(name, ".") EQ "cfc">		
<cfset fileString = fileString & '
	<bean id="#ListFirst(name, ".")#" class="com.model.#ListFirst(name, ".")#" autowire="byType" />'>
</cfif>	
</cfloop>
