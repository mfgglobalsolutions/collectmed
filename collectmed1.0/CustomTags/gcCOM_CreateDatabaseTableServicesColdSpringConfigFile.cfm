<!-------------------------------------------------------------------------------------->
<!--- NAME: gcCreateDatabaseTableServicesColdSpringConfigFile.cfm                    --->
<!-------------------------------------------------------------------------------------->
<!--- PURPOSE:                                                                       --->  
<!---                                                                                --->
...
<!-------------------------------------------------------------------------------------->
	...
	<cfparam name="attributes.componentPath" default="eobmanager1.0\com\services\config">
...
<cfdirectory action="LIST" directory="C:\EOBManager\eobmanager1.0\com\services" name="CurrentServicescfcs">	
...
<cfloop query="CurrentServicescfcs">		
<cfif ListLast(name, ".") EQ "cfc">		
<cfset fileString = fileString & '
	<bean id="#ListFirst(name, ".")#" class="com.services.#ListFirst(name, ".")#" autowire="byType">
		<constructor-arg name="systemDAO"><ref bean="systemDAO" /></constructor-arg>	
	</bean>'>
</cfif>	
</cfloop>
