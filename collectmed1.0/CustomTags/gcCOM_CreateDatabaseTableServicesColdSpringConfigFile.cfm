...
<!-------------------------------------------------------------------------------------->
	...
	<cfparam name="attributes.componentPath" default="collectmed1.0\com\services\config">
...
<cfdirectory action="LIST" directory="C:\collectmed\collectmed1.0\com\services" name="CurrentServicescfcs">	
