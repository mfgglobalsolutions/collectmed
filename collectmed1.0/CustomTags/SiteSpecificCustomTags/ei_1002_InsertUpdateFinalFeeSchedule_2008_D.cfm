...
<!-------------------------------------------------------------------------------------->
	...
	<cfparam name="attributes.filename" default="DMEFeeSchedule_2008_D_PIPE.txt">
...
ALTER TABLE [dbo].[EOB_MEDICARE_2008_D_PROCEDURECodeFeeSchedule] ADD 
	...
	CONSTRAINT [DF_EOB_MEDICARE_2008_D_PROCEDURECodeFeeSchedule_DateCreated] DEFAULT (now()) FOR [DateCreated]
GO
