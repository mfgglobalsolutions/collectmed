...
<!--- NAME:                                                      --->
<!--- @@NAME@@                                                   --->
<!---   ei_1002_InsertUpdateAcuteCareProcedureCodes.cfm          --->
<!--- @@NAME@@                                                   --->
<!------------------------------------------------------------------>
<!--- CATEGORY:                                                  --->
<!--- @@CATEGORY@@                                               --->
...
<!--- EXAMPLE CALL:                                              --->
<!--- @@EXAMPLECALL@@                                            --->
<!---  &lt;cf_ei_1002_InsertUpdateAcuteCareProcedureCodes<br>    --->
<!---  &nbsp;&nbsp;testmode="no"                                 --->
<!--- @@EXAMPLECALL@@                                            --->
<!---                                                            --->
<!------------------------------------------------------------------>
...
<!--- <strong>filename</strong> (PROCDESC.REF)<br>               --->
...
<!------------------------------------------------------------------>
	...
	<cfparam name="attributes.filename" default="PROCDESC.REF">
		...
		<cfelse>
			...
			<cfif NOT testmode>
				...
				<cfquery name="insertCode" datasource="#trim(request.datasource)#">
					INSERT INTO ei_2_PROCEDURECode  (code, description)
