...
<!-------------------------------------------------------------------------------------->
	...
	<cfparam name="attributes.filename" default="DMEFeeSchedule_2009_B_PIPE.txt">
	...
	<cfloop list="#trim(fileContent)#" delimiters="#chr(13)##chr(10)#" index="i">
		...
		<cfif NOT ISNumeric(trim(getCategoryCodeID.StandardListItemID))>		
			<cfoutput>
				...
				INSERT INTO EOB_MEDICARE_2009_B_PROCEDURECodeFeeSchedule(HCPCRecordID, CategoryID, MOD1, MOD2, MOD3, MOD4, Ceiling, Floor, Fee_AL_16, Fee_AK_17, Fee_AZ_18, Fee_AR_19, Fee_CA_20, Fee_CO_21, Fee_CT_22, Fee_DE_23, Fee_DC_24, Fee_FL_25, Fee_GA_26, Fee_HI_27, Fee_ID_28, Fee_IL_29, Fee_IN_30, Fee_IA_31, Fee_KS_32, Fee_KY_33, Fee_LA_34, Fee_ME_35, Fee_MD_36, Fee_MA_37, Fee_MI_38, Fee_MN_39, Fee_MS_40, Fee_MO_41, Fee_MT_42, Fee_NE_43, Fee_NV_44, Fee_NE_45, Fee_NJ_46, Fee_NM_47, Fee_NY_48, Fee_NC_49, Fee_ND_50, Fee_OH_51, Fee_OK_52, Fee_OR_53, Fee_PA_54, Fee_RI_55, Fee_SC_56, Fee_SD_57, Fee_TN_58, Fee_TX_59, Fee_UT_60, Fee_VT_61, Fee_VA_62, Fee_WA_63, Fee_WV_64, Fee_WI_65, Fee_WY_66, Fee_PR_229, Fee_VI_238, Description)
...
ALTER TABLE [dbo].[EOB_MEDICARE_2009_B_PROCEDURECodeFeeSchedule] ADD 
	...
	CONSTRAINT [DF_EOB_MEDICARE_2009_B_PROCEDURECodeFeeSchedule_DateCreated] DEFAULT (now()) FOR [DateCreated]
GO
