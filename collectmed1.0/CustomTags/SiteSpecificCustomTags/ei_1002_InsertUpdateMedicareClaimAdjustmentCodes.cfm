...
<!--- NAME:                                                      --->
<!--- @@NAME@@                                                   --->
<!---   ei_1002_InsertUpdateMedicareClaimAdjustmentCodes.cfm     --->
<!--- @@NAME@@                                                   --->
<!------------------------------------------------------------------>
<!--- CATEGORY:                                                  --->
<!--- @@CATEGORY@@                                               --->
...
<!--- MedicareClaimAdjustmentCodes.txt                           --->
...
<!--- EXAMPLE CALL:                                              --->
<!--- @@EXAMPLECALL@@                                            --->
<!---  &lt;cf_ei_1002_InsertUpdateMedicareClaimAdjustmentCodes<br> --->
<!---  &nbsp;&nbsp;testmode="no"                                 --->
<!--- @@EXAMPLECALL@@                                            --->
<!---                                                            --->
<!------------------------------------------------------------------>
...
<!--- (MedicareClaimAdjustmentCodes.txt)<br>                     --->
...
<!------------------------------------------------------------------>
	...
	<cfparam name="attributes.filename" default="MedicareClaimAdjustmentCodes.txt">
		...
		<cfif getCode.RecordCount GTE 1>
			...
			<cfif NOT testmode>
				...
				<cfquery name="update" datasource="#trim(request.datasource)#">
					UPDATE pa_master.EOB_MEDICARE_CLAIMADJUSTMENTCode  
		...
		<cfelse>
			...
			<cfif NOT testmode>
				...
				<cfquery name="insertCode" datasource="#trim(request.datasource)#">
					INSERT INTO pa_master.EOB_MEDICARE_CLAIMADJUSTMENTCode  (code, description)
