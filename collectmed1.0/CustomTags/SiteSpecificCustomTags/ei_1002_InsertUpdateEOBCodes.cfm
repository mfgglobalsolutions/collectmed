...
<!--- NAME:                                                      --->
<!--- @@NAME@@                                                   --->
<!---   ei_1002_InsertUpdateEOBCodes.cfm                         --->
<!--- @@NAME@@                                                   --->
<!------------------------------------------------------------------>
<!--- CATEGORY:                                                  --->
<!--- @@CATEGORY@@                                               --->
...
<!--- eobmanager\eob_1002_Codes_Import\EOB.REF                   --->
...
<!--- EXAMPLE CALL:                                              --->
<!--- @@EXAMPLECALL@@                                            --->
<!---  &lt;cf_ei_1002_InsertUpdateEOBCodes<br>                   --->
<!---  &nbsp;&nbsp;testmode="no"                                 --->
<!--- @@EXAMPLECALL@@                                            --->
<!---                                                            --->
<!------------------------------------------------------------------>
...
<!--- <strong>filename</strong> (EOB.REF)<br>                    --->
...
<!------------------------------------------------------------------>
	...
	<cfparam name="attributes.filename" default="EOB.REF">
		...
		<cfelse>
			...
			<cfif NOT testmode>
				...
				<cfquery name="insertCode" datasource="#trim(request.datasource)#">
					INSERT INTO ei_2_EOBCode  (code, description)
