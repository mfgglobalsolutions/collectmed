...
<!--- DESCRIPTION:                                                                   --->      
<!--- @@DESCRIPTION@@                                                                --->
<!---  This tag will show the phone number form on a page.                           --->
<!--- @@DESCRIPTION@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- EXAMPLE CALL:                                                                  --->
<!--- @@EXAMPLECALL@@                                                                --->
<!--- &&lt;cf_gcPhoneNumberInputDisplay<br>                                          --->
<!---    formname="#trim(formName)#"<br>                                             --->
<!---    functionname="checkPhoneNumber1"<br>                                        --->
<!--- @@EXAMPLECALL@@                                                                --->
<!---                                                                                --->
<!-------------------------------------------------------------------------------------->
<!--- REQUIRED PARAMETERS:                                                           --->
...
<!-------------------------------------------------------------------------------------->	
	...
	<cfparam name="attributes.required" default="PhoneNumberElement">
	<cfset required = attributes.required>
	
	<cfparam name="attributes.requiredMessages" default="You must provide a phone number">
	<cfset requiredMessages = attributes.requiredMessages>
	
	<cfparam name="attributes.requiredType" default="Phone">
	<cfset requiredType = attributes.requiredType>
	
	<cfparam name="attributes.visible" default="PhoneNumberElement">
	...
	<cfparam name="attributes.PhoneNumberElement" default="PhoneNumber">
	<cfset PhoneNumberElement = attributes.PhoneNumberElement>
		
	<cfparam name="attributes.ExtensionElement" default="Extension">
	<cfset ExtensionElement = attributes.ExtensionElement>	
	...
	<cfparam name="attributes.PhoneNumberElementValue" default="">
	<cfset PhoneNumberElementValue = attributes.PhoneNumberElementValue>
	
	<cfparam name="attributes.ExtensionElementValue" default="">
	<cfset ExtensionElementValue = attributes.ExtensionElementValue>
	...
	<cfparam name="attributes.PhoneNumberElementDisplay" default="">
	<cfset PhoneNumberElementDisplay = attributes.PhoneNumberElementDisplay>
	
	<cfparam name="attributes.ExtensionElementDisplay" default="">
	<cfset ExtensionElementDisplay = attributes.ExtensionElementDisplay>
...
<!-------------------------------------------------------------------------------------->
	<cfoutput>
		...
		<script language="JavaScript">
			...
			function IsValidPhoneNumberJS_#randRange#(str) {									
			...
			function #functionname#(){
				...
				<cfloop from="1" to="#listlen(required, "|")#" index="i">
					...
					<cfif elementType EQ "Email">
						else if(!IsValidPhoneNumberJS_#randRange#(document.#trim(formname)#.#evaluate(element)#.value)){
							document.#trim(formname)#.#evaluate(element)#.className = 'SiteTextboxALERT'; 
...
<!-------------------------------------------------------------------------------------->
	<cfoutput>			
		<table border="0" cellpadding="0" cellspacing="0">				
			...
			<cfif ListFindNoCase(visible, "PhoneNumberElement", "|")>
				<tr>
					<cfif PhoneNumberElementDisplay NEQ "">
						<td>									   
					   		<font face="#trim(fontFace)#" size="#trim(fontSize)#" color="#trim(fontColor)#">
								#PhoneNumberElementDisplay# 
							</font>						
						</td>
					</cfif>
					<td<cfif PhoneNumberElementDisplay EQ ""> colspan="2"</cfif>>
			   			<input class="SiteTextbox" type="text" name="#trim(PhoneNumberElement)#" size="35" maxlength="50" value="#PhoneNumberElementValue#"><cfif ListFindNoCase(required, "PhoneNumberElement", "|") GT 0><font size="2" color="FF0000">&nbsp;*</font></cfif>
					</td>
				</tr>				
			<cfelseif ListFindNoCase(hiddenList, "PhoneNumberElement", "|") AND trim(PhoneNumberElement) NEQ "">
				<input type="Hidden" name="#trim(PhoneNumberElement)#" value="#ListGetAt(hiddenValues, ListFindNoCase(hiddenList, "PhoneNumberElement", "|"), "|")#">
			</cfif>			
