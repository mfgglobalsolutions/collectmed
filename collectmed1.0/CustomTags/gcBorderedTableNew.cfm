...
<!------------------------------------------------------------------>
	...
	<cfparam name="attributes.backgroundColor" default="DCE3EB"><!---c0cddc---><!---FF9706--->
...
<!------------------------------------------------------------------>	
	<cfif ThisTag.ExecutionMode neq "end">
		...
		<cfoutput>
			...
			<div class="RoundedBoxTitle">				
				<span class="floatLeft" onclick="#trim(onclick)#">#trim(title)#</span>
				<cfif spanLink EQ "yes">
					<span id="span_Link" style="cursor:hand" class="RoundedBoxTitleRight" onclick="#trim(callWhenVisible)#; #trim(onclick)#"><u>#trim(spanLinkTitle)#</u></span>		
				</cfif>				
			</div>
			<div class="RoundedBox">			
			
						<div id="Box_#trim(randRange)#" style="display: #trim(view)#; padding: 4px; text-align: #trim(boxTextAlign)#;">
