...
<!-------------------------------------------------------------------------------------->		
	<cfif chartType EQ "pie2">	
		...
		<cfchart  title="Assigned Claims" style="/styles/eob_pie.xml" pieSliceStyle="sliced" format="#trim(format)#" fontbold="Yes" xaxistitle="Assigned" yaxistitle="Total" chartwidth="720" chartheight="500" show3d="Yes">
	...
	<cfelse>	
		...
		<cfchart title="Assigned Claims" format="#trim(format)#" pieSliceStyle="#trim(pieSliceStyle)#" xaxistitle="Assigned" yaxistitle="Total" chartwidth="720" chartheight="500" show3d="Yes"> 
