<!--- tagPatientIntakeSearch.cfm --->

<!-------------------------------------------------------------------------------------->
<!--- Initialize all tag variables.                                                  --->      
<!-------------------------------------------------------------------------------------->
	<cfparam name="attributes.formname" default="searchIntakes">
...
<cfoutput>
	<script language="JavaScript">
		...
		function resetForm(textObject) {   
			...
			document.#formName#.intakeIDs.value = '';
			document.#formName#.lastNameContains.value = '';
			document.#formName#.AssignedToUserID.value = '';
	...
	<cf_gcBorderedTable	title="Search&nbsp;Query" tablealign="center">	
		...
		<cfoutput>
			<form method="post" name="#trim(formname)#">
				<input type="Hidden" name="clear_session.User.IntakeDisplayQuery" value="1">
				<input type="Hidden" name="clear_session.User.IntakeDisplayCancelledQuery" value="1">
				<input type="Hidden" name="clear_session.User.IntakeDisplayClosedQuery" value="1">
				...
				<table border="0" cellpadding="0" cellspacing="10">					
					...
					<tr>			
						...
						<td nowrap><input type="Text" name="intakeIDs" value="" size="25" class="SiteTextBox"  onkeyup="this.value=this.value.replace(/[^\d]+/g,',');">&nbsp;<span class="copyGreySmall">(comma delimited)</span></td>			
					</tr>	
					...
					<tr>
						<td align="center" colspan="2" nowrap>			
							<cf_gcSubmitButton value="Search&nbsp;Intakes">&nbsp;&nbsp;&nbsp;<input type="button" onclick="resetForm(this);" value="Clear Form" class="SiteSubmitbox">							
						</td>
					</tr>					
				</table>			
			</form>
