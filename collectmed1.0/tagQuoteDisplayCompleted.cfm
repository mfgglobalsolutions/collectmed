		...
		<cftry>			
			...
			<cfoutput>
				<script language="JavaScript">
					var taskElement = document.getElementById("tabQuoteCompletedVerbage");
					if (taskElement != null){
						document.getElementById("tabQuoteCompletedVerbage").innerHTML = 'Completed (#trim(getQuotes.RecordCount)#)';		
					};	
				</script>
			</cfoutput>					
