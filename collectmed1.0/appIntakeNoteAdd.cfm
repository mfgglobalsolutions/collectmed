...
<!-------------------------------------------------------------------------------------->
	<cfif note NEQ "">
		...
		<!-------------------------------------------------------------------------------------->
		<!--- Add code to update the intake itself so that we know if anything has been      --->
...
<!-------------------------------------------------------------------------------------->
	<cfset urlString = "appIntakeNote.cfm?objectID=#trim(objectID)#&instanceID=#trim(instanceID)#">
