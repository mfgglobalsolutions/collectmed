...
<!-------------------------------------------------------------------------------------->
	...
	<cfparam name="attributes.ObjectID" default="5">
	...
	<cfparam name="attributes.InstanceID" default="8418"><!---8418 7703--->
			...
			<cf_gcBorderedTable	title="Create&nbsp;Flag" tablealign="left" tableWidth="100%">	
				<form name="#trim(formName)#" method="post" onsubmit="return validateForm();">
					...
					<table align="left" cellpadding="5" cellspacing="0" border="0">				
						<tr>					
							<td valign="top">			   
					   			<form name="CreateFlag" method="post" action="appCreateFlagAdd.cfm" onsubmit="return validateForm();">																					
									<table cellspacing="4" cellpadding="3" border="0">
										...
										<tr>
											<!---<td class="SiteRequiredLabel" valign="top" align="right">Flag&nbsp;Note:</td>--->
											<td colspan="2">														
												<cf_gcHTMLNoteEditor form_name="#trim(formname)#" field_name="note" verbage="">								
											</td>
		
										    <!---<td class="SiteLabel"><textarea class="SiteTextArea" name="note" cols="100" rows="6" onclick="insertAtCursor(document.#trim(formName)#.note, document.#trim(formName)#.parameter.value);"><cfif IsDefined("editNote")>#trim(editNote)#</cfif></textarea></td>--->
										</tr>
