...
<!-------------------------------------------------------------------------------------->
	<cfset AddressObj = createObject("component", "addressGateway")>
	<cfset address = AddressObj.getByID(ds: trim(request.datasource), addressID: trim(addressID))>	
								...
								<li>
									...
									<select class="SiteSelectBox" name="AddressTypeID">											
										<cfloop query="getAllAddressTypes">
											<option value="#StandardListItemID#" <cfif StandardListItemID EQ address.getAddressTypeID()>SELECTED</cfif>> #ItemNameDisplay#
										</cfloop>
									</select>
								</li>
								<li>
									<label for="Attention">Attention:</label>
									<input class="SiteTextbox" name="Attention" type="text" size="25" value="#address.getAttention()#">
								</li>
								<li>
									<label for="AddressLine1">Address Line 1:</label>
									<input class="SiteTextbox" name="AddressLine1" type="text" size="25" value="#address.getAddressLine1()#">
								</li>
								<li>
									<label for="AddressLine2">Address Line 2:</label>
									<input class="SiteTextbox" name="AddressLine2" type="text" size="25" value="#address.getAddressLine2()#">
								</li>
								<li>
									<label for="City">City, State Zip:</label>
									<input class="SiteTextbox" type="text" name="City" size="15" maxlength="50" value="#address.getCity()#" onChange="capitalizeMe(this)">,
									&nbsp;&nbsp;
									...
									<select class="SiteSelectBox" name="StateID">
										<cfloop query="getAllStates">
											<option value="#StandardListItemID#" <cfif StandardListItemID EQ address.getStateID()>SELECTED</cfif>> #ItemNameDisplay#
										</cfloop>
									</select>
									&nbsp;<input class="SiteTextbox" type="Text" name="ZipCode" size="13" maxlength="25" value="#address.getZipCode()#"> 					
								</li>									
							</ol>
						</fieldset>							
