...
<cfcomponent name="eob_medicare_2006_procedurecodefeescheduleBean" output="false" alias="eob_medicare_2006_procedurecodefeescheduleBean" extends="EOB_MEDICARE_2006_PROCEDURECodeFeeScheduleDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_medicare_2006_procedurecodefeescheduleBean">
