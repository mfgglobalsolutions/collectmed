...
<cfcomponent output="false">
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="bean" required="true" type="EOB_MEDICARE_2005_PROCEDURECodeFeeScheduleBean" />
		...
		<cftransaction isolation="read_committed">
			...
			<cfquery name="qCreateEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule" datasource="#trim(arguments.ds)#">
		...
		<cfscript>
			arguments.bean.setRecordID(qCreateEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.RecordID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EOB_MEDICARE_2005_PROCEDURECodeFeeScheduleBean">
		
		<cfargument name="ds" required="true" type="string" />
		<cfargument name="RecordID" required="yes" type="numeric" />		
		<cfset var qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule = "" />		
		
		<cfset qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule = getEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule(trim(arguments.ds), trim(EOB_MEDICARE_2005_PROCEDURECodeFeeScheduleID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule = createObject("component", "EOB_MEDICARE_2005_PROCEDURECodeFeeScheduleBean").init(arguments.ds);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setRecordID(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.RecordID);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setHCPCRecordID(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.HCPCRecordID);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setCategoryID(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.CategoryID);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setMOD1(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.MOD1);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setMOD2(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.MOD2);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setMOD3(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.MOD3);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setMOD4(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.MOD4);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setCeiling(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Ceiling);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFloor(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Floor);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_AL_16(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_AL_16);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_AK_17(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_AK_17);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_AZ_18(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_AZ_18);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_AR_19(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_AR_19);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_CA_20(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_CA_20);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_CO_21(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_CO_21);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_CT_22(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_CT_22);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_DE_23(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_DE_23);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_DC_24(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_DC_24);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_FL_25(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_FL_25);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_GA_26(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_GA_26);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_HI_27(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_HI_27);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_ID_28(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_ID_28);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_IL_29(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_IL_29);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_IN_30(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_IN_30);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_IA_31(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_IA_31);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_KS_32(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_KS_32);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_KY_33(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_KY_33);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_LA_34(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_LA_34);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_ME_35(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_ME_35);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_MD_36(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_MD_36);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_MA_37(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_MA_37);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_MI_38(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_MI_38);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_MN_39(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_MN_39);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_MS_40(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_MS_40);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_MO_41(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_MO_41);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_MT_42(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_MT_42);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_NE_43(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_NE_43);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_NV_44(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_NV_44);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_NE_45(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_NE_45);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_NJ_46(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_NJ_46);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_NM_47(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_NM_47);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_NY_48(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_NY_48);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_NC_49(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_NC_49);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_ND_50(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_ND_50);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_OH_51(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_OH_51);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_OK_52(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_OK_52);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_OR_53(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_OR_53);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_PA_54(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_PA_54);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_RI_55(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_RI_55);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_SC_56(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_SC_56);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_SD_57(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_SD_57);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_TN_58(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_TN_58);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_TX_59(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_TX_59);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_UT_60(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_UT_60);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_VT_61(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_VT_61);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_VA_62(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_VA_62);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_WA_63(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_WA_63);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_WV_64(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_WV_64);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_WI_65(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_WI_65);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_WY_66(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_WY_66);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_PR_229(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_PR_229);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setFee_VI_238(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Fee_VI_238);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setActive(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.Active);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setInactiveCode(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.InactiveCode);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setDateCreated(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.DateCreated);
			objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.setDateModified(qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule.DateModified);				
			return objEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule" datasource="#trim(arguments.ds)#">
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDeleteEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule" datasource="#trim(arguments.ds)#" result="status">
			DELETE
	...
	<cffunction name="getEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule" output="false" access="public" returntype="query">
		...
		<cfargument name="ds" required="true" type="string" />
		<cfargument name="EOB_MEDICARE_2005_PROCEDURECodeFeeScheduleID" required="yes" type="numeric" />		
		<cfset var qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule = "" />		
	
		<cfquery name="qGetEOB_MEDICARE_2005_PROCEDURECodeFeeSchedule" datasource="#trim(arguments.ds)#">
