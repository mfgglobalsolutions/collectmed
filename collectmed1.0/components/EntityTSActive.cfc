...
<cfcomponent name="entitytsActive" output="false" alias="entitytsActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="entitytsActive">
		...
		<cfif isDefined("arguments.stValues")>
			<cfif StructKeyExists(stValues, "EntityTSID") AND stValues.EntityTSID NEQ 0>
				<cfquery name="qGetEntityTS" datasource="#trim(variables.ds)#">
	...
	<cffunction name="save" output="false" access="remote">
		...
		<cfif this.getEntityTSID() EQ 0>
			<cfset create(this)>			
		<cfelse>
			<cfset update(this)>
		</cfif>
		
		<cfreturn this.getEntityTSID()>	
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EntityTSActive" />
		...
		<cftransaction isolation="read_committed">
			...
			<cfquery name="qCreateEntityTS" datasource="#trim(variables.ds)#">
				INSERT INTO EntityTS (EntityID,ColM,ColR,InactiveCode)
				VALUES (						
		...
		<cfscript>
			read(qCreateEntityTS.EntityTSID);
			arguments.obj.setEntityTSID(qCreateEntityTS.EntityTSID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EntityTSActive">
				
		<cfargument name="EntityTSID" required="yes" type="numeric" />		
		<cfset var qGetEntityTS = "" />		
		
		<cfset qGetEntityTS = getEntityTS(trim(EntityTSID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setEntityTSID(qGetEntityTS.EntityTSID);
			this.setEntityID(qGetEntityTS.EntityID);
			this.setColM(qGetEntityTS.ColM);
			this.setColR(qGetEntityTS.ColR);
			this.setIsDefault(qGetEntityTS.IsDefault);
			this.setActive(qGetEntityTS.Active);
			this.setInactiveCode(qGetEntityTS.InactiveCode);
			this.setDateCreated(qGetEntityTS.DateCreated);
			this.setDateModified(qGetEntityTS.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateEntityTS" datasource="#trim(variables.ds)#">
				UPDATE EntityTS  SET
				...
				WHERE EntityTSID = <cfqueryparam value="#trim(arguments.obj.getEntityTSID())#" cfsqltype="CF_SQL_INTEGER">
			</cfquery>		
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDeleteEntityTS" datasource="#trim(variables.ds)#" result="status">
			DELETE
			FROM EntityTS
			WHERE EntityTSID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#trim(obj.getEntityTSID())#" /> 
		</cfquery>
