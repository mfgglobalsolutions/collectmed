...
<cfcomponent name="eob_medicare_2007_procedurecodefeescheduleBean" output="false" alias="eob_medicare_2007_procedurecodefeescheduleBean" extends="EOB_MEDICARE_2007_PROCEDURECodeFeeScheduleDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_medicare_2007_procedurecodefeescheduleBean">
