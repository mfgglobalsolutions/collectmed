...
<cfcomponent name="eob_medicare_2006_procedurecodefeescheduleActive" output="false" alias="eob_medicare_2006_procedurecodefeescheduleActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_medicare_2006_procedurecodefeescheduleActive">
		...
		<cfif isDefined("arguments.stValues")>
			<cfif StructKeyExists(stValues, "RecordID") AND stValues.RecordID NEQ 0>
				<cfquery name="qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule" datasource="#trim(variables.ds)#">
				...
				<cfscript>
					variables.HCPCRecordID = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.HCPCRecordID;
					variables.CategoryID = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.CategoryID;
					variables.MOD1 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.MOD1;
					variables.MOD2 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.MOD2;
					variables.MOD3 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.MOD3;
					variables.MOD4 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.MOD4;
					variables.Ceiling = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Ceiling;
					variables.Floor = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Floor;
					variables.Fee_AL_16 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_AL_16;
					variables.Fee_AK_17 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_AK_17;
					variables.Fee_AZ_18 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_AZ_18;
					variables.Fee_AR_19 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_AR_19;
					variables.Fee_CA_20 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_CA_20;
					variables.Fee_CO_21 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_CO_21;
					variables.Fee_CT_22 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_CT_22;
					variables.Fee_DE_23 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_DE_23;
					variables.Fee_DC_24 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_DC_24;
					variables.Fee_FL_25 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_FL_25;
					variables.Fee_GA_26 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_GA_26;
					variables.Fee_HI_27 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_HI_27;
					variables.Fee_ID_28 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_ID_28;
					variables.Fee_IL_29 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_IL_29;
					variables.Fee_IN_30 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_IN_30;
					variables.Fee_IA_31 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_IA_31;
					variables.Fee_KS_32 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_KS_32;
					variables.Fee_KY_33 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_KY_33;
					variables.Fee_LA_34 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_LA_34;
					variables.Fee_ME_35 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_ME_35;
					variables.Fee_MD_36 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MD_36;
					variables.Fee_MA_37 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MA_37;
					variables.Fee_MI_38 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MI_38;
					variables.Fee_MN_39 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MN_39;
					variables.Fee_MS_40 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MS_40;
					variables.Fee_MO_41 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MO_41;
					variables.Fee_MT_42 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MT_42;
					variables.Fee_NE_43 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NE_43;
					variables.Fee_NV_44 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NV_44;
					variables.Fee_NE_45 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NE_45;
					variables.Fee_NJ_46 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NJ_46;
					variables.Fee_NM_47 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NM_47;
					variables.Fee_NY_48 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NY_48;
					variables.Fee_NC_49 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NC_49;
					variables.Fee_ND_50 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_ND_50;
					variables.Fee_OH_51 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_OH_51;
					variables.Fee_OK_52 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_OK_52;
					variables.Fee_OR_53 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_OR_53;
					variables.Fee_PA_54 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_PA_54;
					variables.Fee_RI_55 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_RI_55;
					variables.Fee_SC_56 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_SC_56;
					variables.Fee_SD_57 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_SD_57;
					variables.Fee_TN_58 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_TN_58;
					variables.Fee_TX_59 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_TX_59;
					variables.Fee_UT_60 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_UT_60;
					variables.Fee_VT_61 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_VT_61;
					variables.Fee_VA_62 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_VA_62;
					variables.Fee_WA_63 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_WA_63;
					variables.Fee_WV_64 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_WV_64;
					variables.Fee_WI_65 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_WI_65;
					variables.Fee_WY_66 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_WY_66;
					variables.Fee_PR_229 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_PR_229;
					variables.Fee_VI_238 = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_VI_238;
					variables.Active = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Active;
					variables.InactiveCode = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.InactiveCode;
					variables.DateModified = qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.DateModified;
				</cfscript>
			</cfif>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="getEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule" output="false" access="public" returntype="query">
		...
		<cfreturn qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule>
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EOB_MEDICARE_2006_PROCEDURECodeFeeScheduleActive" />
		
		<cfset var qCreateEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule = "" />		
		...
		<cftransaction isolation="read_committed">
			...
			<cfquery name="qCreateEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule" datasource="#trim(variables.ds)#">
		...
		<cfscript>
			read(qCreateEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.RecordID);
			arguments.obj.setRecordID(qCreateEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.RecordID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EOB_MEDICARE_2006_PROCEDURECodeFeeScheduleActive">
				
		<cfargument name="RecordID" required="yes" type="numeric" />		
		<cfset var qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule = "" />		
		
		<cfset qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule = getEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule(trim(RecordID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setRecordID(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.RecordID);
			this.setHCPCRecordID(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.HCPCRecordID);
			this.setCategoryID(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.CategoryID);
			this.setMOD1(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.MOD1);
			this.setMOD2(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.MOD2);
			this.setMOD3(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.MOD3);
			this.setMOD4(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.MOD4);
			this.setCeiling(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Ceiling);
			this.setFloor(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Floor);
			this.setFee_AL_16(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_AL_16);
			this.setFee_AK_17(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_AK_17);
			this.setFee_AZ_18(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_AZ_18);
			this.setFee_AR_19(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_AR_19);
			this.setFee_CA_20(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_CA_20);
			this.setFee_CO_21(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_CO_21);
			this.setFee_CT_22(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_CT_22);
			this.setFee_DE_23(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_DE_23);
			this.setFee_DC_24(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_DC_24);
			this.setFee_FL_25(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_FL_25);
			this.setFee_GA_26(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_GA_26);
			this.setFee_HI_27(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_HI_27);
			this.setFee_ID_28(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_ID_28);
			this.setFee_IL_29(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_IL_29);
			this.setFee_IN_30(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_IN_30);
			this.setFee_IA_31(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_IA_31);
			this.setFee_KS_32(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_KS_32);
			this.setFee_KY_33(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_KY_33);
			this.setFee_LA_34(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_LA_34);
			this.setFee_ME_35(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_ME_35);
			this.setFee_MD_36(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MD_36);
			this.setFee_MA_37(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MA_37);
			this.setFee_MI_38(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MI_38);
			this.setFee_MN_39(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MN_39);
			this.setFee_MS_40(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MS_40);
			this.setFee_MO_41(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MO_41);
			this.setFee_MT_42(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_MT_42);
			this.setFee_NE_43(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NE_43);
			this.setFee_NV_44(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NV_44);
			this.setFee_NE_45(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NE_45);
			this.setFee_NJ_46(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NJ_46);
			this.setFee_NM_47(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NM_47);
			this.setFee_NY_48(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NY_48);
			this.setFee_NC_49(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_NC_49);
			this.setFee_ND_50(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_ND_50);
			this.setFee_OH_51(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_OH_51);
			this.setFee_OK_52(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_OK_52);
			this.setFee_OR_53(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_OR_53);
			this.setFee_PA_54(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_PA_54);
			this.setFee_RI_55(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_RI_55);
			this.setFee_SC_56(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_SC_56);
			this.setFee_SD_57(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_SD_57);
			this.setFee_TN_58(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_TN_58);
			this.setFee_TX_59(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_TX_59);
			this.setFee_UT_60(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_UT_60);
			this.setFee_VT_61(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_VT_61);
			this.setFee_VA_62(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_VA_62);
			this.setFee_WA_63(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_WA_63);
			this.setFee_WV_64(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_WV_64);
			this.setFee_WI_65(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_WI_65);
			this.setFee_WY_66(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_WY_66);
			this.setFee_PR_229(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_PR_229);
			this.setFee_VI_238(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Fee_VI_238);
			this.setActive(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.Active);
			this.setInactiveCode(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.InactiveCode);
			this.setDateCreated(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.DateCreated);
			this.setDateModified(qGetEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EOB_MEDICARE_2006_PROCEDURECodeFeeScheduleActive" />
		<cfset var qUpdateEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule = "" />
		<cfset var localHCPCRecordID = arguments.obj.getHCPCRecordID() />
		<cfset var localCategoryID = arguments.obj.getCategoryID() />
		<cfset var localMOD1 = arguments.obj.getMOD1() />
		<cfset var localMOD2 = arguments.obj.getMOD2() />
		...
		<cftry>
			...
			<cfquery name="qUpdateEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule" datasource="#trim(variables.ds)#">
				UPDATE eob_medicare_2006_procedurecodefeeschedule  SET
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfargument name="obj" required="true" type="EOB_MEDICARE_2006_PROCEDURECodeFeeScheduleActive" />
		<cfset var qDeleteEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule = "">

		<cfquery name="qDeleteEOB_MEDICARE_2006_PROCEDURECodeFeeSchedule" datasource="#trim(variables.ds)#" result="status">
			DELETE
			FROM eob_medicare_2006_procedurecodefeeschedule
