...
<cfcomponent name="eob_drgcodeBean" output="false" alias="eob_drgcodeBean" extends="EOB_DRGCodeDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_drgcodeBean">
