...
<cfcomponent name="procedureopencloseBean" output="false" alias="procedureopencloseBean" extends="ProcedureOpenCloseDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="procedureopencloseBean">
