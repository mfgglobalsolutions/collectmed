...
<cfcomponent name="eob_toscodeBean" output="false" alias="eob_toscodeBean" extends="EOB_TOSCodeDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_toscodeBean">
