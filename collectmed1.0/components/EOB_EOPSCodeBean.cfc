...
<cfcomponent name="eob_eopscodeBean" output="false" alias="eob_eopscodeBean" extends="EOB_EOPSCodeDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_eopscodeBean">
