...
<cfcomponent name="eob_diagnosiscodeBean" output="false" alias="eob_diagnosiscodeBean" extends="EOB_DIAGNOSISCodeDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_diagnosiscodeBean">
