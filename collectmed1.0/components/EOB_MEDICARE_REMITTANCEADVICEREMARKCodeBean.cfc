...
<cfcomponent name="eob_medicare_remittanceadviceremarkcodeBean" output="false" alias="eob_medicare_remittanceadviceremarkcodeBean" extends="EOB_MEDICARE_REMITTANCEADVICEREMARKCodeDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_medicare_remittanceadviceremarkcodeBean">
