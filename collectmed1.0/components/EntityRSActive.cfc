...
<cfcomponent name="entityrsActive" output="false" alias="entityrsActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="entityrsActive">
	...
	<cffunction name="save" output="false" access="remote">
		...
		<cfif this.getEntityRSID() EQ 0>
			<cfset create(this)>			
		<cfelse>
			<cfset update(this)>
		</cfif>
		
		<cfreturn this.getEntityRSID()>	
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EntityRSActive" />
		...
		<cfscript>
			read(qCreateEntityRS.EntityRSID);
			arguments.obj.setEntityRSID(qCreateEntityRS.EntityRSID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EntityRSActive">
				
		<cfargument name="EntityRSID" required="yes" type="numeric" />		
		<cfset var qGetEntityRS = "" />		
		
		<cfset qGetEntityRS = getEntityRS(trim(EntityRSID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setEntityRSID(qGetEntityRS.EntityRSID);
			this.setEntityID(qGetEntityRS.EntityID);
			this.setColM(qGetEntityRS.ColM);
			this.setColE(qGetEntityRS.ColE);
			this.setColL(qGetEntityRS.ColL);
			this.setColI(qGetEntityRS.ColI);
			this.setColA(qGetEntityRS.ColA);
			this.setColC(qGetEntityRS.ColC);
			this.setColR(qGetEntityRS.ColR);
			this.setIsDefault(qGetEntityRS.IsDefault);
			this.setActive(qGetEntityRS.Active);
			this.setInactiveCode(qGetEntityRS.InactiveCode);
			this.setDateCreated(qGetEntityRS.DateCreated);
			this.setDateModified(qGetEntityRS.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateEntityRS" datasource="#trim(variables.ds)#">
				...
				WHERE EntityRSID = <cfqueryparam value="#trim(arguments.obj.getEntityRSID())#" cfsqltype="CF_SQL_INTEGER">
			</cfquery>		
