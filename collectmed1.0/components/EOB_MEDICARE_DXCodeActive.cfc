...
<cfcomponent name="eob_medicare_dxcodeActive" output="false" alias="eob_medicare_dxcodeActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_medicare_dxcodeActive">
		...
		<cfif isDefined("arguments.stValues")>
			<cfif StructKeyExists(stValues, "RecordID") AND stValues.RecordID NEQ 0>
				<cfquery name="qGetEOB_MEDICARE_DXCode" datasource="#trim(variables.ds)#">
				...
				<cfscript>
					variables.Code = qGetEOB_MEDICARE_DXCode.Code;
					variables.Description = qGetEOB_MEDICARE_DXCode.Description;
					variables.Active = qGetEOB_MEDICARE_DXCode.Active;
					variables.InactiveCode = qGetEOB_MEDICARE_DXCode.InactiveCode;
					variables.DateModified = qGetEOB_MEDICARE_DXCode.DateModified;
				</cfscript>
			</cfif>
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EOB_MEDICARE_DXCodeActive" />
		...
		<cftransaction isolation="read_committed">
			...
			<cfquery name="qCreateEOB_MEDICARE_DXCode" datasource="#trim(variables.ds)#">
				INSERT INTO EOB_MEDICARE_DXCode (Code,Description,InactiveCode)
				VALUES (						
		...
		<cfscript>
			read(qCreateEOB_MEDICARE_DXCode.RecordID);
			arguments.obj.setRecordID(qCreateEOB_MEDICARE_DXCode.RecordID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EOB_MEDICARE_DXCodeActive">
				
		<cfargument name="RecordID" required="yes" type="numeric" />		
		<cfset var qGetEOB_MEDICARE_DXCode = "" />		
		
		<cfset qGetEOB_MEDICARE_DXCode = getEOB_MEDICARE_DXCode(trim(RecordID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setRecordID(qGetEOB_MEDICARE_DXCode.RecordID);
			this.setCode(qGetEOB_MEDICARE_DXCode.Code);
			this.setDescription(qGetEOB_MEDICARE_DXCode.Description);
			this.setActive(qGetEOB_MEDICARE_DXCode.Active);
			this.setInactiveCode(qGetEOB_MEDICARE_DXCode.InactiveCode);
			this.setDateCreated(qGetEOB_MEDICARE_DXCode.DateCreated);
			this.setDateModified(qGetEOB_MEDICARE_DXCode.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateEOB_MEDICARE_DXCode" datasource="#trim(variables.ds)#">
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDeleteEOB_MEDICARE_DXCode" datasource="#trim(variables.ds)#" result="status">
			DELETE
			FROM EOB_MEDICARE_DXCode
