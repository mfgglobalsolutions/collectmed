...
<cfcomponent name="procedure_medicare_claimadjustmentBean" output="false" alias="procedure_medicare_claimadjustmentBean" extends="Procedure_MEDICARE_CLAIMADJUSTMENTDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="procedure_medicare_claimadjustmentBean">
