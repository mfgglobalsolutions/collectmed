...
<cfcomponent name="eob_dmefeetoscodeBean" output="false" alias="eob_dmefeetoscodeBean" extends="EOB_DMEFEETOSCodeDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_dmefeetoscodeBean">
