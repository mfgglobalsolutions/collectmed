...
<cfcomponent displayname="InsuranceCompanySVC" output="false" hint="I am the InsuranceCompanySVC Class used to interact with the InsuranceCompany package.">
	...
	<cfset variables.instance.InsuranceCompanyGateway = '' />	
	...
	<cffunction name="init" access="public"	output="false" returntype="any" hint="I am the constructor method for the InsuranceCompanySVC Class.">
		...
		<cfargument name="InsuranceCompanyDAO" required="true" type="Components.service.InsuranceCompanyDAO" hint="I am the DAO object." />
		<cfargument name="InsuranceCompanyGateway" required="true" type="Components.service.InsuranceCompanyGateway" hint="I am the Gateway object." />
	...
	<cffunction name="save" access="public" output="false" hint="I save or update an InsuranceCompany into the database.">
		...
		<cfreturn variables.instance.InsuranceCompanyDAO.save(arguments.InsuranceCompany) />
	</cffunction>
	
	<cffunction name="read" access="public" output="false" hint="I obtain details for a specific InsuranceCompany from the database.">
		<cfargument name="InsuranceCompany" required="true" type="cmComponents.com.common.model.InsuranceCompany" hint="I am the InsuranceCompany you wish to search for." />
		<cfreturn variables.instance.InsuranceCompanyDAO.read(arguments.InsuranceCompany) />
	</cffunction>
	...
	<cffunction name="delete" access="public" output="false" hint="I delete a specific InsuranceCompany from the database.">
		...
		<cfreturn variables.instance.InsuranceCompanyDAO.delete(arguments.InsuranceCompanyID) />
	</cffunction>	
	...
	<cffunction name="getAllInsuranceCompanys" access="public" output="false" hint="I run a query of all InsuranceCompanys within the database table.">		
		...
		<cfreturn variables.instance.InsuranceCompanyGateway.getAllInsuranceCompanys(arguments.filter) />		
	</cffunction>
	...
	<cffunction name="filterByInsuranceCompanyID" access="public" output="false" hint="I run a query of all InsuranceCompanys within the database table based upon a filter.">
		...
		<cfreturn variables.instance.InsuranceCompanyGateway.filterAllInsuranceCompanys(strFilter) />
