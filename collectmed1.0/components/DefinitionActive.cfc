...
<cfcomponent name="definitionActive" output="false" alias="definitionActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="definitionActive">
	...
	<cffunction name="save" output="false" access="remote">
		...
		<cfif this.getDefinitionID() EQ 0>
			<cfset create(this)>			
		<cfelse>
			<cfset update(this)>
		</cfif>
		
		<cfreturn this.getDefinitionID()>	
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="DefinitionActive" />
		
		<cfset var qCreateDefinition = "" />		
		
		<cfset var localTitle = arguments.obj.getTitle() />
		<cfset var localDefinition = arguments.obj.getDefinition() />
		...
		<cfscript>
			read(qCreateDefinition.DefinitionID);
			arguments.obj.setDefinitionID(qCreateDefinition.DefinitionID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="DefinitionActive">
				
		<cfargument name="DefinitionID" required="yes" type="numeric" />		
		<cfset var qGetDefinition = "" />		
		
		<cfset qGetDefinition = getDefinition(trim(DefinitionID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setDefinitionID(qGetDefinition.DefinitionID);
			this.setTitle(qGetDefinition.Title);
			this.setDefinition(qGetDefinition.Definition);
			this.setActive(qGetDefinition.Active);
			this.setInactiveCode(qGetDefinition.InactiveCode);
			this.setDateCreated(qGetDefinition.DateCreated);
			this.setDateModified(qGetDefinition.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateDefinition" datasource="#trim(variables.ds)#">
				...
				WHERE DefinitionID = <cfqueryparam value="#trim(arguments.obj.getDefinitionID())#" cfsqltype="CF_SQL_INTEGER">
			</cfquery>		
