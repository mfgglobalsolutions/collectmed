...
<cfcomponent name="procedure_medicare_remark_codeBean" output="false" alias="procedure_medicare_remark_codeBean" extends="Procedure_MEDICARE_REMARK_CODEDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="procedure_medicare_remark_codeBean">
