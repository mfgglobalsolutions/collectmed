...
<cfcomponent output="false">
	...
	<cffunction name="getById" output="false" access="remote">
		...
		<cfreturn createObject("component", "EOB_ProviderDAO").read(trim(arguments.ds), trim(arguments.recordID))>		
	...
	<cffunction name="save" output="false" access="remote">
		...
		<cfif obj.getrecordID() EQ 0>
			<cfreturn createObject("component", "EOB_ProviderDAO").create(arguments.ds, arguments.obj)>
		<cfelse>
			<cfreturn createObject("component", "EOB_ProviderDAO").update(arguments.ds, arguments.obj)>
		</cfif>	
	...
	<cffunction name="deleteById" output="false" access="remote">
		...
		<cfset var obj = getById(arguments.ds, trim(arguments.recordID)) />
 		<cfset createObject("component", "EOB_ProviderDAO").delete(arguments.ds, obj) />		
	...
	<!-------------------------------------------------------------------------------------->		
	<cffunction name="getAllByIDArray" output="false" access="remote" returntype="EOB_ProviderBean[]">
		...
		<cfset var qRead="" />
		<cfset var obj="" />
		<cfset var arrEOB_ProviderBeans = arrayNew(1) />
		...
		<cfloop query="qRead">
			<cfscript>
				obj = createObject("component", "EOB_ProviderDAO").read(qRead.recordID);
				ArrayAppend(arrEOB_ProviderBeans, obj);
			</cfscript>
		</cfloop>
		
		<cfreturn arrEOB_ProviderBeans>
