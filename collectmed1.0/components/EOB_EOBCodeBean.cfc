...
<cfcomponent name="eob_eobcodeBean" output="false" alias="eob_eobcodeBean" extends="EOB_EOBCodeDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_eobcodeBean">
