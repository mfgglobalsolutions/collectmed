...
<cfcomponent name="eob_diagnosiscodeActive" output="false" alias="eob_diagnosiscodeActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_diagnosiscodeActive">
		...
		<cfif isDefined("arguments.stValues")>
			<cfif StructKeyExists(stValues, "RecordID") AND stValues.RecordID NEQ 0>
				<cfquery name="qGetEOB_DIAGNOSISCode" datasource="#trim(variables.ds)#">
				...
				<cfscript>
					variables.Code = qGetEOB_DIAGNOSISCode.Code;
					variables.Description = qGetEOB_DIAGNOSISCode.Description;
					variables.Active = qGetEOB_DIAGNOSISCode.Active;
					variables.InactiveCode = qGetEOB_DIAGNOSISCode.InactiveCode;
					variables.DateModified = qGetEOB_DIAGNOSISCode.DateModified;
				</cfscript>
			</cfif>
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EOB_DIAGNOSISCodeActive" />
		...
		<cftransaction isolation="read_committed">
			...
			<cfquery name="qCreateEOB_DIAGNOSISCode" datasource="#trim(variables.ds)#">
				INSERT INTO eob_diagnosiscode (Code,Description,InactiveCode)
				VALUES (						
		...
		<cfscript>
			read(qCreateEOB_DIAGNOSISCode.RecordID);
			arguments.obj.setRecordID(qCreateEOB_DIAGNOSISCode.RecordID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EOB_DIAGNOSISCodeActive">
				
		<cfargument name="RecordID" required="yes" type="numeric" />		
		<cfset var qGetEOB_DIAGNOSISCode = "" />		
		
		<cfset qGetEOB_DIAGNOSISCode = getEOB_DIAGNOSISCode(trim(RecordID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setRecordID(qGetEOB_DIAGNOSISCode.RecordID);
			this.setCode(qGetEOB_DIAGNOSISCode.Code);
			this.setDescription(qGetEOB_DIAGNOSISCode.Description);
			this.setActive(qGetEOB_DIAGNOSISCode.Active);
			this.setInactiveCode(qGetEOB_DIAGNOSISCode.InactiveCode);
			this.setDateCreated(qGetEOB_DIAGNOSISCode.DateCreated);
			this.setDateModified(qGetEOB_DIAGNOSISCode.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateEOB_DIAGNOSISCode" datasource="#trim(variables.ds)#">
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDeleteEOB_DIAGNOSISCode" datasource="#trim(variables.ds)#" result="status">
			DELETE
			FROM eob_diagnosiscode
