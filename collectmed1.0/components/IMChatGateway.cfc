...
<cfcomponent output="false">
	...
	<cffunction name="getById" output="false" access="remote">
		...
		<cfreturn createObject("component", "IMChatDAO").read(trim(arguments.ds), trim(arguments.RecordID))>		
	...
	<cffunction name="save" output="false" access="remote">
		...
		<cfif obj.getRecordID() EQ 0>
			<cfreturn createObject("component", "IMChatDAO").create(arguments.ds, arguments.obj)>
		<cfelse>
			<cfreturn createObject("component", "IMChatDAO").update(arguments.ds, arguments.obj)>
		</cfif>	
	...
	<cffunction name="deleteById" output="false" access="remote">
		...
		<cfset var obj = getById(arguments.ds, trim(arguments.RecordID)) />
 		<cfset createObject("component", "IMChatDAO").delete(arguments.ds, obj) />		
	...
	<!-------------------------------------------------------------------------------------->		
	<cffunction name="getAllByIDArray" output="false" access="remote" returntype="IMChatBean[]">
		...
		<cfset var qRead="" />
		<cfset var obj="" />
		<cfset var arrIMChatBeans = arrayNew(1) />
		...
		<cfloop query="qRead">
			<cfscript>
				obj = createObject("component", "IMChatDAO").read(qRead.RecordID);
				ArrayAppend(arrIMChatBeans, obj);
			</cfscript>
		</cfloop>
		
		<cfreturn arrIMChatBeans>
