...
<cfcomponent output="false">
	...
	<cffunction name="getById" output="false" access="remote">
		...
		<cfreturn createObject("component", "EOB_DRGCodeDAO").read(trim(arguments.ds), trim(arguments.RecordID))>		
	...
	<cffunction name="save" output="false" access="remote">
		...
		<cfif obj.getRecordID() EQ 0>
			<cfreturn createObject("component", "EOB_DRGCodeDAO").create(arguments.ds, arguments.obj)>
		<cfelse>
			<cfreturn createObject("component", "EOB_DRGCodeDAO").update(arguments.ds, arguments.obj)>
		</cfif>	
	...
	<cffunction name="deleteById" output="false" access="remote">
		...
		<cfset var obj = getById(arguments.ds, trim(arguments.RecordID)) />
 		<cfset createObject("component", "EOB_DRGCodeDAO").delete(arguments.ds, obj) />		
	...
	<!-------------------------------------------------------------------------------------->		
	<cffunction name="getAllByIDArray" output="false" access="remote" returntype="EOB_DRGCodeBean[]">
		...
		<cfset var qRead="" />
		<cfset var obj="" />
		<cfset var arrEOB_DRGCodeBeans = arrayNew(1) />
		...
		<cfloop query="qRead">
			<cfscript>
				obj = createObject("component", "EOB_DRGCodeDAO").read(qRead.RecordID);
				ArrayAppend(arrEOB_DRGCodeBeans, obj);
			</cfscript>
		</cfloop>
		
		<cfreturn arrEOB_DRGCodeBeans>
