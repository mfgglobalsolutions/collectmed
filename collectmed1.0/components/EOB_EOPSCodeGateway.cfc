...
<cfcomponent output="false">
	...
	<cffunction name="getById" output="false" access="remote">
		...
		<cfreturn createObject("component", "EOB_EOPSCodeDAO").read(trim(arguments.ds), trim(arguments.RecordID))>		
	...
	<cffunction name="save" output="false" access="remote">
		...
		<cfif obj.getRecordID() EQ 0>
			<cfreturn createObject("component", "EOB_EOPSCodeDAO").create(arguments.ds, arguments.obj)>
		<cfelse>
			<cfreturn createObject("component", "EOB_EOPSCodeDAO").update(arguments.ds, arguments.obj)>
		</cfif>	
	...
	<cffunction name="deleteById" output="false" access="remote">
		...
		<cfset var obj = getById(arguments.ds, trim(arguments.RecordID)) />
 		<cfset createObject("component", "EOB_EOPSCodeDAO").delete(arguments.ds, obj) />		
	...
	<!-------------------------------------------------------------------------------------->		
	<cffunction name="getAllByIDArray" output="false" access="remote" returntype="EOB_EOPSCodeBean[]">
		...
		<cfset var qRead="" />
		<cfset var obj="" />
		<cfset var arrEOB_EOPSCodeBeans = arrayNew(1) />
		...
		<cfloop query="qRead">
			<cfscript>
				obj = createObject("component", "EOB_EOPSCodeDAO").read(qRead.RecordID);
				ArrayAppend(arrEOB_EOPSCodeBeans, obj);
			</cfscript>
		</cfloop>
		
		<cfreturn arrEOB_EOPSCodeBeans>
