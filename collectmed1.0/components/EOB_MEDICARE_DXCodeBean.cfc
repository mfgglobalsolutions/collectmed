...
<cfcomponent name="eob_medicare_dxcodeBean" output="false" alias="eob_medicare_dxcodeBean" extends="EOB_MEDICARE_DXCodeDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_medicare_dxcodeBean">
