...
<cfcomponent name="entityaddressBean" output="false" alias="entityaddressBean" extends="EntityAddressDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="entityaddressBean">
