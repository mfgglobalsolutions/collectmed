...
<cfcomponent name="eob_dmefeetoscodeActive" output="false" alias="eob_dmefeetoscodeActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_dmefeetoscodeActive">
		...
		<cfif isDefined("arguments.stValues")>
			<cfif StructKeyExists(stValues, "RecordID") AND stValues.RecordID NEQ 0>
				<cfquery name="qGetEOB_DMEFEETOSCode" datasource="#trim(variables.ds)#">
				...
				<cfscript>
					variables.Code = qGetEOB_DMEFEETOSCode.Code;
					variables.Description = qGetEOB_DMEFEETOSCode.Description;
					variables.Active = qGetEOB_DMEFEETOSCode.Active;
					variables.InactiveCode = qGetEOB_DMEFEETOSCode.InactiveCode;
					variables.DateModified = qGetEOB_DMEFEETOSCode.DateModified;
				</cfscript>
			</cfif>
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EOB_DMEFEETOSCodeActive" />
		...
		<cftransaction isolation="read_committed">
			...
			<cfquery name="qCreateEOB_DMEFEETOSCode" datasource="#trim(variables.ds)#">
				INSERT INTO eob_dmefeetoscode (Code,Description,InactiveCode)
				VALUES (						
		...
		<cfscript>
			read(qCreateEOB_DMEFEETOSCode.RecordID);
			arguments.obj.setRecordID(qCreateEOB_DMEFEETOSCode.RecordID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EOB_DMEFEETOSCodeActive">
				
		<cfargument name="RecordID" required="yes" type="numeric" />		
		<cfset var qGetEOB_DMEFEETOSCode = "" />		
		
		<cfset qGetEOB_DMEFEETOSCode = getEOB_DMEFEETOSCode(trim(RecordID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setRecordID(qGetEOB_DMEFEETOSCode.RecordID);
			this.setCode(qGetEOB_DMEFEETOSCode.Code);
			this.setDescription(qGetEOB_DMEFEETOSCode.Description);
			this.setActive(qGetEOB_DMEFEETOSCode.Active);
			this.setInactiveCode(qGetEOB_DMEFEETOSCode.InactiveCode);
			this.setDateCreated(qGetEOB_DMEFEETOSCode.DateCreated);
			this.setDateModified(qGetEOB_DMEFEETOSCode.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateEOB_DMEFEETOSCode" datasource="#trim(variables.ds)#">
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDeleteEOB_DMEFEETOSCode" datasource="#trim(variables.ds)#" result="status">
			DELETE
			FROM eob_dmefeetoscode
