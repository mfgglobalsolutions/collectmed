...
<cfcomponent name="systemusermessageBean" output="false" alias="systemusermessageBean" extends="SystemUserMessageDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="systemusermessageBean">
