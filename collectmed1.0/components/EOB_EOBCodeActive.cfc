...
<cfcomponent name="eob_eobcodeActive" output="false" alias="eob_eobcodeActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_eobcodeActive">
		...
		<cfif isDefined("arguments.stValues")>
			<cfif StructKeyExists(stValues, "RecordID") AND stValues.RecordID NEQ 0>
				<cfquery name="qGetEOB_EOBCode" datasource="#trim(variables.ds)#">
				...
				<cfscript>
					variables.Code = qGetEOB_EOBCode.Code;
					variables.Description = qGetEOB_EOBCode.Description;
					variables.Active = qGetEOB_EOBCode.Active;
					variables.InactiveCode = qGetEOB_EOBCode.InactiveCode;
					variables.DateModified = qGetEOB_EOBCode.DateModified;
				</cfscript>
			</cfif>
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EOB_EOBCodeActive" />
		...
		<cftransaction isolation="read_committed">
			...
			<cfquery name="qCreateEOB_EOBCode" datasource="#trim(variables.ds)#">
				INSERT INTO EOB_EOBCode (Code,Description,InactiveCode)
				VALUES (						
		...
		<cfscript>
			read(qCreateEOB_EOBCode.RecordID);
			arguments.obj.setRecordID(qCreateEOB_EOBCode.RecordID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EOB_EOBCodeActive">
				
		<cfargument name="RecordID" required="yes" type="numeric" />		
		<cfset var qGetEOB_EOBCode = "" />		
		
		<cfset qGetEOB_EOBCode = getEOB_EOBCode(trim(RecordID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setRecordID(qGetEOB_EOBCode.RecordID);
			this.setCode(qGetEOB_EOBCode.Code);
			this.setDescription(qGetEOB_EOBCode.Description);
			this.setActive(qGetEOB_EOBCode.Active);
			this.setInactiveCode(qGetEOB_EOBCode.InactiveCode);
			this.setDateCreated(qGetEOB_EOBCode.DateCreated);
			this.setDateModified(qGetEOB_EOBCode.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateEOB_EOBCode" datasource="#trim(variables.ds)#">
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDeleteEOB_EOBCode" datasource="#trim(variables.ds)#" result="status">
			DELETE
			FROM EOB_EOBCode
