...
<cfcomponent name="entityphoneBean" output="false" alias="entityphoneBean" extends="EntityPhoneDAO">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="entityphoneBean">
