...
<cfcomponent name="eob_medicare_claimadjustmentcodeActive" output="false" alias="eob_medicare_claimadjustmentcodeActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_medicare_claimadjustmentcodeActive">
		...
		<cfif isDefined("arguments.stValues")>
			<cfif StructKeyExists(stValues, "RecordID") AND stValues.RecordID NEQ 0>
				<cfquery name="qGetEOB_MEDICARE_CLAIMADJUSTMENTCode" datasource="#trim(variables.ds)#">
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EOB_MEDICARE_CLAIMADJUSTMENTCodeActive" />
		...
		<cftransaction isolation="read_committed">
			...
			<cfquery name="qCreateEOB_MEDICARE_CLAIMADJUSTMENTCode" datasource="#trim(variables.ds)#">
				INSERT INTO EOB_MEDICARE_CLAIMADJUSTMENTCode (Code,Description,InactiveCode)
				VALUES (						
		...
		<cfscript>
			read(qCreateEOB_MEDICARE_CLAIMADJUSTMENTCode.RecordID);
			arguments.obj.setRecordID(qCreateEOB_MEDICARE_CLAIMADJUSTMENTCode.RecordID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EOB_MEDICARE_CLAIMADJUSTMENTCodeActive">
				
		<cfargument name="RecordID" required="yes" type="numeric" />		
		<cfset var qGetEOB_MEDICARE_CLAIMADJUSTMENTCode = "" />		
		
		<cfset qGetEOB_MEDICARE_CLAIMADJUSTMENTCode = getEOB_MEDICARE_CLAIMADJUSTMENTCode(trim(RecordID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setRecordID(qGetEOB_MEDICARE_CLAIMADJUSTMENTCode.RecordID);
			this.setCode(qGetEOB_MEDICARE_CLAIMADJUSTMENTCode.Code);
			this.setDescription(qGetEOB_MEDICARE_CLAIMADJUSTMENTCode.Description);
			this.setActive(qGetEOB_MEDICARE_CLAIMADJUSTMENTCode.Active);
			this.setInactiveCode(qGetEOB_MEDICARE_CLAIMADJUSTMENTCode.InactiveCode);
			this.setDateCreated(qGetEOB_MEDICARE_CLAIMADJUSTMENTCode.DateCreated);
			this.setDateModified(qGetEOB_MEDICARE_CLAIMADJUSTMENTCode.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateEOB_MEDICARE_CLAIMADJUSTMENTCode" datasource="#trim(variables.ds)#">
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDeleteEOB_MEDICARE_CLAIMADJUSTMENTCode" datasource="#trim(variables.ds)#" result="status">
			DELETE
			FROM EOB_MEDICARE_CLAIMADJUSTMENTCode
