...
<cfcomponent name="eob_medicare_remittanceadviceremarkcodeActive" output="false" alias="eob_medicare_remittanceadviceremarkcodeActive">
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="init" output="false" returntype="eob_medicare_remittanceadviceremarkcodeActive">
		...
		<cfif isDefined("arguments.stValues")>
			<cfif StructKeyExists(stValues, "RecordID") AND stValues.RecordID NEQ 0>
				<cfquery name="qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode" datasource="#trim(variables.ds)#">
				...
				<cfscript>
					variables.Code = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.Code;
					variables.Description = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.Description;
					variables.Active = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.Active;
					variables.InactiveCode = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.InactiveCode;
					variables.DateModified = qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.DateModified;
				</cfscript>
			</cfif>
	...
	<cffunction name="create" output="false" access="public">
		...
		<cfargument name="obj" required="true" type="EOB_MEDICARE_REMITTANCEADVICEREMARKCodeActive" />
		...
		<cftransaction isolation="read_committed">
			...
			<cfquery name="qCreateEOB_MEDICARE_REMITTANCEADVICEREMARKCode" datasource="#trim(variables.ds)#">
				INSERT INTO eob_medicare_remittanceadviceremarkcode (Code,Description,InactiveCode)
				VALUES (						
		...
		<cfscript>
			read(qCreateEOB_MEDICARE_REMITTANCEADVICEREMARKCode.RecordID);
			arguments.obj.setRecordID(qCreateEOB_MEDICARE_REMITTANCEADVICEREMARKCode.RecordID);
		</cfscript>
	...
	<!-------------------------------------------------------------------------------------->	
	<cffunction name="read" output="false" access="public" returntype="EOB_MEDICARE_REMITTANCEADVICEREMARKCodeActive">
				
		<cfargument name="RecordID" required="yes" type="numeric" />		
		<cfset var qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode = "" />		
		
		<cfset qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode = getEOB_MEDICARE_REMITTANCEADVICEREMARKCode(trim(RecordID)) />
		...
		<!-------------------------------------------------------------------------------------->			
		<cfscript>
			this.setRecordID(qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.RecordID);
			this.setCode(qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.Code);
			this.setDescription(qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.Description);
			this.setActive(qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.Active);
			this.setInactiveCode(qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.InactiveCode);
			this.setDateCreated(qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.DateCreated);
			this.setDateModified(qGetEOB_MEDICARE_REMITTANCEADVICEREMARKCode.DateModified);				
			return this;
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cftry>
			...
			<cfquery name="qUpdateEOB_MEDICARE_REMITTANCEADVICEREMARKCode" datasource="#trim(variables.ds)#">
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDeleteEOB_MEDICARE_REMITTANCEADVICEREMARKCode" datasource="#trim(variables.ds)#" result="status">
			DELETE
			FROM eob_medicare_remittanceadviceremarkcode
